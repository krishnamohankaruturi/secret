...
<xsl:stylesheet version="2.0" xmlns:saxon="http://saxon.sf.net/"
		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" font-family="Arial" font-size="10pt">
			...
			<fo:layout-master-set>
				<fo:simple-page-master master-name="allPages" page-height="22cm" page-width="28.45cm" margin-top="1.4cm" margin-bottom="1.8cm" margin-left="1.8cm" margin-right="1.8cm">
					...
					<fo:region-body margin-top="42mm" margin-right="5pt" margin-bottom="10mm" />
			...
			<fo:page-sequence master-reference="allPages">
				...
				<fo:static-content flow-name="xsl-region-before" >
					<xsl:call-template name="alternateSchoolSummmaryHeaderContent"/>
				</fo:static-content>

				<!-- Define the contents of the footer. -->
				<fo:static-content flow-name="xsl-region-after">				
					<xsl:call-template name="alternateSchoolSummmaryFooterContent"/>
				</fo:static-content>
				
				<!-- Define the contents of the body. -->
				<fo:flow flow-name="xsl-region-body">				 			
				 	<xsl:call-template name="alternateSchoolSummmaryBodyContent"/>		
					<fo:block id="veryDistrictLastPage"> </fo:block>		
				</fo:flow>
	...
	<xsl:template name="alternateSchoolSummmaryBodyContent" >
		...
		<fo:block>
			<fo:table border-before-width.conditionality="retain" border-after-width.conditionality="retain" border-top-style="solid" border-bottom-style="solid" 
													...
													<fo:table-column column-width="40.5mm" />
													<fo:table-column column-width="20.5mm" />
													<fo:table-column column-width="27.8mm" />
													<fo:table-column column-width="21.7mm" />
													<fo:table-column column-width="45.7mm" />													
													 <fo:table-header>
													...
													<fo:table-cell padding-left="1pt" padding-right="1pt" padding-top="0.5pt" display-align="before"
														...
														<fo:table-cell padding-left="1pt" padding-right="9pt" padding-top="0.5pt" display-align="before"
															padding-bottom="0.3pt" border-top-style="solid" 
															border-bottom-style="solid" >
															<fo:block font-size="11.0pt" font-weight="bold" text-align="center">
													 	...
													 	<xsl:for-each select="alternateAggregateReport/alternateAggregateStudents/edu.ku.cete.domain.report.AlternateAggregateStudents">
													 	   ...
													 	   <fo:table-row  border-top-style="solid" border-bottom-style="solid" keep-together.within-page="always" >
																...
																<fo:table-cell padding-left="1pt" padding-right="1pt" padding-top="0.5pt" display-align="before"
																	...
																	<fo:block font-size="11.0pt" >
																		<xsl:value-of select="educatorLastName" />
																	</fo:block>
																 </fo:table-cell>
							...
							<fo:block-container margin-left="2.2pt"  margin-right="2.2pt" margin-top="20pt" page-break-inside="avoid" >
	...
	<xsl:template name="alternateSchoolSummmaryHeaderContent" >
		<fo:table table-layout="fixed">
				...
				<fo:table-row>
					...
					<fo:table-cell >					
							<fo:block text-align="center"  margin-top="-2pt" font-weight="bold" font-size="12pt"  >
										<xsl:text>End of Year Report School Results </xsl:text>
					...
					<fo:table-cell >
						<fo:block-container >
							<xsl:call-template name="alternateSchoolSummaryHeaderLogo"/>
							...
							<fo:block font-size="11pt"  margin-top="1.0mm" margin-left="47.0mm"   >
									<xsl:call-template name="alternateSchoolSummmaryHeaderState"/>
							</fo:block>	
						</fo:block-container>
					</fo:table-cell>
				</fo:table-row>
		 ...
		 <fo:table table-layout="fixed" margin-top="-5.8mm" >
	...
	<xsl:template name="alternateSchoolSummmaryFooterContent" >
	  <fo:block text-align="end" font-size="10pt" margin-left="10mm">
			Page <fo:page-number/> of <fo:page-number-citation ref-id="veryDistrictLastPage"/>
		</fo:block> 
		
	</xsl:template>	
	
	<xsl:template name="alternateSchoolSummmaryHeaderState">		
			<fo:inline font-weight="bold">
	...
	<xsl:template name="alternateSchoolSummaryHeaderLogo">
		<fo:table>
		<fo:table-body>
		<fo:table-row>
		<fo:table-cell>
