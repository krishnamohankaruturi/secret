...
<xsl:stylesheet version="2.0" xmlns:saxon="http://saxon.sf.net/"
		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" font-family="Arial" font-size="10pt">
			...
			<fo:layout-master-set>
				<fo:simple-page-master master-name="allPages" page-height="22cm" page-width="27.92cm" margin-top="1.4cm" margin-bottom="1.8cm" margin-left="2.5cm" margin-right="2.5cm">
					...
					<fo:region-body margin-top="35mm" margin-right="5pt" />
			...
			<fo:page-sequence master-reference="allPages">
				...
				<fo:static-content flow-name="xsl-region-before" >
					<xsl:call-template name="dlmDistrictSummmaryHeaderContent"/>
				</fo:static-content>

				<!-- Define the contents of the footer. -->
				<fo:static-content flow-name="xsl-region-after">				
					<xsl:call-template name="dlmDistrictSummmaryFooterContent"/>
				</fo:static-content>
				
				<!-- Define the contents of the body. -->
				<fo:flow flow-name="xsl-region-body">				 			
				 	<xsl:call-template name="dlmDistrictSummmaryBodyContent"/>		
	...
	<xsl:template name="dlmDistrictSummmaryBodyContent" >
	...
	<xsl:template name="dlmDistrictSummmaryHeaderContent" >
		<fo:table table-layout="fixed">
				...
				<fo:table-row>
					...
					<fo:table-cell >					
							<fo:block text-align="center" margin-top="-2pt" font-weight="bold" font-size="12pt"  >
										<xsl:text>End of Year Report District Results </xsl:text>
					...
					<fo:table-cell >
						<fo:block-container >
							<xsl:call-template name="dlmDistrictSummaryHeaderLogo"/>
							<fo:block font-size="11pt"  margin-top="-4.4mm"  margin-left="46.5mm"  >
								<fo:inline font-weight="bold">
									<xsl:text>DISTRICT ID</xsl:text>
								</fo:inline>
								<xsl:text>: </xsl:text>	
								<xsl:value-of select="dlmSummaryReport/orgGrfCalculation/districtCode"/>
							</fo:block>
							<fo:block font-size="11pt"  margin-top="-0.5mm" margin-left="46.5mm"   >
									<xsl:call-template name="dlmDistrictSummmaryHeaderState"/>
							</fo:block>	
						</fo:block-container>
					</fo:table-cell>
				</fo:table-row>
		 ...
		 <fo:table table-layout="fixed" margin-top="-14pt" >
					...
					<fo:table-cell>
						<fo:block-container>
								<fo:block text-align="left" font-size="11pt"  >
										...
										<xsl:text>: </xsl:text>
										<xsl:value-of select="dlmSummaryReport/orgGrfCalculation/districtShortName"/>
								</fo:block>																	
						</fo:block-container>
					</fo:table-cell>					
				</fo:table-row>
	...
	<xsl:template name="dlmDistrictSummaryHeaderLogo">
		<fo:table>
		<fo:table-body>
		<fo:table-row>
		<fo:table-cell>
