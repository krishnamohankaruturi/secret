			...
			<fo:page-sequence master-reference="simpleA4">
                ...
                <fo:flow flow-name="xsl-region-body">
						<fo:block text-align="center">
							<fo:table  border-top-style="solid" border-bottom-style="solid" border-left-style="solid" border-right-style="solid" display-align="center">
					       ...
					       <fo:table-header>
							...
							<fo:table-cell  background-color="#A9A9A9" number-columns-spanned="8" padding-left="2pt" padding-right="2pt" padding-top="2pt" padding-bottom="2pt" border-top-style="solid" border-bottom-style="solid" border-left-style="solid" border-right-style="solid" >
							...
							<fo:table-row>
								...
								<fo:table-cell number-columns-spanned="4" padding-left="15pt" padding-right="2pt" padding-top="2pt" padding-bottom="2pt" border-top-style="solid" border-bottom-style="solid" border-left-style="solid" border-right-style="solid" >
								...
								<fo:table-cell number-columns-spanned="4" padding-left="15pt" padding-right="2pt" padding-top="2pt" padding-bottom="2pt" border-top-style="solid" border-bottom-style="solid" border-left-style="solid" border-right-style="solid" >
								<fo:block font-size="10.0pt" font-family="sans-serif" font-weight="bold" text-align="left">							
									<xsl:text>totalparticipants</xsl:text>
								</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell number-columns-spanned="4" padding-left="15pt" padding-right="2pt" padding-top="2pt" padding-bottom="2pt" border-top-style="solid" border-bottom-style="solid" border-left-style="solid" border-right-style="solid" >
								<fo:block font-size="10.0pt" font-family="sans-serif" font-weight="bold" text-align="left">							
									<xsl:text>classHighestpointsByPercentage</xsl:text>
								</fo:block>
								</fo:table-cell>
								
								<fo:table-cell number-columns-spanned="4" space-after="8.0pt" padding-left="2pt" padding-right="2pt" padding-top="2pt" padding-bottom="2pt" border-top-style="solid" border-bottom-style="solid" border-left-style="solid" border-right-style="solid">
										<fo:block font-size="10.0pt" font-family="sans-serif">
								...
								<fo:table-cell number-columns-spanned="4" padding-left="15pt" padding-right="2pt" padding-top="2pt" padding-bottom="2pt" border-top-style="solid" border-bottom-style="solid" border-left-style="solid" border-right-style="solid" >
								<fo:block font-size="10.0pt" font-family="sans-serif" font-weight="bold" text-align="left">							
									<xsl:text>classLowestPointsByPercentage</xsl:text>
								</fo:block>
								</fo:table-cell>
								...
								<fo:table-cell number-columns-spanned="4"  padding-left="2pt" padding-right="2pt" padding-top="2pt" padding-bottom="2pt" border-top-style="solid" border-bottom-style="solid" border-left-style="solid" border-right-style="solid">
									...
									<fo:table-row>
								<xsl:variable name="totalpointsByPercentage" select="interimClassResults/totalpointsByPercentage"></xsl:variable>
								
								<fo:table-cell number-columns-spanned="4" padding-left="15pt" padding-right="4pt" padding-top="2pt" padding-bottom="2pt" border-top-style="solid" border-bottom-style="solid" border-left-style="solid" border-right-style="solid" >
								<fo:block font-size="10.0pt" font-family="sans-serif" font-weight="bold" text-align="left">							
									<xsl:text>totalpointsByPercentage</xsl:text>
								</fo:block>
								</fo:table-cell>
								
								<fo:table-cell number-columns-spanned="4"  padding-left="2pt" padding-right="2pt" padding-top="2pt" padding-bottom="2pt" border-top-style="solid" border-bottom-style="solid" border-left-style="solid" border-right-style="solid">
										<fo:block font-size="10.0pt" font-family="sans-serif">
											 <xsl:value-of select="$totalpointsByPercentage"/>
										</fo:block>
									</fo:table-cell>
									</fo:table-row>
								</fo:table-body>
	...
	<xsl:template name="classroster">
			<fo:block text-align="center">
						<fo:table 
							...
							<fo:table-column column-width="15mm" />
							<fo:table-column column-width="15mm" />
							<xsl:for-each select="interimClassResults/questions">
								<fo:table-column column-width="15mm" />
							</xsl:for-each>
							
							<xsl:for-each select="interimClassResults/interimResultsTypes">
								<fo:table-column column-width="15mm" />
							</xsl:for-each>
							...
							<fo:table-header >
								...
								<fo:table-cell background-color="#1a77bb"
									...
									<fo:block font-size="10.0pt" font-family="sans-serif"
										font-weight="bold">
										<xsl:text>totalPercentage</xsl:text>
									</fo:block>
								</fo:table-cell>
							</fo:table-header>
							<fo:table-body>
           ...
           <fo:block text-align="center">
           <fo:table  border-left-style="solid" border-right-style="solid" display-align="center">
							<fo:table-column column-width="15mm" />
							<fo:table-column column-width="15mm" />
							<fo:table-column column-width="15mm" />
							<fo:table-column column-width="15mm" />
							...
							<fo:table-column column-width="15mm" />
							  <xsl:for-each select="interimClassResults/interimResultsTypes">
					           ...
					           <fo:table-body>				              
								...
								<fo:table-cell number-columns-spanned="5.5" padding-left="2pt" padding-right="2pt" padding-top="2pt" padding-bottom="2pt" border-top-style="solid" border-bottom-style="solid" border-left-style="solid" border-right-style="solid" >
								<fo:block font-size="10.0pt" font-family="sans-serif" font-weight="bold" text-align="right">							
									<xsl:text>itemType</xsl:text>
								</fo:block>
								</fo:table-cell>
								<xsl:for-each select="interimClassResults/interimResultsTypes">
								<fo:table-cell number-columns-spanned="1"  padding-left="2pt" padding-right="2pt" padding-top="2pt" padding-bottom="2pt" border-top-style="solid" border-bottom-style="solid" border-left-style="solid" border-right-style="solid">
										<fo:block font-size="10.0pt" font-family="sans-serif">
								...
								<fo:table-cell number-columns-spanned="5.5" padding-left="2pt" padding-right="2pt" padding-top="2pt" padding-bottom="2pt" border-top-style="solid" border-bottom-style="solid" border-left-style="solid" border-right-style="solid" >
								<fo:block font-size="10.0pt" font-family="sans-serif" font-weight="bold" text-align="right">							
									<xsl:text>correctPercentage</xsl:text>
								</fo:block>
								</fo:table-cell>
								<xsl:for-each select="interimClassResults/interimResultsTypes">
								<fo:table-cell number-columns-spanned="1"  padding-left="2pt" padding-right="2pt" padding-top="2pt" padding-bottom="2pt" border-top-style="solid" border-bottom-style="solid" border-left-style="solid" border-right-style="solid">
								...
								<fo:table-cell number-columns-spanned="5.5" padding-left="2pt" padding-right="2pt" padding-top="2pt" padding-bottom="2pt" border-top-style="solid" border-bottom-style="solid" border-left-style="solid" border-right-style="solid" >
								<fo:block font-size="10.0pt" font-family="sans-serif" font-weight="bold" text-align="right">							
									<xsl:text>incorrectPercentage</xsl:text>
								</fo:block>
								</fo:table-cell>
								<xsl:for-each select="interimClassResults/interimResultsTypes">
								<fo:table-cell number-columns-spanned="1"  padding-left="2pt" padding-right="2pt" padding-top="2pt" padding-bottom="2pt" border-top-style="solid" border-bottom-style="solid" border-left-style="solid" border-right-style="solid">
	...
	<xsl:template name="percentcorrect">
	 ...
	 <fo:block-container height="15mm">
          <fo:block font-size="9.0pt" font-family="serif" border-right-style="dashed" border-right-width="1.5pt">  
	        <fo:external-graphic content-width="scale-down-to-fit" src="/home/yash/Documents/ku/DLM-AART/aart-main/aart-web/BarChart.png" content-height="scale-down-to-fit" height="10px" width="10px" vertical-align="middle">
			</fo:external-graphic>		
    </fo:block>
         
    </fo:block-container> 
    <xsl:call-template name="itempercentage"/>  
	
	</xsl:template>
	<xsl:template name="itempercentage" >
	<fo:block-container height="15mm">
          <fo:block font-size="9.0pt" font-family="serif" border-right-style="dashed" border-right-width="1.5pt">  
	        <fo:external-graphic content-width="scale-down-to-fit" src="/home/yash/Documents/ku/DLM-AART/aart-main/aart-web/BarChart.png" content-height="scale-down-to-fit" height="10px" width="10px" vertical-align="middle">
          ...
          <fo:block font-size="9.0pt" font-family="serif" border-right-style="dashed" border-right-width="1.5pt">  
	        <fo:external-graphic content-width="scale-down-to-fit" content-height="scale-down-to-fit" height="10px" width="10px" vertical-align="middle">
							 								<xsl:attribute name="src">
							 									<xsl:value-of select="interimClassResults/itemPercentCorrect/graphByQuestions"/>
