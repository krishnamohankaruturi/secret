...
(function ($) {
	...
	$.jqPagination = function (el, options) {
		...
		$(base.$input).attr('title','Pagination input');
		...
		base.setPage = function (page, prevent_paged) {
			...
			/*
			 * KU/ATS EDIT (Brad): If the current page is equal to the page they entered,
			 * no need to do anything
			 */
			if (base.options.current_page === page){
				base.setInputValue(current_page);
				return true;
			}
		...
		base.callMethod = function (method, key, value) {
			...
			switch (method.toLowerCase()) {
				...
				case 'option':
					...
					/*
					 * KU/ATS EDIT (Brad): we want to control the page event for the server-side calls,
					 * so we prevent it all the time here by setting trigger to false
					 * */
