...
(function($, undefined) {
	...
	$.jPlayer.event = {
		...
		play: "jPlayer_play",
		replay: "jPlayer_replay", //DLM-add : added replay
		pause: "jPlayer_pause",
	...
	$.jPlayer.prototype = {
		...
		options: { // Instanced in $.jPlayer() constructor
			...
			cssSelector: { // * denotes properties that should only be required when video media type required. _cssSelector() would require changes to enable splitting these into Audio and Video defaults.
				...
				play: ".jp-play",
				pause: ".jp-pause",
				replay: ".jp-replay", //DLM-add : added replay
				stop: ".jp-stop",
				seekBar: ".jp-seek-bar",
				playBar: ".jp-play-bar",
				mute: ".jp-mute",
...
*/
		...
		_addHtmlEventListeners: function(mediaElement, entity) {
			...
			mediaElement.addEventListener("ended", function() {
				if(entity.gate) {
					...
					//if(tasktype == 'tset_stim_br' || tasktype == 'tset_stim_cb'){task.doNextSteps();} //dlm - added : do next steps on alt ui after audio finishes playing
				}
			}, false);
		...
		_getHtmlStatus: function(media, override) {
			...
			if(this.status.ended){
				this.status.toBeReplayed = media.ended;
			}
		},
		...
		_updateButtons: function(playing) {
			if(playing !== undefined) {
				...
				if(this.css.jq.play.length && this.css.jq.pause.length) {
					//DLM-change: replay button
					if(playing) {
						this.css.jq.play.hide();
						this.css.jq.replay.hide();
						this.css.jq.pause.show();
					} else {
						if(this.status.toBeReplayed && this.status.currentTime==0) { 
							this.css.jq.replay.show();
							this.css.jq.play.hide();
						} else {
		...
		replay: function() { //dlm-add: replay function
			this.play();
		},
			...
			if(typeof cssSel === 'string') {
				if($.jPlayer.prototype.options.cssSelector[fn]) {
					...
					if(this.css.jq[fn].length) {
						...
						this.css.jq[fn].bind("click.jPlayer touchend.jPlayer", handler); // Using jPlayer namespace //dlm-added: touchend - make click events work for ipad
					}
		...
		_emulateHtmlUpdate: function() {
			...
			$.each( $.jPlayer.emulateStatus.split(/\s+/g), function(i, name) {
			    /*if(name == 'playbackRate')
			     document.getElementById(self.internal.audio["id"]).playbackRate = self.status[name];
			    else
