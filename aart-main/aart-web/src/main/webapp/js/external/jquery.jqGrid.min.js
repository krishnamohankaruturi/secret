...
(function(b) {
    ...
    b.extend(b.jgrid, {
        ...
        parseDate: function(f, e) {
            ...
            if (e && null !== e && void 0 !== e) {
                ...
                d = 0;
                for (a = f.length; d < a; d++) "M" == f[d] && (i = b.inArray(e[d], g), -1 !== i && 12 > i && (e[d] = i + 1, c.m = e[d])), "F" == f[d] && (i = b.inArray(e[d], g), -1 !== i && 11 < i && (e[d] = i + 1 - 12, c.m = e[d])),
                    "a" == f[d] && (i = b.inArray(e[d], h), -1 !== i && 2 > i && e[d] == h[i] && (e[d] = i, c.h = j(e[d], c.h))), "A" == f[d] && (i = b.inArray(e[d], h), -1 !== i && 1 < i && e[d] == h[i] && (e[d] = i - 2, c.h = j(e[d], c.h))), void 0 !== e[d] && (c[f[d].toLowerCase()] = parseInt(e[d], 10));
        ...
        getAccessor: function(b, e) {
            ...
            c = b[e];
            if (void 0 === c) try {
                if ("string" === typeof e && (a = e.split(".")), i = a.length)
                    for (c = b; c && i--;) d = a.shift(), c = c[d]
            } catch (g) {}
            return c
        },
        ...
        from: function(f) {
            return new function(e, c) {
                ...
                var d = this,
                    ...
                    x = [],
                    r = !0;
                if ("object" == typeof e && e.push) 0 < e.length && (r = "object" != typeof e[0] ? !1 : !0);
                ...
                this._toStr = function(a) {
                    f && (a = b.trim(a));
                    i || (a = a.toLowerCase());
                    return a = a.toString().replace(/\\/g, "\\\\").replace(/\"/g, '\\"')
                };
                ...
                this._repeatCommand = function(a, b) {
                    return null === l ? d : null !== a && null !== b ? l(a, b) : null === k || !r ? l(a) : l(k, a)
                };
                ...
                this._compare = function(a, b, d) {
                    ...
                    if (null !== a && null === b) return -1;
                    if ("[object Date]" === c.call(a) && "[object Date]" === c.call(b)) return a < b ? -d : a > b ?
                        d : 0;
                    !i && "number" !== typeof a && "number" !== typeof b && (a = ("" + a).toLowerCase(), b = ("" + b).toLowerCase());
                ...
                this._doSort = function(a, b) {
                    var c = x[b].by,
                        ...
                        f = x[b].type,
                        e = x[b].datefmt;
                    if (b == x.length - 1) return d._getOrder(a, c, i, f, e);
                    b++;
                    c = d._getGroup(a, c, i, f, e);
                    i = [];
                    for (f = 0; f < c.length; f++)
                        for (var e = d._doSort(c[f].items, b), g = 0; g < e.length; g++) i.push(e[g]);
                    return i
                };
                this._getOrder = function(a, c, i, f, e) {
                    var g = [],
                        h = [],
                        l = "a" == i ?
                        1 : -1,
                    ...
                    for (var f = 0, q = a.length; f < q;) i = h[f].index, g.push(a[i]), f++;
                    return g
                };
                this._getGroup = function(a, c, f, i, e) {
                    var g = [],
                        h = null,
                        j = null,
                        k;
                    b.each(d._getOrder(a, c, f, i, e), function(a, f) {
                        k = b.jgrid.getAccessor(f, c);
                        void 0 === k && (k = "");
                        d._equals(j, k) || (j = k, null !== h && g.push(h), h = d._group(c, k));
                        h.items.push(f)
                    });
                    null !== h && g.push(h);
                    return g
                ...
                this._compareValues = function(a, c, f, i, e) {
                    var g;
                    g = r ? "jQuery.jgrid.getAccessor(this,'" +
                        c + "')" : "this";
                    void 0 === f && (f = null);
                    var h = f,
                        k = void 0 === e.stype ? "text" : e.stype;
                    if (null !== f) switch (k) {
                        case "int":
                        case "integer":
                        ...
                        case "date":
                        case "datetime":
                            h = "" + b.jgrid.parseDate(e.newfmt || "Y-m-d", h).getTime();
                            g = 'jQuery.jgrid.parseDate("' + e.srcfmt + '",' + g + ").getTime()";
                            break;
                        default:
                            g = d._getStr(g), h = d._getStr('"' + d._toStr(h) + '"')
                    }
                    d._append(g + " " + i + " " + h);
                    d._setCommand(a, c);
                    d._resetNegate();
                ...
                this.startsWith = function(a, c) {
                    var i = void 0 === c || null === c ? a : c,
                        i = f ? b.trim(i.toString()).length : i.toString().length;
                    r ? d._append(d._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".substr(0," + i + ") == " + d._getStr('"' + d._toStr(c) + '"')) : (i = f ? b.trim(c.toString()).length : c.toString().length, d._append(d._getStr("this") + ".substr(0," +
                        i + ") == " + d._getStr('"' + d._toStr(a) + '"')));
                ...
                this.endsWith = function(a, c) {
                    var i = void 0 === c || null === c ? a : c,
                        i = f ? b.trim(i.toString()).length : i.toString().length;
                    r ? d._append(d._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".substr(" + d._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".length-" + i + "," + i + ') == "' + d._toStr(c) + '"') : d._append(d._getStr("this") + ".substr(" + d._getStr("this") + '.length-"' + d._toStr(a) + '".length,"' + d._toStr(a) + '".length) == "' +
                        d._toStr(a) + '"');
                ...
                this.contains = function(a, b) {
                    r ? d._append(d._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + '.indexOf("' + d._toStr(b) + '",0) > -1') : d._append(d._getStr("this") + '.indexOf("' + d._toStr(a) + '",0) > -1');
                    d._setCommand(d.contains, a);
                    d._resetNegate();
                    return d
                };
                this.groupBy = function(b, c, f, i) {
                    return !d._hasData() ? null : d._getGroup(a, b, c, f, i)
                };
                this.orderBy = function(a, c, f, i) {
                    c = void 0 === c || null === c ? "a" : b.trim(c.toString().toLowerCase());
                    if (null ===
                        f || void 0 === f) f = "text";
                    if (null === i || void 0 === i) i = "Y-m-d";
    ...
    b.fn.jqGrid = function(f) {
        ...
        return this.each(function() {
            if (!this.grid) {
                var d =
                    ...
                    c = {
                        ...
                        dragMove: function(a) {
                            if (this.resizing) {
                                var b = a.clientX - this.resizing.startX,
                                    ...
                                    c = "ltr" === d.direction ? a.width + b : a.width -
                                    b,
                                    e;
                        ...
                        dragEnd: function() {
                            ...
                            if (this.resizing) {
                                ...
                                !0 === d.forceFit ? (e = this.headers[c + d.nv].newWidth || this.headers[c + d.nv].width, this.headers[c + d.nv].width = e, this.headers[c + d.nv].el.style.width = e + "px", this.cols[c + d.nv].style.width = e + "px", 0 < this.footers.length && (this.footers[c + d.nv].style.width = e + "px"), d.colModel[c + d.nv].width = e) : (d.tblwidth = this.newWidth || d.tblwidth, b("table:first", this.bDiv).css("width",
                                    d.tblwidth + "px"), b("table:first", this.hDiv).css("width", d.tblwidth + "px"), this.hDiv.scrollLeft = this.bDiv.scrollLeft, d.footerrow && (b("table:first", this.sDiv).css("width", d.tblwidth + "px"), this.sDiv.scrollLeft = this.bDiv.scrollLeft));
                        ...
                        populateVisible: function() {
                            ...
                            if (a) {
                                ...
                                if (G) {
                                    ...
                                    var j = Math.round(e.position().top) - f,
                                        k = j + e.height();
                                    G *= h;
                                    var z, s, w;
                                    if (k < a && 0 >= j && (void 0 === d.lastpage || parseInt((k + f + G - 1) / G, 10) <= d.lastpage)) s = parseInt((a - k + G - 1) / G, 10), 0 <= k || 2 > s || !0 === d.scroll ? (z = Math.round((k + f) / G) + 1, j = -1) : j = 1;
                                    0 < j && (z = parseInt(f / G, 10) + 1, s = parseInt((f + a) / G, 10) + 2 - z,
                                        w = !0);
                                    if (s && !(d.lastpage && z > d.lastpage || 1 == d.lastpage || z === d.page && z === d.lastpage)) c.hDiv.loading ? c.timer = setTimeout(c.populateVisible, d.scrollTimeout) : (d.page = z, w && (c.selectionPreserver(e[0]), c.emptyRows(c.bDiv, !1, !1)), c.populate(s))
                                }
                            }
                        },
                        scrollGrid: function(a) {
                            ...
                            d.footerrow &&
                                (c.sDiv.scrollLeft = c.bDiv.scrollLeft);
                            a && a.stopPropagation()
                        },
                            ...
                            var c = a.p,
                                ...
                                g = function() {
                                    ...
                                    if (c.multiselect && e && 0 < e.length)
                                        for (i = 0; i < e.length; i++) e[i] != d && b(a).jqGrid("setSelection", e[i], !1, null);
                ...
                if ("TABLE" !=
                    this.tagName.toUpperCase()) alert("Element is not a table");
                else {
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                        ...
                        b("<div class='ui-widget-overlay jqgrid-overlay' id='lui_" +
                            this.id + "'></div>").append(l).insertBefore(j);
                        ...
                        var q = function(a, b) {
                            ...
                            x = function(d, e, f, g, h, j) {
                                var L = a.p.colModel[d],
                                    k = L.align,
                                    z = 'style="',
                                    s = L.classes,
                                    w = L.name,
                                    p = [];
                                k && (z = z + ("text-align:" + k + ";"));
                                L.hidden === true && (z = z + "display:none;");
                                if (e === 0) z = z + ("width: " + c.headers[d].width + "px;");
                                else if (L.cellattr && b.isFunction(L.cellattr))
                                    if ((d = L.cellattr.call(a, h, f, g, L, j)) && typeof d === "string") {
                                        d = d.replace(/style/i, "style").replace(/title/i, "title");
                                        if (d.indexOf("title") > -1) L.title = false;
                                        d.indexOf("class") > -1 && (s = void 0);
                                        p = d.split("style");
                                        if (p.length === 2) {
                                            p[1] = b.trim(p[1].replace("=", ""));
                                            if (p[1].indexOf("'") === 0 || p[1].indexOf('"') === 0) p[1] = p[1].substring(1);
                                            z = z + p[1].replace(/'/gi, '"')
                                        } else z = z + '"'
                                    }
                                if (!p.length) {
                                ...
                                z = z + ((s !== void 0 ? ' class="' + s + '"' : "") + (L.title && f ? ' title="' + b.jgrid.stripHtml(f) + '"' : ""));
                                z = z + (' aria-describedby="' + a.p.id + "_" + w + '"');
                                return z + p[0]
                            },
                            r = function(c) {
                                return c === void 0 || c === null || c === "" ? "&#160;" : a.p.autoencode ? b.jgrid.htmlEncode(c) : c + ""
                            },
                            C = function(c, d, e, f, g) {
                                var i = a.p.colModel[e];
                                if (typeof i.formatter !== "undefined") {
                                    c = {
                                        rowId: c,
                                        colModel: i,
                                        gid: a.p.id,
                                    ...
                                    d = b.isFunction(i.formatter) ? i.formatter.call(a, d, c, f, g) : b.fmatter ? b.fn.fmatter.call(a, i.formatter, d, c, f, g) : r(d)
                                } else d =
                                    r(d);
                                return d
                            },
                            D = function(a, b, c, d, e) {
                                b = C(a, b, c, e, "add");
                                return '<td role="gridcell" ' + x(c, d, b, e, a, true) + ">" + b + "</td>"
                            },
                            O = function(b, c, d) {
                                var e = '<input role="checkbox" type="checkbox" id="jqg_' + a.p.id + "_" + b + '" class="cbox" name="jqg_' + a.p.id + "_" + b + '"/>';
                                return '<td role="gridcell" ' + x(c, d, "", null, b, true) + ">" + e + "</td>"
                            },
                            V = function(a, b, c, d) {
                                c = (parseInt(c, 10) - 1) * parseInt(d, 10) + 1 + b;
                                return '<td role="gridcell" class="ui-state-default jqgrid-rownum" ' + x(a, b, c, null, b, true) + ">" + c + "</td>"
                            },
                            ba = function(b) {
                                var c,
                                    d = [],
                            ...
                            S = function(c, d, e) {
                                if (a.p.deepempty) b("#" + b.jgrid.jqID(a.p.id) + " tbody:first tr:gt(0)").remove();
                                    ...
                                    b("#" + b.jgrid.jqID(a.p.id) + " tbody:first").empty().append(f)
                                }
                                if (d && a.p.scroll) {
                                    b(">div:first", c).css({
                                        height: "auto"
                            ...
                            ca = function(c, d, e, f, i) {
                                var g = "-1",
                                    h = "",
                                    j, d = d ? "display:none;" : "",
                                    e = "ui-widget-content jqgrow ui-row-" + a.p.direction + e,
                                    f = b.isFunction(a.p.rowattr) ? a.p.rowattr.call(a, f, i) : {};
                            ...
                            da = function(c, d, e, f, g) {
                                var i = new Date,
                                    h = a.p.datatype != "local" && a.p.loadonce || a.p.datatype == "xmlstring",
                                    j = a.p.xmlReader,
                                ...
                                if (b.isXMLDoc(c)) {
                                    ...
                                    var s, w, p = 0,
                                        l, m = a.p.multiselect === true ? 1 : 0,
                                        q = a.p.subGrid ===
                                        true ? 1 : 0,
                                        I = a.p.rownumbers === true ? 1 : 0,
                                        M, n = [],
                                        W, B = {},
                                        t, y, r = [],
                                        x = a.p.altRows === true ? " " + a.p.altclass : "",
                                        u;
                                    j.repeatitems || (n = ba(k));
                                    M = a.p.keyIndex === false ? b.isFunction(j.id) ? j.id.call(a, c) : j.id : a.p.keyIndex;
                                    if (n.length > 0 && !isNaN(M)) {
                                        a.p.remapColumns && a.p.remapColumns.length && (M = b.inArray(M, a.p.remapColumns));
                                        M = n[M]
                                    }
                                    k = (M + "").indexOf("[") === -1 ? n.length ? function(a, c) {
                                        return b(M, a).text() || c
                                    } : function(a, c) {
                                        return b(j.cell, a).eq(M).text() || c
                                    } : function(a, b) {
                                    ...
                                    if (N > 0 && a.p.page <=
                                        0) a.p.page = 1;
                                    if (c && N) {
                                        var H = a.p.scroll ? b.jgrid.randId() : 1;
                                        g && (A = A * (g + 1));
                                        for (var g = b.isFunction(a.p.afterInsertRow), E = a.p.grouping && a.p.groupingView.groupCollapse === true; o < N;) {
                                            t = c[o];
                                            y = k(t, H + o);
                                            y = a.p.idPrefix + y;
                                            s = e === 0 ? 0 : e + 1;
                                            u = (s + o) % 2 == 1 ? x : "";
                                            var J = [];
                                            I && (J[J.length] = V(0, o, a.p.page, a.p.rowNum));
                                            m && (J[J.length] = O(y, I, o));
                                            q && (J[J.length] = b(a).jqGrid("addSubGridCell", m + I, o + e));
                                            if (j.repeatitems) {
                                                W || (W = R(m + q + I));
                                                var F = b.jgrid.getXmlData(t, j.cell, true);
                                                b.each(W, function(b) {
                                                    var c = F[this];
                                                    if (!c) return false;
                                                    l = c.textContent || c.text;
                                                    B[a.p.colModel[b + m + q + I].name] = l;
                                                    J[J.length] = D(y, l, b + m + q + I, o + e, t)
                                                })
                                            } else
                                                for (s = 0; s < n.length; s++) {
                                                    l = b.jgrid.getXmlData(t, n[s]);
                                                    B[a.p.colModel[s + m + q + I].name] = l;
                                                    J[J.length] = D(y, l, s + m + q + I, o + e, t)
                                                }
                                            r.push(ca(y, E, u, B, t));
                                            r.push(J.join(""));
                                            r.push("</tr>");
                                            if (a.p.grouping) {
                                                ...
                                                u = [];
                                                for (var C = 0; C < s; C++) u.push(B[a.p.groupingView.groupField[C]]);
                                                v = b(a).jqGrid("groupingPrepare", r, u, v, B);
                                                r = []
                                            }
                                            if (h || a.p.treeGrid === true) {
                                                B._id_ = y;
                                                a.p.data.push(B);
                                                a.p._index[y] =
                                                    a.p.data.length - 1
                                            ...
                                            if (a.p.gridview === false) {
                                                ...
                                                b(a).triggerHandler("jqGridAfterInsertRow", [y, B, t]);
                                                g && a.p.afterInsertRow.call(a, y, B, t);
                                                r = []
                                            }
                                            B = {};
                                            p++;
                                    ...
                                    if (a.p.gridview === true) {
                                        ...
                                        if (a.p.grouping) {
                                            b(a).jqGrid("groupingRender", v, a.p.colModel.length);
                                            v = null
                                        } else a.p.treeGrid === true && w > 0 ? b(a.rows[w]).after(r.join("")) : b("tbody:first", d).append(r.join(""))
                                    }
                                    if (a.p.subGrid === true) try {
                                        b(a).jqGrid("addSubGrid", m + I)
                                    } catch (K) {}
                                    a.p.totaltime =
                                        new Date - i;
                                    if (p > 0 && a.p.records === 0) a.p.records = N;
                                    r = null;
                                    if (a.p.treeGrid === true) try {
                                        b(a).jqGrid("setTreeNode", w + 1, p + w + 1)
                                    } catch (P) {}
                                    ...
                                    if (h)
                                        for (; p < N;) {
                                            ...
                                            if (j.repeatitems) {
                                                W || (W = R(m + q + I));
                                                var Q = b.jgrid.getXmlData(t, j.cell, true);
                                                b.each(W, function(b) {
                                                    var c =
                                                        Q[this];
                                                    if (!c) return false;
                                            ...
                                            B._id_ = y;
                                            a.p.data.push(B);
                                            a.p._index[y] = a.p.data.length - 1;
                                            B = {};
                                            p++
                                        }
                                }
                            },
                            fa = function(c, d, e, f, g) {
                                var i = new Date;
                                if (c) {
                                    if (a.p.treeANode === -1 && !a.p.scroll) {
                                        S(d, false, true);
                                    ...
                                    var h, j = a.p.datatype != "local" && a.p.loadonce || a.p.datatype == "jsonstring";
                                    if (j) {
                                        a.p.data = [];
                                        a.p._index = {};
                                        a.p.localReader.id = "_id_"
                                    ...
                                    var k = 0,
                                        s, w, p = [],
                                        l, m = a.p.multiselect ? 1 : 0,
                                        q = a.p.subGrid ? 1 : 0,
                                        n = a.p.rownumbers === true ? 1 : 0,
                                        r, u, o = {},
                                        B, t, y = [],
                                        x = a.p.altRows === true ? " " + a.p.altclass : "",
                                        v;
                                    a.p.page = b.jgrid.getAccessor(c, d.page) || 0;
                                    r = b.jgrid.getAccessor(c, d.total);
                                    a.p.lastpage = r === void 0 ? 1 : r;
                                    a.p.records = b.jgrid.getAccessor(c, d.records) || 0;
                                    a.p.userData = b.jgrid.getAccessor(c, d.userdata) || {};
                                    d.repeatitems || (l = p = ba(h));
                                    h = a.p.keyIndex === false ? b.isFunction(d.id) ?
                                        d.id.call(a, c) : d.id : a.p.keyIndex;
                                    if (p.length > 0 && !isNaN(h)) {
                                        a.p.remapColumns && a.p.remapColumns.length && (h = b.inArray(h, a.p.remapColumns));
                                        h = p[h]
                                    }(u = b.jgrid.getAccessor(c, d.root)) || (u = []);
                                    r = u.length;
                                    c = 0;
                                    if (r > 0 && a.p.page <= 0) a.p.page = 1;
                                    var A = parseInt(a.p.rowNum, 10),
                                        N = a.p.scroll ? b.jgrid.randId() : 1;
                                    g && (A = A * (g + 1));
                                    for (var E = b.isFunction(a.p.afterInsertRow), C = {}, F = a.p.grouping && a.p.groupingView.groupCollapse === true; c < r;) {
                                        g = u[c];
                                        t = b.jgrid.getAccessor(g, h);
                                        if (t === void 0) {
                                            t = N + c;
                                            if (p.length === 0 && d.cell) {
                                                s = b.jgrid.getAccessor(g,
                                                    d.cell);
                                                t = s !== void 0 ? s[h] || t : t
                                            }
                                        }
                                        ...
                                        v = (s + c) % 2 == 1 ? x : "";
                                        var H = [];
                                        n && (H[H.length] = V(0, c, a.p.page, a.p.rowNum));
                                        m && (H[H.length] = O(t, n, c));
                                        q && (H[H.length] = H[H.length] + b(a).jqGrid("addSubGridCell", m + n, c + e));
                                        if (d.repeatitems) {
                                            d.cell && (g = b.jgrid.getAccessor(g, d.cell));
                                            l || (l = R(m + q + n))
                                        }
                                        for (w = 0; w < l.length; w++) {
                                            s = b.jgrid.getAccessor(g, l[w]);
                                            H[H.length] = D(t, s, w + m + q + n, c + e, g);
                                            o[a.p.colModel[w + m + q + n].name] = s
                                        }
                                        y.push(ca(t, F, v, o, g));
                                        y.push(H.join(""));
                                        y.push("</tr>");
                                        if (a.p.grouping) {
                                            s = a.p.groupingView.groupField.length;
                                            w = [];
                                            for (v = 0; v < s; v++) w.push(o[a.p.groupingView.groupField[v]]);
                                            C = b(a).jqGrid("groupingPrepare", y, w, C, o);
                                            y = []
                                        }
                                        ...
                                        if (a.p.gridview === false) {
                                            b("#" + b.jgrid.jqID(a.p.id) + " tbody:first").append(y.join(""));
                                            b(a).triggerHandler("jqGridAfterInsertRow", [t, o, g]);
                                            E && a.p.afterInsertRow.call(a, t, o, g);
                                            y = []
                                        }
                                        o = {};
                                        k++;
                                    ...
                                    if (a.p.gridview === true) {
                                        ...
                                        a.p.grouping ? b(a).jqGrid("groupingRender",
                                            C, a.p.colModel.length) : a.p.treeGrid === true && B > 0 ? b(a.rows[B]).after(y.join("")) : b("#" + b.jgrid.jqID(a.p.id) + " tbody:first").append(y.join(""))
                                    }
                                    if (a.p.subGrid === true) try {
                                        b(a).jqGrid("addSubGrid", m + n)
                                    } catch (K) {}
                                    a.p.totaltime = new Date - i;
                                    if (k > 0 && a.p.records === 0) a.p.records = r;
                                    if (a.p.treeGrid === true) try {
                                        b(a).jqGrid("setTreeNode", B + 1, k + B + 1)
                                    } catch (J) {}
                                    if (!a.p.treeGrid && !a.p.scroll) a.grid.bDiv.scrollTop = 0;
                                    a.p.reccount = k;
                                    a.p.treeANode = -1;
                                    ...
                                    if (j)
                                        for (; k < r && u[k];) {
                                            ...
                                            if (t === void 0) {
                                                t = N + k;
                                                p.length === 0 && d.cell && (t = b.jgrid.getAccessor(g, d.cell)[h] || t)
                                            }
                                            if (g) {
                                                t = a.p.idPrefix + t;
                                                if (d.repeatitems) {
                            ...
                            pa = function() {
                                function c(d) {
                                    var e =
                                        ...
                                        g, h, i, j, T;
                                    if (d.groups !== void 0) {
                                        (h = d.groups.length && d.groupOp.toString().toUpperCase() === "OR") && p.orBegin();
                                    ...
                                    if (d.rules !== void 0) {
                                        if (e > 0) {
                                            h = p.select();
                                            p = b.jgrid.from(h);
                                            a.p.ignoreCase && (p = p.ignoreCase())
                                        }
                                        try {
                                            (i = d.rules.length && d.groupOp.toString().toUpperCase() === "OR") && p.orBegin();
                                            for (g = 0; g < d.rules.length; g++) {
                                                ...
                                                if (w[T.op] && T.field) {
                                                    e > 0 && j && j === "OR" &&
                                                        (p = p.or());
                                                    p = w[T.op](p, j)(T.field, T.data, f[T.field])
                                                }
                                                e++
                                            }
                                            i && p.orEnd()
                                    ...
                                    b.each(a.p.colModel, function() {
                                        ...
                                        if (j == "date" || j == "datetime") {
                                            if (this.formatter && typeof this.formatter === "string" && this.formatter == "date") {
                                                ...
                                                k = this.formatoptions && this.formatoptions.newformat ?
                                        ...
                                        if (a.p.grouping && this.name == l.groupField[0]) {
                                            var c = this.name;
                                    ...
                                    if (a.p.treeGrid) b(a).jqGrid("SortTree", d, a.p.sortorder, f[d].stype, f[d].srcfmt);
                                        ...
                                        if (a.p.search === true) {
                                            ...
                                            if (m) {
                                                ...
                                                p = w[a.p.postData.searchOper](p)(a.p.postData.searchField, a.p.postData.searchString, f[a.p.postData.searchField])
                                            } catch (q) {}
                                        }
                                        if (a.p.grouping) {
                                            p.orderBy(h,
                                                l.groupOrder[0], g[0].stype, g[0].srcfmt);
                                            l.groupDataSorted = true
                                        }
                                        d && a.p.sortorder && e && (a.p.sortorder.toUpperCase() == "DESC" ? p.orderBy(a.p.sortname, "d", f[d].stype, f[d].srcfmt) : p.orderBy(a.p.sortname, "a", f[d].stype, f[d].srcfmt));
                                        var m = p.select(),
                                            n = parseInt(a.p.rowNum, 10),
                                            r = m.length,
                                            o = parseInt(a.p.page, 10),
                                            u = Math.ceil(r / n),
                                            v = {},
                                            m = m.slice((o - 1) * n, o * n),
                                            f = p = null;
                                        v[a.p.localReader.total] = u;
                                        v[a.p.localReader.page] = o;
                                        v[a.p.localReader.records] = r;
                                        v[a.p.localReader.root] = m;
                            ...
                            P = function(c) {
                                if (!a.grid.hDiv.loading) {
                                    ...
                                    if (a.p.grouping) {
                                        ...
                                        a.p.groupingView.groupDataSorted === true && (e[g.sort] = a.p.groupingView.groupField[0] + " " + a.p.groupingView.groupOrder[0] + ", " + e[g.sort])
                                    }
                                    b.extend(a.p.postData, e);
                                    var k = !a.p.scroll ? 1 : a.rows.length - 1,
                                                ...
                                                case "script":
                                                    b.ajax(b.extend({
                                                            ...
                                                            success: function(e, g, h) {
                                                                b.isFunction(a.p.beforeProcessing) && a.p.beforeProcessing.call(a, e, g, h);
                                                                f === "xml" ? da(e, a.grid.bDiv,
                                                                    k, c > 1, j) : fa(e, a.grid.bDiv, k, c > 1, j);
                        ...
                        l = function(c, d) {
                            var e = "",
                                f = "<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' role='presentation' class='ui-pg-table'><tbody><tr>",
                                g = "",
                            ...
                            k = c + "_center";
                            l = c + "_right";
                            b("#" + b.jgrid.jqID(c)).append("<div id='" + i + "' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='presentation row'><tbody><tr><td id='" +
                            ...
                            h == "rtl" && (f = f + g);
                            a.p.pginput === true && (e = "<td dir='" +
                                h + "'>" + b.jgrid.format(a.p.pgtext || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox' title='page Number' />", "<span id='sp_1_" + b.jgrid.jqID(c) + "'></span>") + "</td>");
                            if (a.p.pgbuttons === true) {
                                j = ["first" + d, "prev" + d, "next" + d, "last" + d];
                                h == "rtl" && j.reverse();
                                f = f + ("<td id='" + j[0] + "' class='ui-pg-button ui-corner-all'><span tabindex = '0' role='button'  class='ui-icon ui-icon-seek-first'></span></td>");
                                f = f + ("<td id='" + j[1] + "' class='ui-pg-button ui-corner-all'><span tabindex = '0' role='button'  class='ui-icon ui-icon-seek-prev'></span></td>");
                                f = f + (e !== "" ? "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>" + e + "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>" : "") + ("<td id='" + j[2] + "' class='ui-pg-button ui-corner-all'><span  tabindex = '0' role='button' class='ui-icon ui-icon-seek-next'></span></td>");
                                f = f + ("<td id='" + j[3] + "' class='ui-pg-button ui-corner-all'><span tabindex = '0' role='button' class='ui-icon ui-icon-seek-end'></span></td>")
                            } else e !== "" && (f = f + e);
                            h == "ltr" && (f = f + g);
                            f = f + "</tr></tbody></table>";
                            a.p.viewrecords === true && b("td#" + c + "_" + a.p.recordpos, "#" + i).append("<div dir='" + h + "' style='text-align:" + a.p.recordpos + "' class='ui-paging-info'></div>");
                        ...
                        var ma = function(c,
                                ...
                                if (a.p.colModel[d].sortable && !(a.p.savedRow.length > 0)) {
                                    if (!e) {
                                        if (a.p.lastsort < 0) a.p.lastsort = 0;
                                        if (a.p.lastsort == d)
                                    ...
                                    if (b(a).triggerHandler("jqGridSortCol", [c, d, e]) === "stop") a.p.lastsort = d;
                                        ...
                                        if (a.p.datatype == "local") a.p.deselectAfterSort && b(a).jqGrid("resetSelection");
                                            ...
                                            a.p.selrow =
                                                null;
                                            a.p.multiselect && ga(false);
                                            a.p.selarrrow = [];
                                            a.p.savedRow = []
                                        }
                                        if (a.p.scroll) {
                                            e = a.grid.bDiv.scrollLeft;
                                            S(a.grid.bDiv, true, false);
                            ...
                            ra = function(c) {
                                var d, e = {},
                                    f = m ? 0 : a.p.cellLayout;
                                for (d = e[0] = e[1] = e[2] = 0; d <= c; d++) a.p.colModel[d].hidden === false && (e[0] = e[0] + (a.p.colModel[d].width + f));
                                a.p.direction ==
                                    "rtl" && (e[0] = a.p.width - e[0]);
                                e[0] = e[0] - a.grid.bDiv.scrollLeft;
                                b(a.grid.cDiv).is(":visible") && (e[1] = e[1] + (b(a.grid.cDiv).height() + parseInt(b(a.grid.cDiv).css("padding-top"), 10) + parseInt(b(a.grid.cDiv).css("padding-bottom"), 10)));
                                if (a.p.toolbar[0] === true && (a.p.toolbar[1] == "top" || a.p.toolbar[1] == "both")) e[1] = e[1] + (b(a.grid.uDiv).height() + parseInt(b(a.grid.uDiv).css("border-top-width"), 10) + parseInt(b(a.grid.uDiv).css("border-bottom-width"), 10));
                                a.p.toppager && (e[1] = e[1] + (b(a.grid.topDiv).height() + parseInt(b(a.grid.topDiv).css("border-bottom-width"),
                                    10)));
                                e[2] = e[2] + (b(a.grid.bDiv).height() + b(a.grid.hDiv).height());
                                return e
                            },
                            na = function(c) {
                        ...
                        !0 === a.p.grouping && (a.p.scroll = !1, a.p.rownumbers = !1, a.p.subGrid = !1, a.p.treeGrid = !1, a.p.gridview = !0);
                        ...
                        this.p.multiselect && (this.p.colNames.unshift("<input role='checkbox' id='cb_" + this.p.id + "' class='cbox' type='checkbox'/>"), this.p.colModel.unshift({
                            name: "cb",
                            width: m ? a.p.multiselectWidth + a.p.cellLayout : a.p.multiselectWidth,
                            sortable: !1,
                            resizable: !1,
                            hidedlg: !0,
                            search: !1,
                        ...
                        if (!0 === a.p.shrinkToFit && !0 === a.p.forceFit)
                            for (e = a.p.colModel.length - 1; 0 <= e; e--)
                                if (!a.p.colModel[e].hidden) {
                                    a.p.colModel[e].resizable = !1;
                                    break
                                }
                                "horizontal" == a.p.viewsortcols[1] && (X = " ui-i-asc", Q = " ui-i-desc");
                        oa = k ? "class='ui-th-div-ie'" : "";
                        X = "<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc" + X + " ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-" + h + "'></span>" + ("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + Q + " ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-" +
                            h + "'></span></span>");
                        for (e = 0; e < this.p.colNames.length; e++) Q = a.p.headertitles ? ' title="' + b.jgrid.stripHtml(a.p.colNames[e]) + '"' : "", A += "<th id='" + a.p.id + "_" + a.p.colModel[e].name + "' role='columnheader' class='ui-state-default ui-th-column ui-th-" + h + "'" + Q + ">", Q = a.p.colModel[e].index || a.p.colModel[e].name, A += "<div id='jqgh_" + a.p.id + "_" + a.p.colModel[e].name + "' " + oa + ">" + a.p.colNames[e], a.p.colModel[e].width = a.p.colModel[e].width ? parseInt(a.p.colModel[e].width, 10) : 150, "boolean" !== typeof a.p.colModel[e].title &&
                            (a.p.colModel[e].title = !0), Q == a.p.sortname && (a.p.lastsort = e), A += X + "</div></th>";
                        X = null;
                        ...
                        if (this.p.multiselect) {
                            ...
                            b("#cb_" + b.jgrid.jqID(a.p.id), this).bind("click", function() {
                                ...
                                if (this.checked) {
                                    b(a.rows).each(function(d) {
                                        if (d > 0 && !b(this).hasClass("ui-subgrid") &&
                                            !b(this).hasClass("jqgroup") && !b(this).hasClass("ui-state-disabled")) {
                                    ...
                                    b(a.rows).each(function(d) {
                                        if (d >
                                            0 && !b(this).hasClass("ui-subgrid") && !b(this).hasClass("ui-state-disabled")) {
                                ...
                                b(a).triggerHandler("jqGridSelectAll", [Y ? a.p.selarrrow : ja, Y]);
                                b.isFunction(a.p.onSelectAll) && a.p.onSelectAll.call(a, Y ? a.p.selarrrow : ja, Y)
                            })
                        }!0 === a.p.autowidth && (A = b(n).innerWidth(), a.p.width = 0 < A ? A : "nw");
                        (function() {
                            var d = 0,
                                e = m ? 0 : q(a.p.cellLayout, 0),
                                f = 0,
                                g, h = q(a.p.scrollOffset, 0),
                                j, k = false,
                                l, n = 0,
                                r = 0,
                                o;
                            b.each(a.p.colModel, function() {
                                ...
                                this.widthOrg = j = q(this.width, 0);
                                if (this.hidden === false) {
                                    d = d + (j + e);
                                    this.fixed ? n = n + (j + e) : f++;
                                    r++
                                }
                            });
                            isNaN(a.p.width) ? a.p.width = c.width = d : c.width = a.p.width;
                            a.p.tblwidth = d;
                            ...
                            if (a.p.shrinkToFit === true && f > 0) {
                                ...
                                b.each(a.p.colModel, function(b) {
                                    if (this.hidden === false && !this.fixed) {
                                        this.width = j = Math.round(l * this.width / (a.p.tblwidth - e * f - n));
                                        d = d + j;
                                        g = b
                                    }
                                });
                                o = 0;
                                k ? c.width - n - (d + e * f) !== h && (o = c.width - n - (d + e * f) - h) : !k && Math.abs(c.width - n - (d + e * f)) !== 1 && (o = c.width - n - (d + e * f));
                                a.p.colModel[g].width = a.p.colModel[g].width + o;
                                a.p.tblwidth = d + o + e * f + n;
                                if (a.p.tblwidth >
                                    a.p.width) {
                        ...
                        b(n).css("width", c.width + "px").append("<div class='ui-jqgrid-resize-mark' id='rs_m" + a.p.id + "'>&#160;</div>");
                        b(j).css("width", c.width + "px");
                        var A = b("thead:first", a).get(0),
                            U = "";
                        a.p.footerrow && (U += "<table role='presentation grid' style='width:" + a.p.tblwidth + "px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-" +
                            h + "'>");
                        var j = b("tr:first", A),
                            Z = "<tr class='jqgfirstrow' role='row' style='height:auto'>";
                        a.p.disableClick = !1;
                        b("th", j).each(function(d) {
                            ha = a.p.colModel[d].width;
                            ...
                            if (a.p.colModel[d].resizable) {
                                ...
                                b(aa).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + h);
                                b.browser.opera || b(aa).css("cursor", "col-resize");
                                b(this).addClass(a.p.resizeclass)
                            } else aa = "";
                            b(this).css("width", ha + "px").prepend(aa);
                            var e = "";
                            if (a.p.colModel[d].hidden) {
                                b(this).css("display", "none");
                                e = "display:none;"
                            }
                            Z = Z + ("<td role='gridcell' style='height:0px;width:" + ha + "px;" + e + "'></td>");
                            c.headers[d] = {
                                width: ha,
                                el: this
                            };
                            ia = a.p.colModel[d].sortable;
                            if (typeof ia !== "boolean") ia = a.p.colModel[d].sortable = true;
                            ...
                            if (ia)
                                if (a.p.viewsortcols[0]) {
                                    ...
                                    d == a.p.lastsort && b("div span.ui-icon-" + a.p.sortorder,
                                        this).removeClass("ui-state-disabled")
                                } else if (d == a.p.lastsort) {
                                b("div span.s-ico", this).show();
                                b("div span.ui-icon-" + a.p.sortorder, this).removeClass("ui-state-disabled")
                            }
                            a.p.footerrow && (U = U + ("<td role='gridcell' " + x(d, 0, "", null, "", false) + ">&#160;</td>"))
                        ...
                        a.p.footerrow && (U += "</tr></tbody></table>");
                        Z += "</tr>";
                        this.appendChild(document.createElement("tbody"));
                        b(this).addClass("ui-jqgrid-btable").append(Z);
                        var Z = null,
                            j = b("<table class='ui-jqgrid-htable' style='width:" + a.p.tblwidth + "px' role='presentation grid' aria-labelledby='gbox_" + this.id + "' cellspacing='0' cellpadding='0' border='0'></table>").append(A),
                            E = a.p.caption && !0 === a.p.hiddengrid ? !0 : !1;
                        e = b("<div class='ui-jqgrid-hbox" + ("rtl" == h ? "-rtl" : "") + "'></div>");
                        A = null;
                        ...
                        a.p.pager && ("string" == typeof a.p.pager ? "#" != a.p.pager.substr(0, 1) && (a.p.pager = "#" + a.p.pager) : a.p.pager = "#" + b(a.p.pager).attr("id"), b(a.p.pager).css({
                            width: c.width + "px"
                        }).appendTo(n).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom"), E && b(a.p.pager).hide(), l(a.p.pager, ""));
                        ...
                        b(a).before(c.hDiv).click(function(c) {
                            o = c.target;
                            u = b(o, a.rows).closest("tr.jqgrow");
                            if (b(u).length === 0 || u[0].className.indexOf("ui-state-disabled") > -1 || (b(o, a).closest("table.ui-jqgrid-btable").attr("id") || "").replace("_frozen", "") !== a.id) return this;
                            var d = b(o).hasClass("cbox"),
                                e = b(a).triggerHandler("jqGridBeforeSelectRow", [u[0].id, c]);
                            (e = e === false || e === "stop" ? false : true) && b.isFunction(a.p.beforeSelectRow) && (e = a.p.beforeSelectRow.call(a,
                                u[0].id, c));
                            if (!(o.tagName == "A" || (o.tagName == "INPUT" || o.tagName == "TEXTAREA" || o.tagName == "OPTION" || o.tagName == "SELECT") && !d) && e === true) {
                                v = u[0].id;
                                F = b.jgrid.getCellIndex(o);
                                ka = b(o).closest("td,th").html();
                                b(a).triggerHandler("jqGridCellSelect", [v, F, ka, c]);
                                b.isFunction(a.p.onCellSelect) && a.p.onCellSelect.call(a, v, F, ka, c);
                                if (a.p.cellEdit === true)
                                    if (a.p.multiselect && d) b(a).jqGrid("setSelection", v, true, c);
                                    else {
                                        v = u[0].rowIndex;
                                        try {
                                            b(a).jqGrid("editCell", v, F, true)
                                        } catch (f) {}
                            ...
                            if (b(u).length !== 0) {
                                v = u[0].rowIndex;
                                F = b.jgrid.getCellIndex(o);
                                b(a).triggerHandler("jqGridDblClickRow", [b(u).attr("id"), v, F, c]);
                            ...
                            if (b(u).length !== 0) {
                                ...
                                v = u[0].rowIndex;
                                F = b.jgrid.getCellIndex(o);
                                b(a).triggerHandler("jqGridRightClickRow", [b(u).attr("id"), v, F, c]);
                        ...
                        var la = !0 === a.p.hidegrid ? b("<a role='link' href='javascript:void(0)'/>").addClass("ui-jqgrid-titlebar-close HeaderButton").hover(function() {
                        ...
                        b(c.cDiv).append(la).append("<span class='ui-jqgrid-title" + ("rtl" == h ? "-rtl" : "") + "'>" + a.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix");
                        ...
                        a.p.footerrow && (c.sDiv = b("<div class='ui-jqgrid-sdiv'></div>")[0], e = b("<div class='ui-jqgrid-hbox" + ("rtl" == h ? "-rtl" : "") + "'></div>"), b(c.sDiv).append(e).insertAfter(c.hDiv).width(c.width), b(e).append(U), c.footers =
                            b(".ui-jqgrid-ftable", c.sDiv)[0].rows[0].cells, a.p.rownumbers && (c.footers[0].className = "ui-state-default jqgrid-rownum"), E && b(c.sDiv).hide());
                        e = null;
                        if (a.p.caption) {
                            var sa = a.p.datatype;
    ...
    b.jgrid.extend({
        ...
        getDataIDs: function() {
            ...
            this.each(function() {
                if ((c = this.rows.length) && 0 < c)
                    for (; e < c;) b(this.rows[e]).hasClass("jqgrow") && (f[d] = this.rows[e].id, d++), e++
            });
            return f
        },
        setSelection: function(f, e, c) {
            return this.each(function() {
                var d, a, i, g, h, j;
                if (void 0 !== f && (e = !1 === e ? !1 : !0, (a = this.rows.namedItem(f + "")) && a.className && !(-1 < a.className.indexOf("ui-state-disabled"))))(!0 === this.p.scrollrows && (i = this.rows.namedItem(f).rowIndex, 0 <= i && (d = b(this.grid.bDiv)[0].clientHeight,
                    ...
                    "prop" : "attr"]("checked", d)), b(this).triggerHandler("jqGridSelectRow", [a.id, d, c]), this.p.onSelectRow && e && this.p.onSelectRow.call(this, a.id, d, c)) : "ui-subgrid" !== a.className && (this.p.selrow != a.id ? (b(this.rows.namedItem(this.p.selrow)).removeClass("ui-state-highlight").attr({
                    "aria-selected": "false",
                    tabindex: "-1"
                }), b(a).addClass("ui-state-highlight").attr({
                    "aria-selected": "true",
                    tabindex: "0"
                }), j && (b("#" + b.jgrid.jqID(this.p.selrow), "#" + b.jgrid.jqID(j)).removeClass("ui-state-highlight"), b("#" + b.jgrid.jqID(f),
        ...
        resetSelection: function(f) {
            return this.each(function() {
                ...
                if ("undefined" !== typeof f) {
                    ...
                    b(c).removeClass("ui-state-highlight").attr("aria-selected",
                        "false");
                    ...
                    "#" + b.jgrid.jqID(a)).removeClass("ui-state-highlight"), e.p.selrow = null);
        ...
        getRowData: function(f) {
            ...
            this.each(function() {
                var g = this,
                    h, j;
                if ("undefined" == typeof f) d = !0, c = [], a = g.rows.length;
                else {
                ...
                for (; i < a;) d &&
                    (j = g.rows[i]), b(j).hasClass("jqgrow") && (b("td", j).each(function(a) {
                        h = g.p.colModel[a].name;
                        if ("cb" !== h && "subgrid" !== h && "rn" !== h)
                            if (!0 === g.p.treeGrid && h == g.p.ExpandColumn) e[h] = b.jgrid.htmlDecode(b("span:first", this).html());
                            else try {
                                e[h] = b.unformat.call(g, this, {
                                    rowId: j.id,
        ...
        delRowData: function(f) {
            ...
            this.each(function() {
                if (c = this.rows.namedItem(f)) {
                    if (b(c).remove(), this.p.records--,
                        this.p.reccount--, this.updatepager(!0, !1), e = !0, this.p.multiselect && (d = b.inArray(f, this.p.selarrrow), -1 != d && this.p.selarrrow.splice(d, 1)), f == this.p.selrow) this.p.selrow = null
                } else return !1;
                ...
                if (!0 === this.p.altRows && e) {
                    ...
                    b(this.rows).each(function(a) {
                        1 == a % 2 ? b(this).addClass(i) : b(this).removeClass(i)
                    })
                }
            });
            return e
        },
        setRowData: function(f,
            e, c) {
            var d, a = !0,
                i;
            this.each(function() {
                ...
                if (e) try {
                    if (b(this.p.colModel).each(function(a) {
                            d = this.name;
                            void 0 !== e[d] && (k[d] = this.formatter && "string" === typeof this.formatter && "date" == this.formatter ? b.unformat.date.call(g, e[d], this) : e[d], h = g.formatter(f, e[d], a, e, "edit"), i = this.title ? {
                                title: b.jgrid.stripHtml(h)
                            } : {}, !0 === g.p.treeGrid && d == g.p.ExpandColumn ? b("td:eq(" + a + ") > span:first", j).html(h).attr(i) : b("td:eq(" + a +
                                ")", j).html(h).attr(i))
                        }), "local" == g.p.datatype) {
                        var m = b.jgrid.stripPref(g.p.idPrefix, f),
                            n = g.p._index[m];
                        if (g.p.treeGrid)
                            for (var q in g.p.treeReader) k.hasOwnProperty(g.p.treeReader[q]) && delete k[g.p.treeReader[q]];
                        "undefined" != typeof n && (g.p.data[n] = b.extend(!0, g.p.data[n], k));
                        k = null
                    }
                } catch (x) {
                    a = !1
        ...
        addRowData: function(f, e, c, d) {
            ...
            var a = !1,
                ...
                x, r, C, D,
                O, V;
            e && (b.isArray(e) ? (x = !0, c = "last", r = f) : (e = [e], x = !1), this.each(function() {
                var ba = e.length;
                ...
                if (!x)
                    if (typeof f != "undefined") f = f + "";
                        ...
                        if (this.p.keyIndex !== false) {
                            r = this.p.colModel[this.p.keyIndex + h + j + l].name;
                            typeof e[0][r] != "undefined" && (f = e[0][r])
                        }
                    }
                C = this.p.altclass;
                for (var R = 0, S = "", K = {}, ca = b.isFunction(this.p.afterInsertRow) ? true : false; R < ba;) {
                    D = e[R];
                    g = "";
                    if (x) {
                        try {
                        ...
                        S =
                            this.p.altRows === true ? (this.rows.length - 1) % 2 === 0 ? C : "" : ""
                    }
                    V = f;
                    f = this.p.idPrefix + f;
                    if (l) {
                        q = this.formatCol(0, 1, "", null, f, true);
                        g = g + ('<td role="gridcell" aria-describedby="' + this.p.id + '_rn" class="ui-state-default jqgrid-rownum" ' + q + ">0</td>")
                    }
                    if (h) {
                        n = '<input role="checkbox" type="checkbox" id="jqg_' + this.p.id + "_" + f + '" class="cbox"/>';
                        q = this.formatCol(l, 1, "", null, f, true);
                        g = g + ('<td role="gridcell" aria-describedby="' + this.p.id + '_cb" ' + q + ">" + n + "</td>")
                    }
                    j && (g = g + b(this).jqGrid("addSubGridCell", h + l, 1));
                    for (m =
                        h + j + l; m < this.p.colModel.length; m++) {
                        O = this.p.colModel[m];
                        i = O.name;
                        K[i] = O.formatter && typeof O.formatter === "string" && O.formatter == "date" ? b.unformat.date.call(this, D[i], O) : D[i];
                        n = this.formatter(f, b.jgrid.getAccessor(D, i), m, D, "edit");
                        q = this.formatCol(m, 1, n, D, f, true);
                        g = g + ('<td role="gridcell" aria-describedby="' + this.p.id + "_" + i + '" ' + q + ">" + n + "</td>")
                    }
                    g = '<tr id="' + f + '" role="row" tabindex="-1" class="ui-widget-content jqgrow ui-row-' + this.p.direction + " " + S + '">' + g + "</tr>";
                    if (this.rows.length === 0) b("table:first",
                        this.grid.bDiv).append(g);
                    else switch (c) {
                        case "last":
                            b(this.rows[this.rows.length - 1]).after(g);
                            k = this.rows.length - 1;
                            break;
                        case "first":
                            b(this.rows[0]).after(g);
                            k = 1;
                            break;
                        case "after":
                            (k = this.rows.namedItem(d)) && (b(this.rows[k.rowIndex + 1]).hasClass("ui-subgrid") ? b(this.rows[k.rowIndex + 1]).after(g) : b(k).after(g));
                            k++;
                            break;
                        case "before":
                    ...
                    this.p.subGrid === true && b(this).jqGrid("addSubGrid", h + l, k);
                    this.p.records++;
                    this.p.reccount++;
                    b(this).triggerHandler("jqGridAfterInsertRow", [f, D, D]);
                    ca && this.p.afterInsertRow.call(this, f, D, D);
                    R++;
                    if (this.p.datatype == "local") {
                        K[this.p.localReader.id] = V;
                        this.p._index[V] = this.p.data.length;
                        this.p.data.push(K);
                        K = {}
                    }
                }
                this.p.altRows === true && !x && (c == "last" ? (this.rows.length - 1) % 2 == 1 && b(this.rows[this.rows.length - 1]).addClass(C) : b(this.rows).each(function(a) {
                    a % 2 == 1 ? b(this).addClass(C) : b(this).removeClass(C)
                }));
        ...
        footerData: function(f, e, c) {
            ...
            this.each(function() {
                ...
                b(this.p.colModel).each(function(d) {
                    a = this.name;
                    "set" == f ? void 0 !== e[a] && (l = c ? j.formatter("", e[a], d, e, "edit") : e[a], h = this.title ? {
                        title: b.jgrid.stripHtml(l)
                    } : {}, b("tr.footrow td:eq(" + d + ")", j.grid.sDiv).html(l).attr(h), i = !0) : "get" == f && (g[a] = b("tr.footrow td:eq(" + d + ")", j.grid.sDiv).html())
                })
            });
            return "get" ==
                f ? g : i
        ...
        showHideCol: function(f, e) {
            return this.each(function() {
                var c = this,
                    d = !1,
                    a = b.browser.webkit || b.browser.safari ? 0 : c.p.cellLayout,
                    i;
                if (c.grid) {
                    "string" === typeof f && (f = [f]);
                    e = "none" != e ? "" : "none";
                    ...
                    b(this.p.colModel).each(function(h) {
                        if (-1 !== b.inArray(this.name, f) && this.hidden === g) {
                            ...
                            b(c.rows).each(function() {
                                b(this).hasClass("jqgroup") || b(this.cells[h]).css("display", e)
                            });
                            c.p.footerrow && b("tr.footrow td:eq(" + h + ")", c.grid.sDiv).css("display", e);
                            i = this.widthOrg ? this.widthOrg : parseInt(this.width, 10);
                    ...
                    !0 === d && b(c).jqGrid("setGridWidth", !0 === c.p.shrinkToFit ? c.p.tblwidth : c.p.width);
        ...
        remapColumns: function(f, e, c) {
            ...
            e && a(b("#" +
                b.jgrid.jqID(i.p.id) + " tbody:first"), ".jqgfirstrow, tr.jqgrow, tr.jqfoot");
        ...
        setGridWidth: function(f, e) {
            return this.each(function() {
                if (this.grid) {
                    var c = this,
                        d, a = 0,
                        i = b.browser.webkit || b.browser.safari ? 0 : c.p.cellLayout,
                        g, h = 0,
                        j = !1,
                        l = c.p.scrollOffset,
                        k, m = 0,
                    ...
                    if (!isNaN(f)) {
                        ...
                        !0 === c.p.toolbar[0] && (b(c.grid.uDiv).css("width", f + "px"), "both" == c.p.toolbar[1] && b(c.grid.ubDiv).css("width",
                            f + "px"));
                        ...
                        if (!0 === e) {
                            b.each(c.p.colModel, function() {
                                if (this.hidden === false) {
                                    d = this.widthOrg ? this.widthOrg : parseInt(this.width, 10);
                                    a = a + (d + i);
                                    this.fixed ? m = m + (d + i) : h++;
                                    n++
                                }
                            });
                            if (0 === h) return;
                            ...
                            var a = 0,
                                x = 0 < c.grid.cols.length;
                            b.each(c.p.colModel, function(b) {
                                if (this.hidden ===
                                    false && !this.fixed) {
                                    d = this.widthOrg ? this.widthOrg : parseInt(this.width, 10);
                                    d = Math.round(k * d / (c.p.tblwidth - i * h - m));
                                    if (!(d < 0)) {
                                        this.width = d;
                                        a = a + d;
                            ...
                            if (!g) return;
                            q = 0;
                            j ? f - m - (a + i * h) !== l && (q = f - m - (a + i * h) - l) : 1 !== Math.abs(f - m - (a + i * h)) && (q = f - m - (a + i * h));
                            c.p.colModel[g].width += q;
                            c.p.tblwidth = a + q + i * h + m;
                            c.p.tblwidth > f ? (j = c.p.tblwidth - parseInt(f, 10),
                                c.p.tblwidth = f, d = c.p.colModel[g].width -= j) : d = c.p.colModel[g].width;
                            c.grid.headers[g].width = d;
                            c.grid.headers[g].el.style.width = d + "px";
                            x && (c.grid.cols[g].style.width = d + "px");
        ...
        setLabel: function(f, e, c, d) {
            return this.each(function() {
                ...
                if (this.grid && "undefined" != typeof f && (b(this.p.colModel).each(function(b) {
                    ...
                    if (e) {
                        var g = b(".s-ico", i);
                        b("[id^=jqgh_]", i).empty().html(e).append(g);
                        this.p.colNames[a] = e
                    }
        ...
        setCell: function(f, e, c, d, a, i) {
            return this.each(function() {
                ...
                if (this.grid && (isNaN(e) ? b(this.p.colModel).each(function(a) {
                    ...
                    }) : g = parseInt(e, 10), 0 <= g && (h = this.rows.namedItem(f)))) {
                    var l = b("td:eq(" + g +
                        ")", h);
                    if ("" !== c || !0 === i) h = this.formatter(f, c, g, h, "edit"), j = this.p.colModel[g].title ? {
                        title: b.jgrid.stripHtml(h)
                    } : {}, this.p.treeGrid && 0 < b(".tree-wrap", b(l)).length ? b("span", b(l)).html(h).attr(j) : b(l).html(h).attr(j), "local" == this.p.datatype && (h = this.p.colModel[g], c = h.formatter && "string" === typeof h.formatter && "date" == h.formatter ? b.unformat.date.call(this, c, h) : c, j = this.p._index[f], "undefined" != typeof j && (this.p.data[j][h.name] = c));
                    ...
                    if (k && 0 < k) {
                        for (; m < k;) {
                            if (b(this.rows[m]).hasClass("jqgrow")) {
                                ...
                                c ? (j = parseFloat(a), i += j, 0 === m ? h = g = j : (g = Math.min(g, j), h = Math.max(h, j))) : e ? d.push({
                                    id: this.rows[m].id,
                                    value: a
                                }) : d.push(a)
                            }
        ...
        bindKeys: function(f) {
            ...
            return this.each(function() {
                ...
                b(c).keydown(function(d) {
                    ...
                    if (a)
                        if (h = c.p._index[a.id], 37 === d.keyCode || 38 === d.keyCode || 39 === d.keyCode || 40 === d.keyCode) {
                            if (38 === d.keyCode) {
                                g = a.previousSibling;
                                f = "";
                                if (g)
                            ...
                            if (40 === d.keyCode) {
                                ...
                                if (g)
                                    if (b(g).is(":hidden"))
                                        for (; g;) {
                                            if (g =
                                                g.nextSibling, !b(g).is(":hidden") && b(g).hasClass("jqgrow")) {
                                                f = g.id;
                                                break
                                            }
                                        } else f = g.id;
                            ...
                            37 === d.keyCode && (c.p.treeGrid && c.p.data[h][j] && b(a).find("div.treeclick").trigger("click"), b(c).triggerHandler("jqGridKeyLeft", [c.p.selrow]), b.isFunction(e.onLeftKey) && e.onLeftKey.call(c, c.p.selrow));
                            39 === d.keyCode && (c.p.treeGrid && !c.p.data[h][j] && b(a).find("div.treeclick").trigger("click"), b(c).triggerHandler("jqGridKeyRight", [c.p.selrow]), b.isFunction(e.onRightKey) && e.onRightKey.call(c,
                                c.p.selrow))
...
(function(b) {
    ...
    b.fn.fmatter = function(a, c, f, d, e) {
        var g = c,
            f = b.extend({}, b.jgrid.formatter, f);
        try {
            g = b.fn.fmatter[a].call(this, c, f, d, e)
        } catch (h) {}
        return g
    };
    b.fmatter.util = {
        NumberFormat: function(a, c) {
            ...
            if (b.fmatter.isNumber(a)) {
                var f = 0 > a,
                    d = a + "",
                    e = c.decimalSeparator ? c.decimalSeparator : ".",
                    g;
                ...
                d = c.prefix ? c.prefix + d : d;
                return d = c.suffix ? d + c.suffix : d
            }
            return a
        },
    ...
    b.fn.fmatter.checkbox = function(a, c) {
        var f = b.extend({}, c.checkbox),
            d;
        b.fmatter.isUndefined(c.colModel.formatoptions) || (f = b.extend({}, f, c.colModel.formatoptions));
        d = !0 === f.disabled ? 'disabled="disabled"' : "";
        if (b.fmatter.isEmpty(a) || b.fmatter.isUndefined(a)) a = b.fn.fmatter.defaultFormat(a, f);
        a = (a + "").toLowerCase();
    ...
    b.fn.fmatter.link = function(a, c) {
        ...
        return !b.fmatter.isEmpty(a) ? "<a " + d + ' href="' + a + '">' + a + "</a>" : b.fn.fmatter.defaultFormat(a,
            c)
    };
    b.fn.fmatter.showlink = function(a, c) {
        ...
        b.fmatter.isUndefined(c.colModel.formatoptions) || (f = b.extend({}, f, c.colModel.formatoptions));
        f.target && (d = "target=" + f.target);
        f = f.baseLinkUrl + f.showAction + "?" + f.idName + "=" + c.rowId + f.addParam;
        return b.fmatter.isString(a) || b.fmatter.isNumber(a) ? "<a " + d + ' href="' + f + '">' + a + "</a>" : b.fn.fmatter.defaultFormat(a, c)
    };
    b.fn.fmatter.integer = function(a,
        c) {
        var f = b.extend({}, c.integer);
        b.fmatter.isUndefined(c.colModel.formatoptions) || (f = b.extend({}, f, c.colModel.formatoptions));
        return b.fmatter.isEmpty(a) ? f.defaultValue : b.fmatter.util.NumberFormat(a, f)
    };
    b.fn.fmatter.number = function(a, c) {
        var f = b.extend({}, c.number);
        b.fmatter.isUndefined(c.colModel.formatoptions) || (f = b.extend({}, f, c.colModel.formatoptions));
        return b.fmatter.isEmpty(a) ? f.defaultValue : b.fmatter.util.NumberFormat(a, f)
    };
    b.fn.fmatter.currency = function(a, c) {
        var f = b.extend({}, c.currency);
        b.fmatter.isUndefined(c.colModel.formatoptions) ||
            (f = b.extend({}, f, c.colModel.formatoptions));
        return b.fmatter.isEmpty(a) ? f.defaultValue : b.fmatter.util.NumberFormat(a, f)
    };
    b.fn.fmatter.date = function(a, c, f, d) {
        f = b.extend({}, c.date);
        b.fmatter.isUndefined(c.colModel.formatoptions) || (f = b.extend({}, f, c.colModel.formatoptions));
        return !f.reformatAfterEdit && "edit" == d || b.fmatter.isEmpty(a) ? b.fn.fmatter.defaultFormat(a, c) : b.fmatter.util.DateFormat(f.srcformat, a, f.newformat, f)
    };
    b.fn.fmatter.select = function(a, c) {
        ...
        if (f) {
            ...
            if (b.fmatter.isString(f))
                for (var j = f.split(g), k = 0, l = 0; l < j.length; l++)
                    if (g = j[l].split(e), 2 < g.length && (g[1] = b.map(g, function(a, b) {
                            if (b > 0) return a
                        }).join(e)), h) - 1 < b.inArray(g[0], i) && (d[k] = g[1], k++);
                    else {
                        if (b.trim(g[0]) == b.trim(a)) {
                            d[0] = g[1];
                            break
                        }
                    } else b.fmatter.isObject(f) && (h ? d = b.map(i, function(a) {
                return f[a]
            }) : d[0] = f[a] || "")
        }
        a = d.join(", ");
    ...
    b.fn.fmatter.rowactionsMultifunctional=function(event,a, c, f, d){
    	...
    	jQuery.fn.fmatter.rowactions(a, c, f, d);
    };
       
    b(document).on("keypress", ".ui-icon", function (e) {     
        if (e.keyCode == 13) {
        	 b(this).trigger('click');
        }else{
        	return false;
    ...
    b.fn.fmatter.rowactions = function(a, c, f, d) {
        var e = {
            ...
            a = b.jgrid.jqID(a),
            c = b.jgrid.jqID(c),
            d = b("#" + c)[0].p.colModel[d];
        b.fmatter.isUndefined(d.formatoptions) || (e = b.extend(e, d.formatoptions));
        b.fmatter.isUndefined(b("#" + c)[0].p.editOptions) || (e.editOptions = b("#" + c)[0].p.editOptions);
        b.fmatter.isUndefined(b("#" + c)[0].p.delOptions) || (e.delOptions = b("#" + c)[0].p.delOptions);
        var g = b("#" + c)[0],
            d = function(d, f) {
                b.isFunction(e.afterSave) &&
                    e.afterSave.call(g, d, f);
            ...
            h = function(d) {
                b.isFunction(e.afterRestore) && e.afterRestore.call(g, d);
                b("tr#" + a + " div.ui-inline-edit, tr#" + a + " div.ui-inline-del", "#" + c + ".ui-jqgrid-btable:first").show();
                b("tr#" + a + " div.ui-inline-save, tr#" + a + " div.ui-inline-cancel", "#" + c + ".ui-jqgrid-btable:first").hide()
            };
        if (b("#" + a, "#" + c).hasClass("jqgrid-new-row")) {
            var i = g.p.prmNames;
            e.extraparam[i.oper] = i.addoper
        }
        switch (f) {
            case "edit":
                b("#" + c).jqGrid("editRow", a, e.keys, e.onEdit, e.onSuccess, e.url, e.extraparam, d, e.onError, h);
            ...
            case "save":
                b("#" + c).jqGrid("saveRow",
                    a, e.onSuccess, e.url, e.extraparam, d, e.onError, h) && (b("tr#" + a + " div.ui-inline-edit, tr#" + a + " div.ui-inline-del", "#" + c + ".ui-jqgrid-btable:first").show(), b("tr#" + a + " div.ui-inline-save, tr#" + a + " div.ui-inline-cancel", "#" + c + ".ui-jqgrid-btable:first").hide(), b(g).triggerHandler("jqGridAfterGridComplete"));
                break;
            case "cancel":
                ...
                break;
            case "del":
                b("#" + c).jqGrid("delGridRow", a, e.delOptions);
                break;
            case "formedit":
                b("#" + c).jqGrid("setSelection", a), b("#" + c).jqGrid("editGridRow", a, e.editOptions)
        }
    };
    b.fn.fmatter.actions = function(a, c) {
        ...
        var d = c.rowId,
            e = "",
            g;
        if ("undefined" == typeof d || b.fmatter.isEmpty(d)) return "";
        f.editformbutton ? (g = "OnKeyPress=jQuery.fn.fmatter.rowactionsMultifunctional(event,'" + d + "','" + c.gid + "','formedit'," + c.pos + "); onclick=jQuery.fn.fmatter.rowactionsMultifunctional(event,'" + d + "','" + c.gid + "','formedit'," + c.pos + "); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover');  OnFocus=jQuery(this).addClass('ui-state-hover'); OnBlur=jQuery(this).removeClass('ui-state-hover'); ", e = e + "<div title='" + b.jgrid.nav.edittitle + "' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' " + g + "><span tabindex = '0' role='button' class='ui-icon ui-icon-pencil' ></span></div>") : f.editbutton && (g = "OnKeyPress=jQuery.fn.fmatter.rowactionsMultifunctional(event,'" + d + "','" + c.gid + "','edit'," + c.pos + "); onclick=jQuery.fn.fmatter.rowactionsMultifunctional(event,'" + d + "','" + c.gid + "','edit'," + c.pos + "); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); OnFocus=jQuery(this).addClass('ui-state-hover'); OnBlur=jQuery(this).removeClass('ui-state-hover');",
            e = e + "<div  tabindex='0' role='button' title='" + b.jgrid.nav.edittitle + "' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' " + g + "><span tabindex = '0' role='button' class='ui-icon ui-icon-pencil' ></span></div>");
        f.delbutton && (g = "tabindex='0' role='button' OnKeyPress=jQuery.fn.fmatter.rowactionsMultifunctional(event,'" + d + "','" + c.gid + "','del'," + c.pos + "); onclick=jQuery.fn.fmatter.rowactionsMultifunctional(event,'" + d + "','" + c.gid + "','del'," + c.pos + "); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); OnFocus=jQuery(this).addClass('ui-state-hover'); OnBlur=jQuery(this).removeClass('ui-state-hover');", e = e + "<div title='" + b.jgrid.nav.deltitle + "' style='float:left;margin-left:5px;' class='ui-pg-div ui-inline-del' " + g + "><span class='ui-icon ui-icon-trash'></span></div>");
        g = "OnKeyPress=jQuery.fn.fmatter.rowactionsMultifunctional(event,'" + d + "','" + c.gid + "','save'," + c.pos + "); onclick=jQuery.fn.fmatter.rowactionsMultifunctional(event,'" + d + "','" + c.gid + "','save'," + c.pos + "); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); OnFocus=jQuery(this).addClass('ui-state-hover'); OnBlur=jQuery(this).removeClass('ui-state-hover');";
        e = e + "<div tabindex='0' role='button' title='" + b.jgrid.edit.bSubmit + "' style='float:left;display:none' class='ui-pg-div ui-inline-save' " + g + "><span class='ui-icon ui-icon-disk'></span></div>";
        g = "OnKeyPress=jQuery.fn.fmatter.rowactionsMultifunctional(event,'" + d + "','" + c.gid + "','cancel'," + c.pos + "); onclick=jQuery.fn.fmatter.rowactionsMultifunctional(event,'" + d + "','" + c.gid + "','cancel'," + c.pos + "); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); OnFocus=jQuery(this).addClass('ui-state-hover'); OnBlur=jQuery(this).removeClass('ui-state-hover');";
        e = e + "<div tabindex='0' role='button' title='" + b.jgrid.edit.bCancel + "' style='float:left;display:none;margin-left:5px;' class='ui-pg-div ui-inline-cancel' " + g + "><span class='ui-icon ui-icon-cancel'></span></div>";
        return "<div style='margin-left:8px;'>" + e + "</div>"
    };
    b.unformat = function(a, c, f, d) {
        var e, g = c.colModel.formatter,
            h = c.colModel.formatoptions || {},
            i = /([\.\*\_\'\(\)\{\}\+\?\\])/g,
            j = c.colModel.unformat || b.fn.fmatter[g] && b.fn.fmatter[g].unformat;
        if ("undefined" !== typeof j && b.isFunction(j)) e = j.call(this, b(a).text(), c, a);
        else if (!b.fmatter.isUndefined(g) &&
            b.fmatter.isString(g)) switch (e = b.jgrid.formatter || {}, g) {
            case "integer":
                h = b.extend({}, e.integer, h);
                c = h.thousandsSeparator.replace(i, "\\$1");
                e = b(a).text().replace(RegExp(c, "g"), "");
                break;
            case "number":
                h = b.extend({}, e.number, h);
                c = h.thousandsSeparator.replace(i, "\\$1");
                e = b(a).text().replace(RegExp(c, "g"), "").replace(h.decimalSeparator, ".");
                break;
            case "currency":
                h = b.extend({}, e.currency, h);
                c = h.thousandsSeparator.replace(i, "\\$1");
                c = RegExp(c, "g");
                e = b(a).text();
                h.prefix && h.prefix.length && (e = e.substr(h.prefix.length));
                h.suffix && h.suffix.length && (e = e.substr(0, e.length - h.suffix.length));
                e = e.replace(c, "").replace(h.decimalSeparator, ".");
                break;
            case "checkbox":
                h = c.colModel.editoptions ? c.colModel.editoptions.value.split(":") : ["Yes", "No"];
                e = b("input", a).is(":checked") ? h[0] : h[1];
                break;
            case "select":
                e = b.unformat.select(a, c, f, d);
                break;
            case "actions":
                return "";
            default:
    ...
    b.unformat.select = function(a, c, f, d) {
        ...
        a = b(a).text();
        if (!0 === d) return a;
        var d = b.extend({}, !b.fmatter.isUndefined(c.colModel.formatoptions) ? c.colModel.formatoptions : c.colModel.editoptions),
            c = void 0 === d.separator ? ":" : d.separator,
            e = void 0 === d.delimiter ? ";" : d.delimiter;
        if (d.value) {
            var g = d.value,
                d = !0 === d.multiple ? !0 : !1,
                h = [];
            d && (h = a.split(","), h = b.map(h, function(a) {
                return b.trim(a)
            }));
            if (b.fmatter.isString(g))
                for (var i = g.split(e), j = 0, k = 0; k < i.length; k++)
                    if (e = i[k].split(c), 2 < e.length && (e[1] = b.map(e, function(a, b) {
                            if (b > 0) return a
                        }).join(c)), d) - 1 < b.inArray(e[1], h) && (f[j] = e[0], j++);
                    else {
                        if (b.trim(e[1]) == b.trim(a)) {
                            f[0] = e[0];
                            break
                        }
                    } else if (b.fmatter.isObject(g) || b.isArray(g)) d || (h[0] = a), f = b.map(h, function(a) {
                var c;
    ...
    b.unformat.date = function(a, c) {
        var f = b.jgrid.formatter.date || {};
        b.fmatter.isUndefined(c.formatoptions) || (f = b.extend({}, f, c.formatoptions));
        return !b.fmatter.isEmpty(a) ? b.fmatter.util.DateFormat(f.newformat, a, f.srcformat, f) : b.fn.fmatter.defaultFormat(a,
            c)
    }
})(jQuery);
(function(a) {
                ...
                if (!this.ftoolbar) {
                    var e = function() {
                            ...
                            a.each(c.p.colModel, function() {
                                ...
                                var search_filter_id = (this.label==null || this.label == undefined || this.label == 'undefined') ? this.name:this.label;
                                if (g = a("#gs_" + a.jgrid.jqID(search_filter_id), !0 === this.frozen && !0 === c.p.frozenColumns ? c.grid.fhDiv : c.grid.hDiv).val()) d[f] = g, h[f] = m, j++;
                                else try {
                        ...
                        h = a("<tr class='ui-search-toolbar' role='rowheader'></tr>"),
                        g;
                    a.each(c.p.colModel, function() {
                        var i = this,
                            j, q, f, n;
                        q = a("<th role='columnheader' class='ui-state-default ui-th-column ui-th-" + c.p.direction + "'></th>");
                        j = a("<div style='width:100%;position:relative;height:100%;padding-right:0.3em;'></div>");
                        !0 === this.hidden && a(q).css("display",
                            "none");
                        ...
                        if (this.search) switch (this.stype) {
                            case "select":
                                if (n = this.surl || f.dataUrl) a.ajax(a.extend({
                                    ...
                                    dataType: "html",
                                    success: function(c) {
                                        if (f.buildSelect !== void 0)(c = f.buildSelect(c)) && a(j).append(c);
                                        else a(j).append(c);
                                        f.defaultValue !== void 0 && a("select", j).val(f.defaultValue);
                                        
                                        var search_filter_id = (i.label==null || i.label == undefined || i.label == 'undefined') ? i.name:i.label;
                                        
                                        a("select", j).attr({
                                            name: i.index || i.name,
                                            id: "gs_" + search_filter_id
                                        });
                                    ...
                                    var m, o, k;
                                    i.searchoptions ? (m = void 0 === i.searchoptions.value ? "" : i.searchoptions.value, o = void 0 === i.searchoptions.separator ? ":" : i.searchoptions.separator, k = void 0 === i.searchoptions.delimiter ? ";" : i.searchoptions.delimiter) : i.editoptions &&
                                        (m = void 0 === i.editoptions.value ? "" : i.editoptions.value, o = void 0 === i.editoptions.separator ? ":" : i.editoptions.separator, k = void 0 === i.editoptions.delimiter ? ";" : i.editoptions.delimiter);
                                    if (m) {
                                        ...
                                        if ("string" === typeof m) {
                                            ...
                                            for (l in m) m.hasOwnProperty(l) &&
                                                (k = document.createElement("option"), k.value = l, k.innerHTML = m[l], n.appendChild(k));
                            ...
                            case "text":
                            	  var search_filter_id = (i.label==null || i.label == undefined || i.label == 'undefined') ? i.name:i.label;
                                o = void 0 !== f.defaultValue ? f.defaultValue : "", a(j).append("<input type='text' style='width:95%;padding:0px;' name='" + (i.index || i.name) + "' id='gs_" + search_filter_id + "' value='" + o + "'/>"),
                                    f.attr && a("input", j).attr(f.attr), void 0 !== f.dataInit && f.dataInit(a("input", j)[0]), void 0 !== f.dataEvents && d(a("input", j)[0], f.dataEvents), !0 === b.autosearch && (b.searchOnEnter ? a("input", j).keypress(function(a) {
                    ...
                    this.clearToolbar = function(d) {
                        ...
                        a.each(c.p.colModel, function() {
                            ...
                            switch (this.stype) {
                                case "select":
                                	var search_filter_id = (this.label==null || this.label == undefined || this.label == 'undefined') ? this.name:this.label;
                                    a("#gs_" + a.jgrid.jqID(search_filter_id) + " option", !0 === this.frozen && !0 === c.p.frozenColumns ? c.grid.fhDiv : c.grid.hDiv).each(function(c) {
                                ...
                                case "text":
                                	var search_filter_id = (this.label==null || this.label == undefined || this.label == 'undefined') ? this.name:this.label;
                                    if (a("#gs_" + a.jgrid.jqID(search_filter_id), !0 === this.frozen && !0 === c.p.frozenColumns ? c.grid.fhDiv : c.grid.hDiv).val(b), void 0 !== b) j[f] = b, g++;
                                    else try {
                                        delete c.p.postData[f]
                                    } catch (e) {}
                            }
            ...
            return this.each(function() {
                ...
                for (d = 0; d < n; d++)
                    if (i = m[d].el, j = a(i), c = f[d], g = {
                            ...
                            role: "gridcell"
                        }).css(g).addClass("ui-first-th-" + this.p.direction).appendTo(l), i.style.width = "",
                        g = r(c.name, b.groupHeaders), 0 <= g) {
                        g = b.groupHeaders[g];
                        e = g.numberOfColumns;
                        q = g.titleText;
                        ...
                        if (0 <=
                            ...
                            a(b).bind("jqGridOnSortCol.setFrozenColumns", function(c, d) {
                                var e = a("tr.ui-jqgrid-labels:last th:eq(" + b.p.lastsort + ")", b.grid.fhDiv),
                                    g = a("tr.ui-jqgrid-labels:last th:eq(" +
                                        d + ")", b.grid.fhDiv);
            ...
            return this.each(function() {
                if (this.grid && !0 === this.p.frozenColumns) {
                    ...
                    if (!0 === this.p.hoverrows) {
                        var b;
                        a("#" + a.jgrid.jqID(this.p.id)).bind("mouseover", function(d) {
...
(function(a) {
    a.extend(a.jgrid, {
        ...
        createModal: function(d, b, c, f, g, h, i) {
            ...
            a(k).append(l);
            j ? (e.dir = "rtl", a(".ui-jqdialog-title", k).css("float", "right"), a(".ui-jqdialog-titlebar-close", k).css("left", "0.3em")) : (e.dir = "ltr", a(".ui-jqdialog-title", k).css("float", "left"), a(".ui-jqdialog-titlebar-close", k).css("right", "0.3em"));
            ...
            b = {};
            if (a.fn.jqm && !0 === c.jqModal) 0 === c.left && 0 === c.top && c.overlay && (i = [], i = this.findPos(g), c.left = i[0] + 4, c.top = i[1] + 4), b.top = c.top + "px", b.left = c.left;
            ...
            a("a.ui-jqdialog-titlebar-close", k).click(function() {
                var b = a("#" + a.jgrid.jqID(d.themodal)).data("onClose") || c.onClose,
                    e = a("#" + a.jgrid.jqID(d.themodal)).data("gbox") ||
                    c.gbox;
            ...
            f = 0;
            j && b.left && !h && (f = a(c.gbox).width() - (!isNaN(c.width) ? parseInt(c.width, 10) : 0) - 8, b.left = parseInt(b.left, 10) + parseInt(f, 10));
            b.left && (b.left += "px");
            a(e).css(a.extend({
            ...
            if (c.drag)
                if (a(k).css("cursor", "move"), a.fn.jqDrag) a(e).jqDrag(k);
                else try {
                    a(e).draggable({
                ...
                if (c.resize)
                    if (a.fn.jqResize) a(e).append("<div class='jqResize ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se ui-icon-grip-diagonal-se'></div>"),
        ...
        info_dialog: function(d, b, c, f) {
            ...
            if (0 < g.buttons.length)
                for (f = 0; f < g.buttons.length; f++) "undefined" == typeof g.buttons[f].id && (g.buttons[f].id = "info_button_" + f), d += "<a href='javascript:void(0)' id='" + g.buttons[f].id + "' class='fm-button ui-state-default ui-corner-all'>" + g.buttons[f].text + "</a>";
        ...
        createEl: function(d, b, c, f, g) {
            function h(b, d) {
                a.isFunction(d.dataInit) && d.dataInit(b);
                d.dataEvents && a.each(d.dataEvents,
                    function() {
                    ...
                    if ("undefined" != typeof b.dataUrl) a.ajax(a.extend({
                        ...
                        success: function(d) {
                            var b = [],
                                ...
                                g = f.multiple === true;
                            typeof f.buildSelect != "undefined" &&
                                (d = f.buildSelect(d));
                            if (d = a(d).html()) {
                                a(c).append(d);
                                i(c, f);
                        ...
                        var j;
                        "undefined" === typeof b.size && (b.size =
                            d ? 3 : 1);
                        ...
                        if ("string" === typeof b.value) {
                            ...
                            for (j = 0; j < n.length; j++) {
                                k = n[j].split(l);
                                2 < k.length && (k[1] = a.map(k, function(a, b) {
                                    if (b > 0) return a
                                }).join(l));
                                ...
                                g.innerHTML = k[1];
                                e.appendChild(g);
                                if (!d && (a.trim(k[0]) == a.trim(c) ||
                                        a.trim(k[1]) == a.trim(c))) g.selected = "selected";
                                if (d && (-1 < a.inArray(a.trim(k[1]), f) || -1 < a.inArray(a.trim(k[0]), f))) g.selected = "selected"
                            }
                            ...
                            for (j in l = b.value, l)
                                if (l.hasOwnProperty(j)) {
                                    ...
                                    if (d && (-1 < a.inArray(a.trim(l[j]), f) || -1 < a.inArray(a.trim(j), f))) g.selected = "selected"
                                }
                        i(e, b, ["value"]);
                        b = h(e, b)
                    }
                ...
                case "custom":
                    ...
                    try {
                        if (a.isFunction(b.custom_element))
                            if (l = b.custom_element.call(this, c, b)) l = a(l).addClass("customelement").attr({
                                id: b.id,
                                name: b.name
                            }), a(e).empty().append(l);
                            else throw "e2";
                        ...
                        "e1" == m && this.info_dialog(a.jgrid.errors.errcap, "function 'custom_element' " + a.jgrid.edit.msg.nodefined, a.jgrid.edit.bClose), "e2" == m ? this.info_dialog(a.jgrid.errors.errcap, "function 'custom_element' " + a.jgrid.edit.msg.novalue, a.jgrid.edit.bClose) : this.info_dialog(a.jgrid.errors.errcap, "string" === typeof m ? m : m.message, a.jgrid.edit.bClose)
                    }
            }
            return e
        },
        checkDate: function(a, b) {
            ...
            2 == g && 1 == j.length &&
                (g = 1);
            if (j.length != g || 0 === c[a[f]] && "00" != b[f] || -1 === i) return !1;
            j = c[a[i]].toString();
            if (1 > j.length || 1 > c[a[i]] || 12 < c[a[i]] || -1 === h) return !1;
            j = c[a[h]].toString();
            return 1 > j.length || 1 > c[a[h]] || 31 < c[a[h]] || 2 == c[a[i]] && c[a[h]] > (0 === c[a[f]] % 4 && (0 !== c[a[f]] % 100 || 0 === c[a[f]] % 400) ? 29 : 28) || c[a[h]] > e[c[a[i]]] ? !1 : !0
        },
        isEmpty: function(a) {
        ...
        checkValues: function(d, b, c, f, g) {
            ...
            if ("undefined" === typeof f)
                if ("string" == typeof b) {
                    f = 0;
                    for (g = c.p.colModel.length; f < g; f++)
            ...
            else h = f, i = void 0 === g ? "_" : g;
            if (h) {
                i || (i = c.p.colNames[b]);
                if (!0 === h.required && this.isEmpty(d)) return [!1, i + ": " + a.jgrid.edit.msg.required, ""];
                f = !1 === h.required ?
                    !1 : !0;
                if (!0 === h.number && !(!1 === f && this.isEmpty(d)) && isNaN(d)) return [!1, i + ": " + a.jgrid.edit.msg.number, ""];
                ...
                if (!0 === h.email && !(!1 === f && this.isEmpty(d)) && (g = /^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i, !g.test(d))) return [!1, i + ": " + a.jgrid.edit.msg.email, ""];
                if (!0 === h.integer && !(!1 === f && this.isEmpty(d)) && (isNaN(d) || 0 !== d % 1 || -1 != d.indexOf("."))) return [!1, i + ": " + a.jgrid.edit.msg.integer, ""];
                if (!0 === h.date && !(!1 === f && this.isEmpty(d)) && (b = c.p.colModel[b].formatoptions && c.p.colModel[b].formatoptions.newformat ? c.p.colModel[b].formatoptions.newformat : c.p.colModel[b].datefmt || "Y-m-d", !this.checkDate(b, d))) return [!1, i + ": " + a.jgrid.edit.msg.date + " - " + b, ""];
                if (!0 === h.time && !(!1 === f && this.isEmpty(d)) && !this.checkTime(d)) return [!1,
                    i + ": " + a.jgrid.edit.msg.date + " - hh:mm (am/pm)", ""
                ];
                if (!0 === h.url && !(!1 === f && this.isEmpty(d)) && (g = /^(((https?)|(ftp)):\/\/([\-\w]+\.)+\w{2,3}(\/[%\-\w]+(\.\w{2,})?)*(([\w\-\.\?\\\/+@&#;`~=%!]*)(\.\w{2,})?)*\/?)/i, !g.test(d))) return [!1, i + ": " + a.jgrid.edit.msg.url, ""];
                if (!0 === h.custom && !(!1 === f && this.isEmpty(d))) return a.isFunction(h.custom_func) ? (d = h.custom_func.call(c, d, i), a.isArray(d) ? d : [!1, a.jgrid.edit.msg.customarray, ""]) : [!1, a.jgrid.edit.msg.customfcheck, ""]
            }
            return [!0, "", ""]
        }
    })
...
(function(a) {
    ...
    a.jgrid.extend({
        searchGrid: function(c) {
            ...
            return this.each(function() {
                function d() {
                    s = a(e).triggerHandler("jqGridFilterBeforeShow", [q]);
                    "undefined" === typeof s && (s = !0);
                    s && a.isFunction(c.beforeShowSearch) && (s = c.beforeShowSearch.call(e, q));
                    s && (a.jgrid.viewModal("#" + a.jgrid.jqID(t.themodal), {
                        ...
                        a(e).triggerHandler("jqGridFilterAfterShow", [q]), a.isFunction(c.afterShowSearch) && c.afterShowSearch.call(e, q))
                }
                var e = this;
                if (e.grid) {
                    var j = "fbox_" + e.p.id,
                        s = !0,
                        t = {
                            themodal: "searchmod" + j,
                            modalhead: "searchhd" + j,
                            modalcontent: "searchcnt" + j,
                            scrollelm: j
                        },
                        r = e.p.postData[c.sFilter],
                        q = a("#" + a.jgrid.jqID(j));
                    "string" === typeof r && (r = a.jgrid.parse(r));
                    !0 === c.recreateFilter && a("#" + a.jgrid.jqID(t.themodal)).remove();
                    if (null !== a("#" + a.jgrid.jqID(t.themodal)).html()) d();
                    else {
                        var g = a("<div><div id='" + j + "' class='searchFilter' style='overflow:auto'></div></div>").insertBefore("#gview_" +
                                a.jgrid.jqID(e.p.id)),
                            f = "left",
                            p = "";
                        "rtl" == e.p.direction && (f = "right", p = " style='text-align:left'", g.attr("dir", "rtl"));
                        var u = a.extend([], e.p.colModel),
                            b = "<a href='javascript:void(0)' id='" + j + "_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>" + c.Find + "</a>",
                            m = "<a href='javascript:void(0)' id='" + j + "_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>" +
                            c.Reset + "</a>",
                            h = "",
                            i = "",
                            n, l = !1,
                            w = -1;
                        c.showQuery && (h = "<a href='javascript:void(0)' id='" + j + "_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>");
                        c.columns.length ? u = c.columns : a.each(u, function(a, b) {
                            if (!b.label) b.label = e.p.colNames[a];
                            if (!l) {
                                var c = typeof b.search === "undefined" ? true : b.search,
                                    d = b.hidden === true;
                        ...
                        if (!r && n || !1 ===
                            c.multipleSearch) {
                            var y = "eq";
                            0 <= w && u[w].searchoptions && u[w].searchoptions.sopt ? y = u[w].searchoptions.sopt[0] : c.sopt && c.sopt.length && (y = c.sopt[0]);
                            r = {
                                groupOp: "AND",
                                rules: [{
                                    field: n,
                        ...
                        l = !1;
                        c.tmplNames && c.tmplNames.length && (l = !0, i = c.tmplLabel, i += "<select class='ui-template'>", i += "<option value='default'>Default</option>", a.each(c.tmplNames, function(a, b) {
                            i = i + ("<option value='" + a + "'>" + b + "</option>")
                        }), i += "</select>");
                        f = "<table class='EditTable' style='border:0px none;margin-top:5px' id='" +
                            j + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:" + f + "'>" + m + i + "</td><td class='EditButton' " + p + ">" + h + b + "</td></tr></tbody></table>";
                        j = a.jgrid.jqID(j);
                        a("#" + j).jqFilter({
                            columns: u,
                            filter: c.loadDefaults ? r : null,
                        ...
                        g.append(f);
                        l && c.tmplFilters && c.tmplFilters.length && a(".ui-template", g).bind("change", function() {
                            var b = a(this).val();
                            b == "default" ? a("#" + j).jqFilter("addFilter", r) : a("#" + j).jqFilter("addFilter", c.tmplFilters[parseInt(b, 10)]);
                            return false
                        });
                        !0 === c.multipleGroup && (c.multipleSearch = !0);
                        a(e).triggerHandler("jqGridFilterInitialize", [a("#" + j)]);
                        a.isFunction(c.onInitializeSearch) &&
                            c.onInitializeSearch.call(e, a("#" + j));
                        c.gbox = "#gbox_" + j;
                        c.layer ? a.jgrid.createModal(t, g, c, "#gview_" + a.jgrid.jqID(e.p.id), a("#gbox_" + a.jgrid.jqID(e.p.id))[0], "#" + a.jgrid.jqID(c.layer), {
                            position: "relative"
                        }) : a.jgrid.createModal(t, g, c, "#gview_" + a.jgrid.jqID(e.p.id), a("#gbox_" + a.jgrid.jqID(e.p.id))[0]);
                        h && a("#" + j + "_query").bind("click", function() {
                            a(".queryresult", g).toggle();
                            return false
                        });
                        void 0 === c.stringResult && (c.stringResult = c.multipleSearch);
                        a("#" + j + "_search").bind("click", function() {
                            var b = a("#" +
                                    j),
                                d = {},
                                o, f = b.jqFilter("filterData");
                            if (c.errorcheck) {
                                b[0].hideError();
                            ...
                            c.closeAfterSearch && a.jgrid.hideModal("#" + a.jgrid.jqID(t.themodal), {
                        ...
                        a("#" + j + "_reset").bind("click", function() {
                            var b = {},
                                d = a("#" + j);
                            e.p.search = false;
                            c.multipleSearch === false ? b[c.sField] = b[c.sValue] =
                                b[c.sOper] = "" : b[c.sFilter] = "";
                            d[0].resetFilter();
                            l && a(".ui-template", g).val("default");
                        ...
                        d();
                        a(".fm-button:not(.ui-state-disabled)", g).hover(function() {
                            a(this).addClass("ui-state-hover")
                        }, function() {
                            a(this).removeClass("ui-state-hover")
                        })
        ...
        editGridRow: function(v, d) {
            ...
            return this.each(function() {
                function e() {
                    a(n + " > tbody > tr > td > .FormElement").each(function() {
                        ...
                        if (d.length) {
                            ...
                            a.each(b.p.colModel, function() {
                                if (this.name === c && this.editoptions && a.isFunction(this.editoptions.custom_value)) {
                                    try {
                                        if (k[c] = this.editoptions.custom_value.call(b, a("#" + a.jgrid.jqID(c), n), "get"), void 0 ===
                                            k[c]) throw "e1";
                                    } catch (d) {
                            ...
                            switch (a(this).get(0).type) {
                                case "checkbox":
                                    a(this).is(":checked") ? k[this.name] = a(this).val() : (d = a(this).attr("offval"), k[this.name] = d);
                                    break;
                                case "select-one":
                                    k[this.name] = a("option:selected", this).val();
                                    A[this.name] = a("option:selected", this).text();
                                    break;
                ...
                function j(d, e, f, k) {
                    var o, h, g, i = 0,
                        ...
                        s = "",
                        m;
                    for (m = 1; m <= k; m++) s += "<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";
                    "_empty" != d && (p = a(e).jqGrid("getInd", d));
                    a(e.p.colModel).each(function(m) {
                        o = this.name;
                        n = (h = this.editrules && !0 === this.editrules.edithidden ? !1 : !0 === this.hidden ? !0 : !1) ? "style='display:none'" : "";
                        if ("cb" !== o && "subgrid" !== o && !0 === this.editable && "rn" !== o) {
                            if (!1 === p) l = "";
                            else if (o == e.p.ExpandColumn && !0 === e.p.treeGrid) l = a("td:eq(" + m + ")", e.rows[p]).text();
                            else {
                                try {
                                    l = a.unformat.call(e, a("td:eq(" + m + ")", e.rows[p]), {
                                        rowId: d,
                                        colModel: this
                                    }, m)
                                } catch (B) {
                                    l = this.edittype && "textarea" == this.edittype ? a("td:eq(" + m + ")",
                                        e.rows[p]).text() : a("td:eq(" + m + ")", e.rows[p]).html()
                                }
                                if (!l || "&nbsp;" == l || "&#160;" == l || 1 == l.length && 160 == l.charCodeAt(0)) l = ""
                            }
                            var q = a.extend({}, this.editoptions || {}, {
                                ...
                                w = parseInt(r.rowpos, 10) || i + 1,
                                t = parseInt(2 * (parseInt(r.colpos, 10) || 1), 10);
                            "_empty" == d && q.defaultValue && (l = a.isFunction(q.defaultValue) ? q.defaultValue() : q.defaultValue);
                            this.edittype || (this.edittype = "text");
                            b.p.autoencode && (l = a.jgrid.htmlDecode(l));
                            j = a.jgrid.createEl(this.edittype, q, l, !1, a.extend({}, a.jgrid.ajaxOptions, e.p.ajaxSelectOptions || {}));
                            "" === l && "checkbox" == this.edittype && (l = a(j).attr("offval"));
                            "" === l && "select" == this.edittype && (l = a("option:eq(0)", j).text());
                            if (c[b.p.id].checkOnSubmit || c[b.p.id].checkOnUpdate) c[b.p.id]._savedData[o] = l;
                            a(j).addClass("FormElement");
                            ("text" == this.edittype || "textarea" == this.edittype) && a(j).addClass("ui-widget-content ui-corner-all");
                            g = a(f).find("tr[rowpos=" + w + "]");
                            r.rowabove && (q = a("<tr><td class='contentinfo' colspan='" +
                                2 * k + "'>" + r.rowcontent + "</td></tr>"), a(f).append(q), q[0].rp = w);
                            0 === g.length && (g = a("<tr " + n + " rowpos='" + w + "'></tr>").addClass("FormData").attr("id", "tr_" + o), a(g).append(s), a(f).append(g), g[0].rp = w);
                            a("td:eq(" + (t - 2) + ")", g[0]).html("undefined" === typeof r.label ? e.p.colNames[m] : r.label);
                            a("td:eq(" + (t - 1) + ")", g[0]).append(r.elmprefix).append(j).append(r.elmsuffix);
                            v[i] = m;
                            i++
                        }
                    });
                    if (0 < i && (m = a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (2 * k - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='" +
                            e.p.id + "_id' value='" + d + "'/></td></tr>"), m[0].rp = i + 999, a(f).append(m), c[b.p.id].checkOnSubmit || c[b.p.id].checkOnUpdate)) c[b.p.id]._savedData[e.p.id + "_id"] = d;
                    return v
                }
                ...
                function s(d, e, o) {
                    ...
                    if ("_empty" == d) a(m).each(function() {
                            ...
                            if ((h = a("#" + a.jgrid.jqID(f), "#" + o)) && h.length && null !== h[0])
                                if (i = "", l.defaultValue ?
                        ...
                        p && (a('td[role="gridcell"]', p).each(function(h) {
                            f = m[h].name;
                            if ("cb" !== f && "subgrid" !== f && "rn" !== f && !0 === m[h].editable) {
                                if (f == e.p.ExpandColumn && !0 === e.p.treeGrid) g = a(this).text();
                                else try {
                                ...
                                switch (m[h].edittype) {
                                    ...
                                    case "select":
                                        ...
                                        a("#" + f + " option", "#" + o).each(function() {
                                            this.selected = !m[h].editoptions.multiple && (a.trim(g) == a.trim(a(this).text()) || i[0] == a.trim(a(this).text()) || i[0] == a.trim(a(this).val())) ? !0 : m[h].editoptions.multiple ? -1 < a.inArray(a.trim(a(this).text()),
                                                i) || -1 < a.inArray(a.trim(a(this).val()), i) ? !0 : !1 : !1
                                        });
                                        break;
                                    case "checkbox":
                                        g += "";
                                        m[h].editoptions && m[h].editoptions.value ? m[h].editoptions.value.split(":")[0] == g ? (a("#" + f, "#" + o)[b.p.useProp ? "prop" : "attr"]("checked", !0), a("#" + f, "#" + o)[b.p.useProp ? "prop" : "attr"]("defaultChecked", !0)) : (a("#" + f, "#" + o)[b.p.useProp ? "prop" : "attr"]("checked", !1), a("#" + f, "#" + o)[b.p.useProp ? "prop" : "attr"]("defaultChecked", !1)) : (g = g.toLowerCase(), 0 > g.search(/(false|0|no|off|undefined)/i) && "" !== g ? (a("#" + f, "#" + o)[b.p.useProp ?
                                            "prop" : "attr"]("checked", !0), a("#" + f, "#" + o)[b.p.useProp ? "prop" : "attr"]("defaultChecked", !0)) : (a("#" + f, "#" + o)[b.p.useProp ? "prop" : "attr"]("checked", !1), a("#" + f, "#" + o)[b.p.useProp ? "prop" : "attr"]("defaultChecked", !1)));
                                        break;
                                    case "custom":
                                        try {
                                            if (m[h].editoptions && a.isFunction(m[h].editoptions.custom_value)) m[h].editoptions.custom_value.call(b, a("#" + f, "#" + o), "set", g);
                                            else throw "e1";
                                        } catch (j) {
                                            "e1" == j ? a.jgrid.info_dialog(jQuery.jgrid.errors.errcap, "function 'custom_value' " + a.jgrid.edit.msg.nodefined, jQuery.jgrid.edit.bClose) :
                                                a.jgrid.info_dialog(jQuery.jgrid.errors.errcap, j.message, jQuery.jgrid.edit.bClose)
                                        }
                                }
                                k++
                            }
                ...
                function r() {
                    var e, f = [!0, "", ""],
                        g = {},
                        o = b.p.prmNames,
                        i, j, p, v, q, r = a(b).triggerHandler("jqGridAddEditBeforeCheckValues", [a("#" + h), z]);
                    r && "object" === typeof r && (k = r);
                    a.isFunction(c[b.p.id].beforeCheckValues) && (r = c[b.p.id].beforeCheckValues.call(b,
                        k, a("#" + h), "_empty" == k[b.p.id + "_id"] ? o.addoper : o.editoper)) && "object" === typeof r && (k = r);
                    for (p in k)
                        if (k.hasOwnProperty(p) && (f = a.jgrid.checkValues(k[p], p, b), !1 === f[0])) break;
                    t();
                    f[0] && (g = a(b).triggerHandler("jqGridAddEditClickSubmit", [c[b.p.id], k, z]), void 0 === g && a.isFunction(c[b.p.id].onclickSubmit) && (g = c[b.p.id].onclickSubmit.call(b, c[b.p.id], k) || {}), f = a(b).triggerHandler("jqGridAddEditBeforeSubmit", [k, a("#" + h), z]), void 0 === f && (f = [!0, "", ""]), f[0] && a.isFunction(c[b.p.id].beforeSubmit) && (f = c[b.p.id].beforeSubmit(k,
                        a("#" + h))));
                    if (f[0] && !c[b.p.id].processing) {
                        ...
                        j = o.oper;
                        i = o.id;
                        k[j] = "_empty" == a.trim(k[b.p.id + "_id"]) ? o.addoper : o.editoper;
                        k[j] != o.addoper ? k[i] = k[b.p.id + "_id"] : void 0 === k[i] && (k[i] = k[b.p.id + "_id"]);
                        delete k[b.p.id + "_id"];
                        k = a.extend(k, c[b.p.id].editData, g);
                        if (!0 === b.p.treeGrid)
                            for (q in k[j] == o.addoper && (v = a(b).jqGrid("getGridParam", "selrow"), k["adjacency" == b.p.treeGridModel ? b.p.treeReader.parent_id_field : "parent_id"] = v), b.p.treeReader) b.p.treeReader.hasOwnProperty(q) &&
                                (g = b.p.treeReader[q], k.hasOwnProperty(g) && !(k[j] == o.addoper && "parent_id_field" === q) && delete k[g]);
                        k[i] = a.jgrid.stripPref(b.p.idPrefix, k[i]);
                        q = a.extend({
                            url: c[b.p.id].url ? c[b.p.id].url : a(b).jqGrid("getGridParam", "editurl"),
                            type: c[b.p.id].mtype,
                            data: a.isFunction(c[b.p.id].serializeEditData) ? c[b.p.id].serializeEditData(k) : k,
                            complete: function(g, p) {
                                k[i] = b.p.idPrefix + k[i];
                                if (p != "success") {
                                    f[0] = false;
                                    f[1] = a(b).triggerHandler("jqGridAddEditErrorTextFormat", [g, z]);
                                    f[1] = a.isFunction(c[b.p.id].errorTextFormat) ?
                                        c[b.p.id].errorTextFormat.call(b, g) : p + " Status: '" + g.statusText + "'. Error code: " + g.status
                                } else {
                                    f = a(b).triggerHandler("jqGridAddEditAfterSubmit", [g, k, z]);
                                    f === void 0 && (f = [true, "", ""]);
                                    f[0] && a.isFunction(c[b.p.id].afterSubmit) && (f = c[b.p.id].afterSubmit.call(b, g, k))
                                }
                                if (f[0] === false) {
                                    a("#FormError>td", n).html(f[1]);
                                    a("#FormError", n).show()
                                } else {
                                    a.each(b.p.colModel, function() {
                                        if (A[this.name] && this.formatter && this.formatter == "select") try {
                                            delete A[this.name]
                                        } catch (a) {}
                                    });
                                    k = a.extend(k, A);
                                    ...
                                    if (k[j] == o.addoper) {
                                        ...
                                        if (c[b.p.id].closeAfterAdd) {
                                            ...
                                            else if (b.p.treeGrid === true) a(b).jqGrid("addChildNode", f[2], v, k);
                                            else {
                                            ...
                                            c[b.p.id].reloadAfterSubmit ?
                                                a(b).trigger("reloadGrid") : b.p.treeGrid === true ? a(b).jqGrid("addChildNode", f[2], v, k) : a(b).jqGrid("addRowData", f[2], k, d.addedrow);
                                            s("_empty", b, h)
                                        } else c[b.p.id].reloadAfterSubmit ? a(b).trigger("reloadGrid") : b.p.treeGrid === true ? a(b).jqGrid("addChildNode", f[2], v, k) : a(b).jqGrid("addRowData", f[2], k, d.addedrow)
                                    } else {
                                        if (c[b.p.id].reloadAfterSubmit) {
                                            a(b).trigger("reloadGrid");
                                            c[b.p.id].closeAfterEdit || setTimeout(function() {
                                                a(b).jqGrid("setSelection", k[i])
                                            }, 1E3)
                                        } else b.p.treeGrid === true ? a(b).jqGrid("setTreeRow",
                                            k[i], k) : a(b).jqGrid("setRowData", k[i], k);
                                        c[b.p.id].closeAfterEdit && a.jgrid.hideModal("#" + a.jgrid.jqID(l.themodal), {
                                            gb: "#gbox_" + a.jgrid.jqID(m),
                                            jqm: d.jqModal,
                                            onClose: c[b.p.id].onClose
                                        })
                                    ...
                                    if (c[b.p.id].checkOnSubmit || c[b.p.id].checkOnUpdate) {
                                        ...
                                        if (c[b.p.id]._savedData[b.p.id + "_id"] !=
                                            "_empty")
                                            for (var q in c[b.p.id]._savedData) k[q] && (c[b.p.id]._savedData[q] = k[q])
                                    }
                                }
                        ...
                        !q.url && !c[b.p.id].useDataProxy && (a.isFunction(b.p.dataProxy) ? c[b.p.id].useDataProxy = !0 : (f[0] = !1, f[1] += " " + a.jgrid.errors.nourl));
                        f[0] && (c[b.p.id].useDataProxy ? (g = b.p.dataProxy.call(b, q, "set_" + b.p.id), "undefined" == typeof g && (g = [!0, ""]), !1 === g[0] ?
                            (f[0] = !1, f[1] = g[1] || "Error deleting the selected row!") : (q.data.oper == o.addoper && c[b.p.id].closeAfterAdd && a.jgrid.hideModal("#" + a.jgrid.jqID(l.themodal), {
                                gb: "#gbox_" + a.jgrid.jqID(m),
                                jqm: d.jqModal,
                                onClose: c[b.p.id].onClose
                            }), q.data.oper == o.editoper && c[b.p.id].closeAfterEdit && a.jgrid.hideModal("#" + a.jgrid.jqID(l.themodal), {
                                gb: "#gbox_" + a.jgrid.jqID(m),
                                jqm: d.jqModal,
                                onClose: c[b.p.id].onClose
                            }))) : a.ajax(q))
                    }!1 === f[0] && (a("#FormError>td", n).html(f[1]), a("#FormError", n).show())
                }
                ...
                function g() {
                    var d = !0;
                    a("#FormError", n).hide();
                    if (c[b.p.id].checkOnUpdate && (k = {}, A = {}, e(), F = a.extend({}, k, A), M = q(F, c[b.p.id]._savedData))) a("#" + h).data("disabled", !0), a(".confirm", "#" + l.themodal).show(), d = !1;
                    return d
                }

                function f() {
                    if ("_empty" !== v && "undefined" !== typeof b.p.savedRow && 0 < b.p.savedRow.length && a.isFunction(a.fn.jqGrid.restoreRow))
                        for (var d = 0; d < b.p.savedRow.length; d++)
                            if (b.p.savedRow[d].id == v) {
                                a(b).jqGrid("restoreRow", v);
                                break
                            }
                }
                ...
                function p(b,
                    ...
                    b == d ? a("#nData", n + "_2").addClass("ui-state-disabled") : a("#nData", n + "_2").removeClass("ui-state-disabled")
                }

                function u() {
                    var d = a(b).jqGrid("getDataIDs"),
                        c = a("#id_g", n).val();
                ...
                if (b.grid && v) {
                    var m = b.p.id,
                        ...
                        w = a.isFunction(c[b.p.id].beforeShowForm) ?
                        c[b.p.id].beforeShowForm : !1,
                        y = a.isFunction(c[b.p.id].afterShowForm) ? c[b.p.id].afterShowForm : !1,
                        x = a.isFunction(c[b.p.id].beforeInitData) ? c[b.p.id].beforeInitData : !1,
                        E = a.isFunction(c[b.p.id].onInitializeForm) ? c[b.p.id].onInitializeForm : !1,
                        o = !0,
                        B = 1,
                        H = 0,
                        k, A, F, M, z, h = a.jgrid.jqID(h);
                    "new" === v ? (v = "_empty", z = "add", d.caption = c[b.p.id].addCaption) : (d.caption = c[b.p.id].editCaption, z = "edit");
                    !0 === d.recreateForm && null !== a("#" + a.jgrid.jqID(l.themodal)).html() && a("#" + a.jgrid.jqID(l.themodal)).remove();
                    var I = !0;
                    d.checkOnUpdate && d.jqModal && !d.modal && (I = !1);
                    if (null !== a("#" + a.jgrid.jqID(l.themodal)).html()) {
                        o = a(b).triggerHandler("jqGridAddEditBeforeInitData", [a("#" + a.jgrid.jqID(h))]);
                        ...
                        a("#FormError", n).hide();
                        c[b.p.id].topinfo ? (a(".topinfo", n).html(c[b.p.id].topinfo), a(".tinfo", n).show()) : a(".tinfo", n).hide();
                        c[b.p.id].bottominfo ? (a(".bottominfo", n + "_2").html(c[b.p.id].bottominfo),
                            a(".binfo", n + "_2").show()) : a(".binfo", n + "_2").hide();
                        s(v, b, h);
                        "_empty" == v || !c[b.p.id].viewPagerButtons ? a("#pData, #nData", n + "_2").hide() : a("#pData, #nData", n + "_2").show();
                        !0 === c[b.p.id].processing && (c[b.p.id].processing = !1, a("#sData", n + "_2").removeClass("ui-state-active"));
                        !0 === a("#" + h).data("disabled") && (a(".confirm", "#" + a.jgrid.jqID(l.themodal)).hide(), a("#" + h).data("disabled", !1));
                        a(b).triggerHandler("jqGridAddEditBeforeShowForm", [a("#" + h), z]);
                        w && w.call(b, a("#" + h));
                        a("#" + a.jgrid.jqID(l.themodal)).data("onClose",
                            c[b.p.id].onClose);
                        ...
                        var G = isNaN(d.dataheight) ? d.dataheight : d.dataheight + "px",
                            G = a("<form name='FormPost' id='" +
                                h + "' class='FormGrid' onSubmit='return false;' style='width:100%;overflow:auto;position:relative;height:" + G + ";'></form>").data("disabled", !1),
                            C = a("<table id='" + i + "' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
                            o = a(b).triggerHandler("jqGridAddEditBeforeInitData", [a("#" + h), z]);
                        "undefined" == typeof o && (o = !0);
                        o && x && (o = x.call(b, a("#" + h)));
                        if (!1 === o) return;
                        f();
                        ...
                        a(G).append(C);
                        x = a("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='" + 2 * B + "'></td></tr>");
                        x[0].rp = 0;
                        a(C).append(x);
                        x = a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='" + 2 * B + "'>" + c[b.p.id].topinfo + "</td></tr>");
                        x[0].rp = 0;
                        a(C).append(x);
                        var o = (x = "rtl" == b.p.direction ? !0 : !1) ? "nData" : "pData",
                            D = x ? "pData" : "nData";
                        j(v, b, C, B);
                        var o = "<a href='javascript:void(0)' id='" + o + "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
                            ...
                            J = "<a href='javascript:void(0)' id='sData' class='fm-button ui-state-default ui-corner-all'>" + d.bSubmit + "</a>",
                            K = "<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>" + d.bCancel + "</a>",
                            i = "<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='" + i + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>" +
                            (x ? D + o : o + D) + "</td><td class='EditButton'>" + J + K + "</td></tr>" + ("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>" + c[b.p.id].bottominfo + "</td></tr>"),
                            i = i + "</tbody></table>";
                        if (0 < H) {
                            var L = [];
                        ...
                        i = a("<span></span>").append(G).append(i);
                        a.jgrid.createModal(l,
                            i, d, "#gview_" + a.jgrid.jqID(b.p.id), a("#gbox_" + a.jgrid.jqID(b.p.id))[0]);
                        x && (a("#pData, #nData", n + "_2").css("float", "right"), a(".EditButton", n + "_2").css("text-align", "left"));
                        c[b.p.id].topinfo && a(".tinfo", n).show();
                        c[b.p.id].bottominfo && a(".binfo", n + "_2").show();
                        i = i = null;
                        ...
                        d.checkOnUpdate && (a("a.ui-jqdialog-titlebar-close span", "#" + a.jgrid.jqID(l.themodal)).removeClass("jqmClose"), a("a.ui-jqdialog-titlebar-close",
                            "#" + a.jgrid.jqID(l.themodal)).unbind("click").click(function() {
                            if (!g()) return false;
                            a.jgrid.hideModal("#" + a.jgrid.jqID(l.themodal), {
                                gb: "#gbox_" + a.jgrid.jqID(m),
                                jqm: d.jqModal,
                        ...
                        !0 === d.saveicon[0] && a("#sData", n + "_2").addClass("right" == d.saveicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='ui-icon " + d.saveicon[2] +
                            "'></span>");
                        ...
                        a(b).triggerHandler("jqGridAddEditBeforeShowForm", [a("#" + h), z]);
                        w && w.call(b, a("#" + h));
                        a("#" + a.jgrid.jqID(l.themodal)).data("onClose", c[b.p.id].onClose);
                        a.jgrid.viewModal("#" + a.jgrid.jqID(l.themodal), {
                            gbox: "#gbox_" + a.jgrid.jqID(m),
                            jqm: d.jqModal,
                            overlay: d.overlay,
                        ...
                        a("#sData", n + "_2").click(function() {
                            ...
                            a("#FormError", n).hide();
                            e();
                            if (k[b.p.id + "_id"] == "_empty") r();
                            else if (d.checkOnSubmit === true) {
                                F = a.extend({}, k, A);
                                if (M = q(F, c[b.p.id]._savedData)) {
        ...
        viewGridRow: function(c, d) {
            ...
            return this.each(function() {
                ...
                function j(b, c, e, f) {
                    for (var g, h, i, l = 0, j, m, q = [], p = !1, n = "<td class='CaptionTD form-view-label ui-widget-content' width='" + d.labelswidth + "'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>", r = "", v = ["integer", "number", "currency"], s = 0, w = 0, t, u, y, x = 1; x <= f; x++) r += 1 == x ? n : "<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";
                    a(c.p.colModel).each(function() {
                        h = this.editrules && !0 === this.editrules.edithidden ? !1 : !0 === this.hidden ? !0 : !1;
                        !h && "right" === this.align && (this.formatter && -1 !== a.inArray(this.formatter, v) ? s = Math.max(s, parseInt(this.width, 10)) : w = Math.max(w, parseInt(this.width, 10)))
                    });
                    t = 0 !== s ? s : 0 !== w ? w : 0;
                    p = a(c).jqGrid("getInd", b);
                    a(c.p.colModel).each(function(b) {
                        g = this.name;
                        u = !1;
                        m = (h = this.editrules && !0 === this.editrules.edithidden ? !1 : !0 === this.hidden ? !0 : !1) ? "style='display:none'" : "";
                        y = "boolean" != typeof this.viewable ? !0 : this.viewable;
                        if ("cb" !== g && "subgrid" !== g && "rn" !== g && y) {
                            j = !1 === p ? "" : g == c.p.ExpandColumn && !0 === c.p.treeGrid ? a("td:eq(" + b + ")", c.rows[p]).text() : a("td:eq(" + b + ")", c.rows[p]).html();
                            u = "right" === this.align && 0 !== t ? !0 : !1;
                            ...
                            var d = a.extend({}, {
                                ...
                                o = parseInt(d.rowpos, 10) || l + 1,
                                n = parseInt(2 * (parseInt(d.colpos, 10) || 1), 10);
                            if (d.rowabove) {
                                var v = a("<tr><td class='contentinfo' colspan='" + 2 * f + "'>" + d.rowcontent + "</td></tr>");
                                a(e).append(v);
                                v[0].rp = o
                            }
                            i = a(e).find("tr[rowpos=" + o + "]");
                            0 === i.length && (i = a("<tr " + m + " rowpos='" + o + "'></tr>").addClass("FormData").attr("id", "trv_" + g), a(i).append(r), a(e).append(i), i[0].rp = o);
                            a("td:eq(" + (n - 2) + ")", i[0]).html("<b>" + ("undefined" === typeof d.label ? c.p.colNames[b] : d.label) + "</b>");
                            a("td:eq(" + (n - 1) + ")", i[0]).append("<span>" + j + "</span>").attr("id", "v_" + g);
                            u && a("td:eq(" + (n - 1) + ") span", i[0]).css({
                                "text-align": "right",
                                width: t + "px"
                            });
                            q[l] = b;
                    ...
                    0 < l && (b = a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" +
                        (2 * f - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='" + b + "'/></td></tr>"), b[0].rp = l + 99, a(e).append(b));
                    return q
                }
                ...
                function t(b, c) {
                    0 === b ? a("#pData", "#" + p + "_2").addClass("ui-state-disabled") : a("#pData", "#" + p + "_2").removeClass("ui-state-disabled");
                    b == c ? a("#nData", "#" + p + "_2").addClass("ui-state-disabled") : a("#nData", "#" + p + "_2").removeClass("ui-state-disabled")
                }

                function r() {
                    var b = a(q).jqGrid("getDataIDs"),
                        c = a("#id_g", "#" + p).val();
                ...
                if (q.grid &&
                    c) {
                    var g = q.p.id,
                        f = "ViewGrid_" + a.jgrid.jqID(g),
                        p = "ViewTbl_" + a.jgrid.jqID(g),
                        u = "ViewGrid_" + g,
                        b = "ViewTbl_" + g,
                        m = {
                            themodal: "viewmod" + g,
                    ...
                    if (null !== a("#" + a.jgrid.jqID(m.themodal)).html()) {
                        ...
                        var w = isNaN(d.dataheight) ? d.dataheight : d.dataheight + "px",
                            u = a("<form name='FormPost' id='" + u + "' class='FormGrid' style='width:100%;overflow:auto;position:relative;height:" + w + ";'></form>"),
                            y = a("<table id='" + b + "' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");
                        h && (i = h(a("#" +
                            f)), "undefined" == typeof i && (i = !0));
                        if (!1 === i) return;
                        a(q.p.colModel).each(function() {
                            var a = this.formoptions;
                        ...
                        i = "<a href='javascript:void(0)' id='" + (b ? "pData" : "nData") + "' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>";
                        w = "<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>" + d.bClose + "</a>";
                        if (0 < l) {
                            var x = [];
                        ...
                        u = a("<span></span>").append(u).append("<table border='0' class='EditTable' id='" + p + "_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='" +
                            d.labelswidth + "'>" + (b ? i + h : h + i) + "</td><td class='EditButton'>" + w + "</td></tr></tbody></table>");
                        a.jgrid.createModal(m, u, d, "#gview_" + a.jgrid.jqID(q.p.id), a("#gview_" + a.jgrid.jqID(q.p.id))[0]);
                        ...
                        a.isFunction(d.beforeShowForm) && d.beforeShowForm(a("#" + f));
                        a.jgrid.viewModal("#" + a.jgrid.jqID(m.themodal), {
                            gbox: "#gbox_" + a.jgrid.jqID(g),
                            jqm: d.jqModal,
                            modal: d.modal
                        ...
                        a("#nData", "#" + p + "_2").click(function() {
                            ...
                            if (b[0] != -1 && b[1][b[0] +
                                ...
                                if (a.isFunction(d.onclickPgButtons)) d.onclickPgButtons("next", a("#" + f), b[1][b[0]]);
                                s(b[1][b[0] + 1], q);
                                a(q).jqGrid("setSelection", b[1][b[0] + 1]);
                                a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons("next", a("#" + f), b[1][b[0] + 1]);
                        ...
                        a("#pData", "#" + p + "_2").click(function() {
                            ...
                            var b = r();
                            if (b[0] != -1 && b[1][b[0] - 1]) {
                                if (a.isFunction(d.onclickPgButtons)) d.onclickPgButtons("prev", a("#" + f), b[1][b[0]]);
                                s(b[1][b[0] - 1], q);
                                a(q).jqGrid("setSelection",
                                    b[1][b[0] - 1]);
                                a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons("prev", a("#" + f), b[1][b[0] - 1]);
                                t(b[0] - 1, b[1].length - 1)
                            }
                            e();
                            return false
        ...
        delGridRow: function(v, d) {
            ...
            return this.each(function() {
                var e = this;
                if (e.grid && v) {
                    var j = a.isFunction(c[e.p.id].beforeShowForm),
                        s = a.isFunction(c[e.p.id].afterShowForm),
                        t = a.isFunction(c[e.p.id].beforeInitData) ? c[e.p.id].beforeInitData : !1,
                        r = e.p.id,
                        q = {},
                        g = !0,
                        f = "DelTbl_" + a.jgrid.jqID(r),
                        p, u, b, m, h = "DelTbl_" + r,
                        i = {
                            themodal: "delmod" + r,
                            modalhead: "delhd" + r,
                    ...
                    jQuery.isArray(v) && (v = v.join());
                    if (null !== a("#" + a.jgrid.jqID(i.themodal)).html()) {
                        t && (g = t(a("#" + f)), "undefined" == typeof g && (g = !0));
                        if (!1 === g) return;
                        a("#DelData>td", "#" + f).text(v);
                        a("#DelError", "#" + f).hide();
                        !0 === c[e.p.id].processing && (c[e.p.id].processing = !1, a("#dData", "#" + f).removeClass("ui-state-active"));
                        j && c[e.p.id].beforeShowForm(a("#" + f));
                        ...
                        var n =
                            isNaN(c[e.p.id].dataheight) ? c[e.p.id].dataheight : c[e.p.id].dataheight + "px",
                            h = "<div id='" + h + "' class='formdata' style='width:100%;overflow:auto;position:relative;height:" + n + ";'><table class='DelTable'><tbody><tr id='DelError' style='display:none'><td class='ui-state-error'></td></tr>" + ("<tr id='DelData' style='display:none'><td >" + v + "</td></tr>"),
                            h = h + ('<tr><td class="delmsg" style="white-space:pre;">' + c[e.p.id].msg + "</td></tr><tr><td >&#160;</td></tr>"),
                            h = h + "</tbody></table></div>" + ("<table cellspacing='0' cellpadding='0' border='0' class='EditTable' id='" +
                        ...
                        d.gbox = "#gbox_" + a.jgrid.jqID(r);
                        a.jgrid.createModal(i, h, d, "#gview_" + a.jgrid.jqID(e.p.id), a("#gview_" + a.jgrid.jqID(e.p.id))[0]);
                        t && (g = t(a("#" + f)), "undefined" == typeof g && (g = !0));
                        if (!1 === g) return;
                        ...
                        !0 === d.delicon[0] && a("#dData", "#" + f + "_2").addClass("right" == d.delicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='ui-icon " + d.delicon[2] +
                            "'></span>");
                        ...
                        a("#dData", "#" + f + "_2").click(function() {
                            ...
                            a.isFunction(c[e.p.id].onclickSubmit) && (q = c[e.p.id].onclickSubmit(c[e.p.id], h) || {});
                            a.isFunction(c[e.p.id].beforeSubmit) && (g = c[e.p.id].beforeSubmit(h));
                            if (g[0] && !c[e.p.id].processing) {
                                c[e.p.id].processing = true;
                                b = e.p.prmNames;
                                p = a.extend({}, c[e.p.id].delData, q);
                                m = b.oper;
                                p[m] = b.deloper;
                                u = b.id;
                                h = ("" + h).split(",");
                                ...
                                j = a.extend({
                                    ...
                                    type: c[e.p.id].mtype,
                                    data: a.isFunction(c[e.p.id].serializeDelData) ? c[e.p.id].serializeDelData(p) : p,
                                    complete: function(b, j) {
                                        if (j != "success") {
                                            g[0] = false;
                                            g[1] = a.isFunction(c[e.p.id].errorTextFormat) ?
                                                c[e.p.id].errorTextFormat(b) : j + " Status: '" + b.statusText + "'. Error code: " + b.status
                                        } else a.isFunction(c[e.p.id].afterSubmit) && (g = c[e.p.id].afterSubmit(b, p));
                                        if (g[0] === false) {
                                            ...
                                            if (c[e.p.id].reloadAfterSubmit && e.p.datatype != "local") a(e).trigger("reloadGrid");
                                                ...
                                                if (e.p.treeGrid === true) try {
                                                    ...
                                                    for (var n = 0; n < h.length; n++) a(e).jqGrid("delRowData", e.p.idPrefix + h[n]);
                                                e.p.selrow = null;
                                                e.p.selarrrow = []
                                            }
                                            a.isFunction(c[e.p.id].afterComplete) && setTimeout(function() {
                                                c[e.p.id].afterComplete(b, h)
                                            }, 500)
                                        }
                                        c[e.p.id].processing = false;
                                        a("#dData", "#" + f + "_2").removeClass("ui-state-active");
                                        g[0] && a.jgrid.hideModal("#" + a.jgrid.jqID(i.themodal), {
                                ...
                                if (!j.url && !c[e.p.id].useDataProxy)
                                ...
                                if (g[0])
                                    if (c[e.p.id].useDataProxy) {
                                        j =
                                            e.p.dataProxy.call(e, j, "del_" + e.p.id);
                                        typeof j == "undefined" && (j = [true, ""]);
                                        if (j[0] === false) {
                                            g[0] = false;
                                            g[1] = j[1] || "Error deleting the selected row!"
                                        } else a.jgrid.hideModal("#" + a.jgrid.jqID(i.themodal), {
                                            gb: "#gbox_" + a.jgrid.jqID(r),
                                            jqm: d.jqModal,
                                            onClose: c[e.p.id].onClose
                                        })
                    ...
                    s && c[e.p.id].afterShowForm(a("#" + f));
                    !0 === c[e.p.id].closeOnEscape && setTimeout(function() {
                        a(".ui-jqdialog-titlebar-close", "#" + a.jgrid.jqID(i.modalhead)).focus()
                    }, 0)
                }
            })
        },
        navGrid: function(c, d, e, j, s, t, r) {
            d = a.extend({
                edit: !0,
                    ...
                    if (g.grid && "string" == typeof c) {
                        null ===
                            a("#" + q.themodal).html() && (!d.alerttop && !d.alertleft && ("undefined" != typeof window.innerWidth ? (d.alertleft = window.innerWidth, d.alerttop = window.innerHeight) : "undefined" != typeof document.documentElement && "undefined" != typeof document.documentElement.clientWidth && 0 !== document.documentElement.clientWidth ? (d.alertleft = document.documentElement.clientWidth, d.alerttop = document.documentElement.clientHeight) : (d.alertleft = 1024, d.alerttop = 768), d.alertleft = d.alertleft / 2 - parseInt(d.alertwidth, 10) / 2, d.alerttop = d.alerttop /
                                2 - 25), a.jgrid.createModal(q, "<div>" + d.alerttext + "</div><span tabindex='0'><span tabindex='-1' id='jqg_alrt'></span></span>", {
                        ...
                        for (var u = 0; u < p; u++) {
                            var b = a("<table cellspacing='0' cellpadding='0' border='0' role='presentation' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"),
                                m, h;
                            0 === u ? (m = c, h = g.p.id, m == g.p.toppager && (h += "_top", p = 1)) : (m = g.p.toppager, h = g.p.id + "_top");
                            "rtl" == g.p.direction && a(b).attr("dir", "rtl").css("float", "right");
                            d.add && (j = j || {}, f = a("<td class='ui-pg-button ui-corner-all'></td>"), a(f).append("<div class='ui-pg-div'><span tabindex = '0' role='button'  class='ui-icon " + d.addicon + "' ></span>" + d.addtext + "</div>"), a("tr", b).append(f), a(f, b).attr({
                                title: d.addtitle || "",
                                id: j.id || "add_" + h
                            }).click(function() {
                                a(this).hasClass("ui-state-disabled") || (a.isFunction(d.addfunc) ? d.addfunc.call(g) : a(g).jqGrid("editGridRow",
                                    "new", j));
                                return false
                            }).hover(function() {
                            ...
                            d.edit && (f = a("<td class='ui-pg-button ui-corner-all'></td>"), e = e || {}, a(f).append("<div class='ui-pg-div'><span tabindex = '0' role='button' class='ui-icon " + d.editicon + "'></span>" + d.edittext + "</div>"), a("tr", b).append(f), a(f, b).attr({
                                title: d.edittitle || "",
                                id: e.id || "edit_" + h
                            }).click(function() {
                            ...
                            d.view && (f = a("<td class='ui-pg-button ui-corner-all'></td>"), r = r || {}, a(f).append("<div class='ui-pg-div'><span tabindex = '0' role='button' class='ui-icon " + d.viewicon + "'></span>" +
                                    d.viewtext + "</div>"), a("tr", b).append(f), a(f, b).attr({
                                    title: d.viewtitle || "",
                                    id: r.id || "view_" + h
                                }).click(function() {
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        var b = g.p.selrow;
                                        if (b) a.isFunction(d.viewfunc) ? d.viewfunc.call(g, b) : a(g).jqGrid("viewGridRow", b, r);
                                        else {
                                            a.jgrid.viewModal("#" + q.themodal, {
                                                gbox: "#gbox_" + a.jgrid.jqID(g.p.id),
                                                jqm: true
                                ...
                                f = null);
                            d.del && (f = a("<td class='ui-pg-button ui-corner-all'></td>"), s = s || {}, a(f).append("<div class='ui-pg-div'><span tabindex = '0' role='button' class='ui-icon " + d.delicon + "'></span>" + d.deltext + "</div>"), a("tr", b).append(f), a(f, b).attr({
                                title: d.deltitle || "",
                                id: s.id || "del_" + h
                            }).click(function() {
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    ...
                                    if (b) a.isFunction(d.delfunc) ? d.delfunc.call(g, b) : a(g).jqGrid("delGridRow", b, s);
                                    else {
                                        a.jgrid.viewModal("#" + q.themodal, {
                                            gbox: "#gbox_" + a.jgrid.jqID(g.p.id),
                                            jqm: true
                            ...
                            d.search && (f = a("<td class='ui-pg-button ui-corner-all'></td>"), t = t || {}, a(f).append("<div class='ui-pg-div'><span tabindex = '0' role='button' class='ui-icon " +
                                d.searchicon + "'></span>" + d.searchtext + "</div>"), a("tr", b).append(f), a(f, b).attr({
                                title: d.searchtitle || "",
                                id: t.id || "search_" + h
                            }).click(function() {
                                ...
                                a(this).removeClass("ui-state-hover")
                            }), t.showOnLoad && !0 === t.showOnLoad && a(f, b).click(), f = null);
                            d.refresh && (f = a("<td class='ui-pg-button ui-corner-all'></td>"),
                                a(f).append("<div class='ui-pg-div'><span tabindex = '0' role='button' class='ui-icon " + d.refreshicon + "'></span>" + d.refreshtext + "</div>"), a("tr", b).append(f), a(f, b).attr({
                                    title: d.refreshtitle || "",
                                    id: "refresh_" + h
                                }).click(function() {
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        a.isFunction(d.beforeRefresh) && d.beforeRefresh();
                                        g.p.search = false;
                                        try {
                                            var b = g.p.id;
                                            g.p.postData.filters = "";
                                            a("#fbox_" + a.jgrid.jqID(b)).jqFilter("resetFilter");
                                            a.isFunction(g.clearToolbar) && g.clearToolbar(false)
                                        } catch (c) {}
                                        ...
                                        a.isFunction(d.afterRefresh) && d.afterRefresh()
                                    }
                                    return false
                                }).hover(function() {
                                    a(this).hasClass("ui-state-disabled") || a(this).addClass("ui-state-hover")
            ...
            return this.each(function() {
                if (this.grid) {
                    ...
                    var e = a(".navtable", c)[0],
                        j = this;
                    if (e && !(d.id && null !== a("#" + a.jgrid.jqID(d.id),
                            e).html())) {
                        var s = a("<td></td>");
                        "NONE" == d.buttonicon.toString().toUpperCase() ? a(s).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'>" + d.caption + "</div>") : a(s).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'><span tabindex = '0' role='button' class='ui-icon " + d.buttonicon + "'></span>" + d.caption + "</div>");
                        d.id && a(s).attr("id", d.id);
                        "first" == d.position ? 0 === e.rows[0].cells.length ? a("tr", e).append(s) : a("tr td:eq(0)", e).before(s) : a("tr", e).append(s);
                        a(s, e).attr("title", d.title || "").click(function(c) {
                            a(this).hasClass("ui-state-disabled") ||
                                a.isFunction(d.onClickButton) && d.onClickButton.call(j, c);
                            return !1
                        }).hover(function() {
                            a(this).hasClass("ui-state-disabled") || a(this).addClass("ui-state-hover")
                        }, function() {
        ...
        navSeparatorAdd: function(c, d) {
            ...
            return this.each(function() {
                if (this.grid) {
                    ...
                    var e = a(".navtable", c)[0];
                    if (e) {
                        var j = "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='" +
        ...
        GridToForm: function(c, d) {
            return this.each(function() {
                var e = this;
                if (e.grid) {
                    var j = a(e).jqGrid("getRowData", c);
                    if (j)
                        for (var s in j) a("[name=" + a.jgrid.jqID(s) + "]", d).is("input:radio") || a("[name=" + a.jgrid.jqID(s) + "]", d).is("input:checkbox") ? a("[name=" + a.jgrid.jqID(s) + "]", d).each(function() {
                            if (a(this).val() == j[s]) a(this)[e.p.useProp ? "prop" : "attr"]("checked", !0);
                            else a(this)[e.p.useProp ? "prop" : "attr"]("checked", !1)
                        }) : a("[name=" + a.jgrid.jqID(s) +
                            "]", d).val(j[s])
                }
            })
        },
        FormToGrid: function(c, d, e, j) {
            return this.each(function() {
                if (this.grid) {
                    e || (e = "set");
                    j || (j = "first");
                    var s = a(d).serializeArray(),
                        t = {};
                    a.each(s, function(a, c) {
                        t[c.name] = c.value
                    });
                    "add" == e ? a(this).jqGrid("addRowData", c, t, j) : "set" == e && a(this).jqGrid("setRowData", c, t)
                }
            })
        }
    })
    ...
    a.fn.jqFilter = function(d) {
        ...
        return this.each(function() {
            if (!this.filter) {
                ...
                if (n) {
                    for (d = 0; d < n; d++)
                        if (f = this.p.columns[d], f.stype ? f.inputtype = f.stype : f.inputtype || (f.inputtype = "text"), f.sorttype ? f.searchtype = f.sorttype : f.searchtype || (f.searchtype = "string"), void 0 === f.hidden && (f.hidden = !1), f.label || (f.label = f.name), f.index && (f.name = f.index), f.hasOwnProperty("searchoptions") || (f.searchoptions = {}), !f.hasOwnProperty("searchrules")) f.searchrules = {};
                    ...
                    this.createTableForGroup = function(g, k) {
                        var b = this,
                            c, e =
                            a("<table class='group ui-widget ui-widget-content' style='border:0px none;'><tbody></tbody></table>"),
                            d = "left";
                        ...
                        if (!0 === this.p.ruleButtons) {
                            ...
                            h.bind("click", function() {
                                ...
                                for (c = 0; c < b.p.columns.length; c++) {
                                    var a = typeof b.p.columns[c].search === "undefined" ? true : b.p.columns[c].search,
                                        e = b.p.columns[c].hidden === true;
                        ...
                        if (void 0 !== g.groups)
                            for (c = 0; c < g.groups.length; c++) d = a("<tr></tr>"), e.append(d), h = a("<td class='first'></td>"), d.append(h), h = a("<td colspan='4'></td>"), h.append(this.createTableForGroup(g.groups[c],
                                g)), d.append(h);
                    ...
                    this.createTableRowForRule = function(g, d) {
                        ...
                        i.searchoptions.id =
                            a.jgrid.randId();
                        t && "text" === i.inputtype && !i.searchoptions.size && (i.searchoptions.size = 10);
                        var m = a.jgrid.createEl(i.inputtype, i.searchoptions, g.data, !0, b.p.ajaxSelectOptions, !0),
                            s = a("<select class='selectopts'></select>");
                        j.append(s);
                        ...
                        for (e = 0; e < f.length; e++) p = a.inArray(f[e], q), -1 !== p && (l = g.op === b.p.ops[p].name ? " selected='selected'" : "", j += "<option value='" + b.p.ops[p].name + "'" + l + ">" + b.p.ops[p].description + "</option>");
                        s.append(j);
...
(function(a) {
    ...
    a.jgrid.extend({
        editRow: function(c, d, b, o, h, f, n, l, e) {
            var j = {},
                g = a.makeArray(arguments).slice(1);
            if ("object" === a.type(g[0])) j = g[0];
            else if ("undefined" !== typeof d && (j.keys = d), a.isFunction(b) && (j.oneditfunc = b), a.isFunction(o) && (j.successfunc = o), "undefined" !== typeof h && (j.url = h), "undefined" !== typeof f && (j.extraparam = f), a.isFunction(n) && (j.aftersavefunc = n), a.isFunction(l) && (j.errorfunc = l), a.isFunction(e)) j.afterrestorefunc = e;
            j = a.extend(!0, {
                keys: !1,
                oneditfunc: null,
                successfunc: null,
            ...
            return this.each(function() {
                var e = this,
                    ...
                    l = {},
                    f, k;
                if (e.grid && (f = a(e).jqGrid("getInd", c, !0), !1 !== f && "0" == (a(f).attr("editable") || "0") && !a(f).hasClass("not-editable-row"))) k = e.p.colModel, a('td[role="gridcell"]', f).each(function(f) {
                    d = k[f].name;
                    ...
                    if (j) b = a("span:first", this).html();
                        ...
                        b = k[f].edittype && "textarea" == k[f].edittype ? a(this).text() : a(this).html()
                    }
                    if ("cb" != d && "subgrid" != d && "rn" != d && (e.p.autoencode && (b = a.jgrid.htmlDecode(b)), l[d] = b, !0 === k[f].editable)) {
                        null === h && (h = f);
                        j ? a("span:first", this).html("") : a(this).html("");
                        var t = a.extend({}, k[f].editoptions || {}, {
                            id: c + "_" + d,
                            name: d
                        });
                        k[f].edittype || (k[f].edittype = "text");
                        if ("&nbsp;" == b || "&#160;" == b || 1 == b.length && 160 == b.charCodeAt(0)) b = "";
                        t = a.jgrid.createEl(k[f].edittype,
                            t, b, !0, a.extend({}, a.jgrid.ajaxOptions, e.p.ajaxSelectOptions || {}));
                        a(t).addClass("editable");
                        j ? a("span:first", this).append(t) : a(this).append(t);
                        "select" == k[f].edittype && "undefined" !== typeof k[f].editoptions && !0 === k[f].editoptions.multiple && "undefined" === typeof k[f].editoptions.dataUrl && a.browser.msie && a(t).width(a(t).width());
                        g++
                    }
        ...
        saveRow: function(c, d, b, o, h, f, n) {
            var l = a.makeArray(arguments).slice(1),
                e = {};
            if ("object" === a.type(l[0])) e = l[0];
            else if (a.isFunction(d) &&
                (e.successfunc = d), "undefined" !== typeof b && (e.url = b), "undefined" !== typeof o && (e.extraparam = o), a.isFunction(h) && (e.aftersavefunc = h), a.isFunction(f) && (e.errorfunc = f), a.isFunction(n)) e.afterrestorefunc = n;
            var e = a.extend(!0, {
                    successfunc: null,
                    url: null,
                    extraparam: {},
                ...
                u, s, q;
            if (!g.grid) return j;
            q = a(g).jqGrid("getInd", c, !0);
            if (!1 === q) return j;
            l = a(q).attr("editable");
            e.url = e.url ? e.url : g.p.editurl;
            if ("1" === l) {
                var k;
                    ...
                    if ("cb" != m && "subgrid" != m && !0 === k.editable && "rn" != m && !a(this).hasClass("not-editable-cell")) {
                        switch (k.edittype) {
                            case "checkbox":
                                ...
                                i[m] = a("input", this).is(":checked") ? c[0] : c[1];
                                break;
                            case "text":
                            case "password":
                            case "textarea":
                            ...
                            case "select":
                                if (k.editoptions.multiple) {
                                    ...
                                    i[m] = a(c).val();
                                    i[m] = i[m] ? i[m].join(",") : "";
                                    a("select option:selected", this).each(function(e, b) {
                                        d[e] = a(b).text()
                                    });
                                    v[m] = d.join(",")
                                } else i[m] = a("select option:selected", this).val(), v[m] = a("select option:selected", this).text();
                                k.formatter && "select" == k.formatter && (v = {});
                                break;
                            case "custom":
                                try {
                                    if (k.editoptions && a.isFunction(k.editoptions.custom_value)) {
                                        if (i[m] = k.editoptions.custom_value.call(g, a(".customelement", this), "get"), void 0 === i[m]) throw "e2";
                                    } else throw "e1";
                                } catch (f) {
                                    "e1" ==
                        ...
                        s = a.jgrid.checkValues(i[m], b, g);
                        if (!1 === s[0]) return s[1] = i[m] + " " + s[1], !1;
                        g.p.autoencode && (i[m] = a.jgrid.htmlEncode(i[m]));
                        "clientArray" !== e.url && k.editoptions && !0 === k.editoptions.NullIfEmpty &&
                            "" === i[m] && (r[m] = "null")
                    }
                });
                if (!1 === s[0]) {
                    try {
                        var p = a.jgrid.findPos(a("#" + a.jgrid.jqID(c), g.grid.bDiv)[0]);
                ...
                var w, l = g.p.prmNames;
                w = l.oper;
                p = l.id;
                i && (i[w] = l.editoper, i[p] = c, "undefined" == typeof g.p.inlineData && (g.p.inlineData = {}), i = a.extend({}, i, g.p.inlineData, e.extraparam));
                if ("clientArray" == e.url) {
                    i = a.extend({}, i, v);
                    g.p.autoencode && a.each(i, function(e, b) {
                        i[e] = a.jgrid.htmlDecode(b)
                    });
                    p = a(g).jqGrid("setRowData", c, i);
                    a(q).attr("editable", "0");
                    for (l = 0; l < g.p.savedRow.length; l++)
                        if (g.p.savedRow[l].id == c) {
                            u = l;
                            break
                        }
                    0 <= u && g.p.savedRow.splice(u, 1);
                    a(g).triggerHandler("jqGridInlineAfterSaveRow", [c, p, i, e]);
                    a.isFunction(e.aftersavefunc) && e.aftersavefunc.call(g, c, p);
                    j = !0;
                    a(q).unbind("keydown")
                } else a("#lui_" + a.jgrid.jqID(g.p.id)).show(), r = a.extend({}, i, r), r[p] = a.jgrid.stripPref(g.p.idPrefix, r[p]), a.ajax(a.extend({
                    url: e.url,
                    data: a.isFunction(g.p.serializeRowData) ? g.p.serializeRowData.call(g,
                        r) : r,
                    type: e.mtype,
                    async: !1,
                    complete: function(b, d) {
                        a("#lui_" + a.jgrid.jqID(g.p.id)).hide();
                        if (d === "success") {
                            var f = true,
                                h;
                            h = a(g).triggerHandler("jqGridInlineSuccessSaveRow", [b, c, e]);
                            a.isArray(h) || (h = [true, i]);
                            h[0] && a.isFunction(e.successfunc) && (h = e.successfunc.call(g, b));
                            if (a.isArray(h)) {
                                f = h[0];
                                i = h[1] ? h[1] : i
                            } else f = h;
                            if (f === true) {
                                g.p.autoencode && a.each(i, function(b, e) {
                                    i[b] = a.jgrid.htmlDecode(e)
                                });
                                i = a.extend({}, i, v);
                                a(g).jqGrid("setRowData", c, i);
                                a(q).attr("editable", "0");
                                for (f = 0; f < g.p.savedRow.length; f++)
                                    if (g.p.savedRow[f].id ==
                                        c) {
                                        u = f;
                                        break
                                    }
                                u >= 0 && g.p.savedRow.splice(u, 1);
                                a(g).triggerHandler("jqGridInlineAfterSaveRow", [c, b, i, e]);
                                a.isFunction(e.aftersavefunc) && e.aftersavefunc.call(g, c, b);
                                j = true;
                                a(q).unbind("keydown")
                            } else {
                                a(g).triggerHandler("jqGridInlineErrorSaveRow", [c, b, d, null, e]);
                                a.isFunction(e.errorfunc) && e.errorfunc.call(g, c, b, d, null);
                                e.restoreAfterError === true && a(g).jqGrid("restoreRow", c, e.afterrestorefunc)
                            }
                        }
                    },
                    error: function(b, d, f) {
                        a("#lui_" + a.jgrid.jqID(g.p.id)).hide();
                        a(g).triggerHandler("jqGridInlineErrorSaveRow", [c, b, d, f, e]);
                        if (a.isFunction(e.errorfunc)) e.errorfunc.call(g, c, b, d, f);
                        else try {
                            a.jgrid.info_dialog(a.jgrid.errors.errcap, '<div class="ui-state-error">' + b.responseText + "</div>", a.jgrid.edit.bClose, {
                                buttonalign: "right"
                            })
                        } catch (h) {
        ...
        restoreRow: function(c, d) {
            var b = a.makeArray(arguments).slice(1),
                o = {};
            "object" === a.type(b[0]) ? o = b[0] : a.isFunction(d) && (o.afterrestorefunc =
                d);
            ...
            return this.each(function() {
                ...
                if (b.grid) {
                    ...
                    if (n !== false) {
                        for (var e = 0; e < b.p.savedRow.length; e++)
                            if (b.p.savedRow[e].id == c) {
                                d = e;
                                break
                            }
                        if (d >= 0) {
                            ...
                            a.each(b.p.colModel, function() {
                                this.editable === true && this.name in b.p.savedRow[d] && (l[this.name] = b.p.savedRow[d][this.name])
                            });
                            a(b).jqGrid("setRowData", c, l);
                            a(n).attr("editable",
                                "0").unbind("keydown");
        ...
        inlineNav: function(c, d) {
            ...
            return this.each(function() {
                if (this.grid) {
                    var b = this,
                        o, h = a.jgrid.jqID(b.p.id);
                    b.p._inlinenav = !0;
                    if (!0 === d.addParams.useFormatter) {
                        var f = b.p.colModel,
                            n;
                        for (n = 0; n < f.length; n++)
                            if (f[n].formatter && "actions" === f[n].formatter) {
                                f[n].formatoptions && (f = a.extend({
                                    keys: !1,
                                    onEdit: null,
                                    onSuccess: null,
                                    afterSave: null,
                                    ...
                                    extraparam: {},
                                    url: null
                                }, f[n].formatoptions), d.addParams.addRowParams = {
                                    keys: f.keys,
                                    oneditfunc: f.onEdit,
                    ...
                    d.add && a(b).jqGrid("navButtonAdd", c, {
                        ...
                        onClickButton: function() {
                            ...
                            d.addParams.useFormatter || (a("#" + h + "_ilsave").removeClass("ui-state-disabled"), a("#" + h + "_ilcancel").removeClass("ui-state-disabled"), a("#" + h + "_iladd").addClass("ui-state-disabled"), a("#" + h + "_iledit").addClass("ui-state-disabled"))
                        }
                    });
                    d.edit && a(b).jqGrid("navButtonAdd", c, {
                        ...
                        onClickButton: function() {
                            var c = a(b).jqGrid("getGridParam",
                                "selrow");
                            c ? (a(b).jqGrid("editRow", c, d.editParams), a("#" + h + "_ilsave").removeClass("ui-state-disabled"), a("#" + h + "_ilcancel").removeClass("ui-state-disabled"), a("#" + h + "_iladd").addClass("ui-state-disabled"), a("#" + h + "_iledit").addClass("ui-state-disabled")) : (a.jgrid.viewModal("#alertmod", {
                                gbox: "#gbox_" + h,
                                jqm: !0
                            }), a("#jqg_alrt").focus())
                        }
                    ...
                    d.save && (a(b).jqGrid("navButtonAdd", c, {
                        ...
                        onClickButton: function() {
                            ...
                            if (c) {
                                ...
                                d.editParams.extraparam[f] = a("#" + a.jgrid.jqID(c), "#" + h).hasClass("jqgrid-new-row") ? e.addoper : e.editoper;
                    ...
                    !0 === d.restoreAfterSelect && (o = a.isFunction(b.p.beforeSelectRow) ? b.p.beforeSelectRow : !1, b.p.beforeSelectRow = function(c, e) {
                        var f = true;
                    ...
                    if (!("subgrid" == g || "cb" == g || "rn" == g)) {
                        ...
                        if (!0 === i.editable && !0 === a && !h.hasClass("not-editable-cell")) {
                            ...
                            var j = b.extend({}, i.editoptions || {}, {
                                ...
                                n = b.jgrid.createEl(i.edittype, j, e, !0, b.extend({}, b.jgrid.ajaxOptions, c.p.ajaxSelectOptions || {}));
                        ...
                        } else 0 <= parseInt(c.p.iCol, 10) && 0 <= parseInt(c.p.iRow, 10) && (b("td:eq(" + c.p.iCol + ")", c.rows[c.p.iRow]).removeClass("edit-cell ui-state-highlight"), b(c.rows[c.p.iRow]).removeClass("selected-row ui-state-hover")), h.addClass("edit-cell ui-state-highlight"), b(c.rows[d]).addClass("selected-row ui-state-hover"),
                            e = h.html().replace(/\&#160\;/ig, ""), b(c).triggerHandler("jqGridSelectCell", [c.rows[d].id, g, e, d, f]), b.isFunction(c.p.onSelectCell) && c.p.onSelectCell.call(c, c.rows[d].id, g, e, d, f);
                        c.p.iCol = f;
                        c.p.iRow = d
                    }
                }
            ...
            return a.each(function() {
                ...
                c.bind("mousedown", {
                    ...
                    d = {
                        X: h.left || i("left") || 0,
                        Y: h.top || i("top") || 0,
                        W: i("width") || e[0].scrollWidth || 0,
                        H: i("height") || e[0].scrollHeight || 0,
                        pX: a.pageX,
                        pY: a.pageY,
                        k: c.k
                    };
...
(function(b) {
    b.jgrid.extend({
        setSubGrid: function() {
            return this.each(function() {
                ...
                if (d[0]) {
                    ...
                    for (var c = 0; c < d[0].name.length; c++) d[0].align[c] = d[0].align[c] || "left"
                }
            })
        },
        addSubGridCell: function(b, c) {
            ...
            return '<td role="gridcell" aria-describedby="' + n + '_subgrid" class="ui-sgcollapsed sgcollapsed" ' + a + "><a href='javascript:void(0);'><span class='ui-icon " + m + "'></span></a></td>"
        },
            ...
            return this.each(function() {
                ...
                if (a.grid) {
                    var m =
                        ...
                        n = function(c, d) {
                            var h, f, o, e = b("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
                                i = b("<tr></tr>");
                            ...
                            b(e).append(i);
                            c && (o = a.p.xmlReader.subgrid, b(o.root +
                                " " + o.row, c).each(function() {
                                i = b("<tr class='ui-widget-content ui-subtblcell'></tr>");
                                if (!0 === o.repeatitems) b(o.cell, this).each(function(a) {
                                    m(i, b(this).text() || "&#160;", a)
                                });
                                else {
                        ...
                        p = function(c, d) {
                            var h, f, e,
                                g, i, k = b("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
                                j = b("<tr></tr>");
                            ...
                            b(k).append(j);
                            if (c && (g = a.p.jsonReader.subgrid, h = c[g.root], "undefined" !== typeof h))
                        ...
                        t = function(c) {
                            ...
                            if (a.p.subGridModel[0].params)
                                for (g = 0; g < a.p.subGridModel[0].params.length; g++)
                                    for (f = 0; f < a.p.colModel.length; f++) a.p.colModel[f].name === a.p.subGridModel[0].params[g] && (e[a.p.colModel[f].name] = b("td:eq(" + f + ")", c).text().replace(/\&#160\;/ig, ""));
                            if (!a.grid.hDiv.loading) switch (a.grid.hDiv.loading = !0, b("#load_" + b.jgrid.jqID(a.p.id)).show(), a.p.subgridtype || (a.p.subgridtype = a.p.datatype), b.isFunction(a.p.subgridtype) ? a.p.subgridtype.call(a, e) : a.p.subgridtype = a.p.subgridtype.toLowerCase(), a.p.subgridtype) {
                                case "xml":
                                case "json":
                                    b.ajax(b.extend({
                                        type: a.p.mtype,
                                        ...
                                        complete: function(c) {
                                            a.p.subgridtype === "xml" ? n(c.responseXML, d) : p(b.jgrid.parse(c.responseText), d)
                                        }
                    ...
                    var s = a.rows.length,
                        l = 1;
                    void 0 !== c && 0 < c && (l = c, s = c + 1);
                    for (; l < s;) b(a.rows[l]).hasClass("jqgrow") && b(a.rows[l].cells[d]).bind("click",
                        function() {
                            ...
                            if (b(this).hasClass("sgcollapsed")) {
                                ...
                                if (a.p.subGridOptions.reloadOnExpand === true || a.p.subGridOptions.reloadOnExpand === false && !b(j).hasClass("ui-subgrid")) {
                                    ...
                                    b(c).after("<tr role='row' class='ui-subgrid'>" +
                                        q + "<td class='ui-widget-content subgrid-cell'><span class='ui-icon " + a.p.subGridOptions.openicon + "'></span></td><td colspan='" + parseInt(a.p.colNames.length - 1 - r, 10) + "' class='ui-widget-content subgrid-data'><div id=" + k + "_" + e + " class='tablediv'></div></td></tr>");
                                    b(a).triggerHandler("jqGridSubGridRowExpanded", [k + "_" + e, e]);
                                    b.isFunction(a.p.subGridRowExpanded) ? a.p.subGridRowExpanded.call(a, k + "_" + e, e) : t(c)
                                } else b(j).show();
                                ...
                                if ((g = g === false || g === "stop" ? false : true) && b.isFunction(a.p.subGridRowColapsed)) {
                                    e = c.id;
                                    g = a.p.subGridRowColapsed.call(a, k + "_" + e, e)
                                }
                                if (g === false) return false;
                            ...
                            return false
                        }), !0 === a.p.subGridOptions.expandOnLoad && b(a.rows[l].cells[d]).trigger("click"), l++;
    ...
    e.jgrid.extend({
        groupingSetup: function() {
            return this.each(function() {
                ...
                if (null !== a && ("object" === typeof a || e.isFunction(a)))
                    if (a.groupField.length) {
                        "undefined" == typeof a.visibiltyOnNextGrouping && (a.visibiltyOnNextGrouping = []);
                        for (var c = 0; c < a.groupField.length; c++)
                            if (a.groupOrder[c] || (a.groupOrder[c] = "asc"), a.groupText[c] || (a.groupText[c] = "{0}"), "boolean" != typeof a.groupColumnShow[c] && (a.groupColumnShow[c] = !0), "boolean" != typeof a.groupSummary[c] && (a.groupSummary[c] = !1), !0 === a.groupColumnShow[c] ? (a.visibiltyOnNextGrouping[c] = !0, e(this).jqGrid("showCol", a.groupField[c])) : (a.visibiltyOnNextGrouping[c] = e("#" + e.jgrid.jqID(this.p.id + "_" + a.groupField[c])).is(":visible"), e(this).jqGrid("hideCol", a.groupField[c])), a.sortitems[c] = [], a.sortnames[c] = [], a.summaryval[c] = [], a.groupSummary[c]) {
                                a.summary[c] = [];
                                for (var b = this.p.colModel, d = 0, g = b.length; d < g; d++) b[d].summaryType && a.summary[c].push({
                                    nm: b[d].name,
                                    st: b[d].summaryType,
                                    v: ""
                                })
        ...
        groupingPrepare: function(a, c, b, d) {
            this.each(function() {
                ...
                var g = c[0].toString().split(" ").join(""),
                    ...
                    f = this;
                b.hasOwnProperty(g) ? b[g].push(a) : (b[g] = [], b[g].push(a), h.sortitems[0].push(g), h.sortnames[0].push(e.trim(c[0].toString())), h.summaryval[0][g] = e.extend(!0, [], h.summary[0]));
        ...
        groupingToggle: function(event, a) {        	
        	if(event.type=='keypress'){
        		if(event.which !=13){
        			return false;
        		}
            ...
            this.each(function() {
                var c = this.p.groupingView,
                    ...
                    l = e("#" + e.jgrid.jqID(a) + " span.tree-wrap-" + this.p.direction),
                    m = !1;
                if (l.hasClass(g)) {
                    if (c.showSummaryOnHide && c.groupSummary[0]) {
                        if (f)
                            for (; f && !e(f).hasClass("jqfoot");) e(f).hide(), f = f.nextSibling
                    } else if (f)
                        for (; f && e(f).attr("id") != d + ("" + b);) e(f).hide(), f = f.nextSibling;
                    l.removeClass(g).addClass(h);
                    m = !0
                } else {
                    if (f)
                        for (; f && e(f).attr("id") != d + ("" + b);) e(f).show(), f = f.nextSibling;
                    l.removeClass(h).addClass(g)
                }
                e(this).triggerHandler("jqGridGroupingClickGroup", [a, m]);
                e.isFunction(this.p.onClickGroup) && this.p.onClickGroup.call(this, a, m)
            });
            return !1
        },
        groupingRender: function(a, c) {
            return this.each(function() {
                var b = this,
                    ...
                    g = "",
                    h = "",
                    f, l = d.groupCollapse ? d.plusicon : d.minusicon,
                    m, q, i;
                d.groupDataSorted || (d.sortitems[0].sort(), d.sortnames[0].sort(), "desc" == d.groupOrder[0].toLowerCase() &&
                    (d.sortitems[0].reverse(), d.sortnames[0].reverse()));
                l += " tree-wrap-" + b.p.direction;
                for (i = 0; i < c;) {
                    if (b.p.colModel[i].name == d.groupField[0]) {
                        q = i;
                        break
                    }
                    i++
                }
                e.each(d.sortitems[0], function(i, n) {
                    f = b.p.id + "ghead_" + i;
                    h = "<span style='cursor:pointer;' class='ui-icon " + l + "' tabindex='0' OnKeyPress=\"jQuery('#" + e.jgrid.jqID(b.p.id) + "').jqGrid('groupingToggle', event, '" + f + "');return false;\" onclick=\"jQuery('#" + e.jgrid.jqID(b.p.id) + "').jqGrid('groupingToggle', event, '" + f + "');return false;\"></span>";
                    try {
                        m = b.formatter(f, d.sortnames[0][i], q, d.sortitems[0])
                    } catch (u) {
                        m = d.sortnames[0][i]
                    }
                    g = g + ('<tr id="' + f + '" role="row" class= "ui-widget-content jqgroup ui-row-' +
                        b.p.direction + '"><td colspan="' + c + '">' + h + e.jgrid.format(d.groupText[0], m, a[n].length) + "</td></tr>");
                    for (var j = 0; j < a[n].length; j++) g = g + a[n][j].join("");
                    if (d.groupSummary[0]) {
                        j = "";
                        d.groupCollapse && !d.showSummaryOnHide && (j = ' style="display:none;"');
                        g = g + ("<tr" + j + ' role="row" class="ui-widget-content jqfoot ui-row-' + b.p.direction + '">');
                        for (var j = d.summaryval[0][n], o = b.p.colModel, p, r = a[n].length, k = 0; k < c; k++) {
                            var s = "<td " + b.formatCol(k, 1, "") + ">&#160;</td>",
                                t = "{0}";
                            e.each(j, function() {
                                if (this.nm == o[k].name) {
                                    if (o[k].summaryTpl) t =
                                        o[k].summaryTpl;
                                    if (this.st == "avg" && this.v && r > 0) this.v = this.v / r;
                                    try {
                                        p = b.formatter("", this.v, k, this)
                                    } catch (a) {
                                        p = this.v
                                    }
                                    s = "<td " + b.formatCol(k, 1, "") + ">" + e.jgrid.format(t, p) + "</td>";
                                    return false
                                }
                            });
                            g = g + s
                ...
                e("#" + e.jgrid.jqID(b.p.id) + " tbody:first").append(g);
                g = null
            })
        },
        groupingGroupBy: function(a, c) {
            return this.each(function() {
                ...
                var d;
                for (d = 0; d <
                    b.groupField.length; d++) !b.groupColumnShow[d] && b.visibiltyOnNextGrouping[d] && e(this).jqGrid("showCol", b.groupField[d]);
                for (d = 0; d < a.length; d++) b.visibiltyOnNextGrouping[d] = e("#" + e.jgrid.jqID(this.p.id) + "_" + e.jgrid.jqID(a[d])).is(":visible");
            ...
            return this.each(function() {
                ...
                if (!0 === a) {
                    for (var c = this.p.groupingView, b = 0; b < c.groupField.length; b++) !c.groupColumnShow[b] &&
                        c.visibiltyOnNextGrouping[b] && e(this).jqGrid("showCol", c.groupField);
    ...
    d.jgrid.extend({
            ...
            return this.each(function() {
                ...
                if (c.grid && c.p.treeGrid)
                    for (var e = c.p.expColInd, g = c.p.treeReader.expanded_field, h = c.p.treeReader.leaf_field, f = c.p.treeReader.level_field, l = c.p.treeReader.icon_field, j = c.p.treeReader.loaded, i, p, m, k; a < b;) k = c.p.data[c.p._index[c.rows[a].id]], "nested" == c.p.treeGridModel && !k[h] && (i = parseInt(k[c.p.treeReader.left_field], 10), p = parseInt(k[c.p.treeReader.right_field], 10), k[h] = p === i + 1 ? "true" : "false", c.rows[a].cells[c.p._treeleafpos].innerHTML =
                        ...
                        a = d(a.target || a.srcElement, c.rows).closest("tr.jqgrow")[0].id;
                        a = c.p._index[a];
                        if (!c.p.data[a][h])
                            if (c.p.data[a][g]) {
                                d(c).jqGrid("collapseRow", c.p.data[a]);
                                d(c).jqGrid("collapseNode", c.p.data[a])
                            } else {
                                d(c).jqGrid("expandRow", c.p.data[a]);
                                d(c).jqGrid("expandNode", c.p.data[a])
                            }
                        return false
                    }), !0 === c.p.ExpandColClick && d(c.rows[a].cells[e]).find("span.cell-wrapper").css("cursor", "pointer").bind("click", function(a) {
                        var a = d(a.target || a.srcElement, c.rows).closest("tr.jqgrow")[0].id,
                            b = c.p._index[a];
                        if (!c.p.data[b][h])
                            if (c.p.data[b][g]) {
                                d(c).jqGrid("collapseRow", c.p.data[b]);
                                d(c).jqGrid("collapseNode",
                                    c.p.data[b])
                            } else {
                                d(c).jqGrid("expandRow", c.p.data[b]);
                                d(c).jqGrid("expandNode", c.p.data[b])
                            }
                        d(c).jqGrid("setSelection", a);
                        return false
                    }), a++
            })
        },
                ...
                if (a.p.treeGrid) {
                    ...
                    for (g in a.p.colModel)
                        if (a.p.colModel.hasOwnProperty(g)) {
                            ...
                            e == a.p.ExpandColumn && !c && (c = !0, a.p.expColInd = b);
                            b++;
                            for (var f in a.p.treeReader) a.p.treeReader[f] == e && h.push(e)
                        }
                    d.each(a.p.treeReader, function(c, e) {
                        if (e && d.inArray(e, h) === -1) {
                            if (c === "leaf_field") a.p._treeleafpos = b;
                            b++;
                            a.p.colNames.push(e);
                            a.p.colModel.push({
                                name: e,
        ...
        expandRow: function(a) {
            this.each(function() {
                ...
                if (b.grid &&
                    b.p.treeGrid) {
                    var c = d(b).jqGrid("getNodeChildren", a),
                        e = b.p.treeReader.expanded_field,
                        g = b.rows;
                    d(c).each(function() {
                        var a = d.jgrid.getAccessor(this, b.p.localReader.id);
                        d(g.namedItem(a)).css("display", "");
                        this[e] && d(b).jqGrid("expandRow", this)
                    })
                }
            })
        },
            ...
            this.each(function() {
                ...
                if (b.grid && b.p.treeGrid) {
                    ...
                    d(c).each(function() {
                        ...
                        d(g.namedItem(a)).css("display",
                            "none");
                        this[e] && d(b).jqGrid("collapseRow", this)
                    })
                }
            })
        },
        getRootNodes: function() {
            ...
            this.each(function() {
                ...
                if (b.grid && b.p.treeGrid) switch (b.p.treeGridModel) {
                    case "nested":
                        var c = b.p.treeReader.level_field;
                        d(b.p.data).each(function() {
                            parseInt(this[c], 10) === parseInt(b.p.tree_root_level, 10) && a.push(this)
                        });
                        break;
                    case "adjacency":
                        var e = b.p.treeReader.parent_id_field;
                        d(b.p.data).each(function() {
        ...
        getNodeDepth: function(a) {
            ...
            this.each(function() {
                if (this.grid && this.p.treeGrid) switch (this.p.treeGridModel) {
                    case "nested":
                        b = parseInt(a[this.p.treeReader.level_field], 10) - parseInt(this.p.tree_root_level, 10);
                        break;
                    case "adjacency":
                        b = d(this).jqGrid("getNodeAncestors", a).length
                }
            });
            return b
        },
                ...
                if (this.grid && this.p.treeGrid) switch (this.p.treeGridModel) {
                    case "nested":
                        ...
                        d(this.p.data).each(function() {
                            if (parseInt(this[g], 10) === l - 1 && parseInt(this[c], 10) < h && parseInt(this[e], 10) > f) return b = this, !1
                        });
                        break;
                    case "adjacency":
                        var j = this.p.treeReader.parent_id_field,
                            i = this.p.localReader.id;
                        d(this.p.data).each(function() {
                            if (this[i] == a[j]) return b = this, !1
                        })
                }
            });
            return b
                ...
                if (this.grid && this.p.treeGrid) switch (this.p.treeGridModel) {
                    case "nested":
                        var c = this.p.treeReader.left_field,
                            ...
                            l = parseInt(a[g], 10);
                        d(this.p.data).each(function() {
                            parseInt(this[g], 10) === l + 1 && parseInt(this[c], 10) > h && parseInt(this[e], 10) < f && b.push(this)
                        });
                        break;
                    case "adjacency":
                        var j = this.p.treeReader.parent_id_field,
                ...
                if (this.grid && this.p.treeGrid) switch (this.p.treeGridModel) {
                    case "nested":
                        var e =
                            ...
                            j = parseInt(a[h], 10);
                        d(this.p.data).each(function() {
                            parseInt(this[h], 10) >= j && parseInt(this[e], 10) >= f && parseInt(this[e], 10) <= l && b.push(this)
                        });
                        break;
                    case "adjacency":
                        if (a) {
        ...
        getNodeAncestors: function(a) {
            ...
            this.each(function() {
                if (this.grid && this.p.treeGrid)
                    for (var c = d(this).jqGrid("getNodeParent", a); c;) b.push(c), c = d(this).jqGrid("getNodeParent", c)
            });
            return b
        },
        isVisibleNode: function(a) {
            ...
            this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    var c = d(this).jqGrid("getNodeAncestors", a),
                ...
                if (this.grid && this.p.treeGrid) {
                    ...
                    if (!a[b]) {
                        var l = d.jgrid.getAccessor(a, this.p.localReader.id),
                            j = d("#" + d.jgrid.jqID(l), this.grid.bDiv)[0],
                            i = this.p._index[l];
                        d(this).jqGrid("isNodeLoaded", this.p.data[i]) ? (a[b] = !0, d("div.treeclick", j).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus")) : this.grid.hDiv.loading || (a[b] = !0, d("div.treeclick", j).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus"), this.p.treeANode = j.rowIndex, this.p.datatype = this.p.treedatatype, "nested" == this.p.treeGridModel ? d(this).jqGrid("setGridParam", {
                                postData: {
                                    nodeid: l,
                                    n_left: a[h],
                                    n_right: a[f],
        ...
        collapseNode: function(a) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    var b = this.p.treeReader.expanded_field;
                    a[b] && (a[b] = !1, b = d.jgrid.getAccessor(a, this.p.localReader.id),
        ...
        SortTree: function(a, b, c, e) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    ...
                    i = g.select();
                    g = 0;
                    for (h = i.length; g < h; g++) f = i[g], l.push(f), d(this).jqGrid("collectChildrenSortTree", l, f, a, b, c, e);
                    d.each(l, function(a) {
        ...
        collectChildrenSortTree: function(a, b, c, e, g, h) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    var f, l, j, i;
                    f = d(this).jqGrid("getNodeChildren", b);
                    f = d.jgrid.from(f);
                    f.orderBy(c, e, g, h);
                    i = f.select();
                    f = 0;
                    for (l = i.length; f < l; f++) j = i[f], a.push(j), d(this).jqGrid("collectChildrenSortTree", a, j, c, e, g, h)
                }
            })
        },
            ...
            return this.each(function() {
                ...
                if (this.grid && this.p.treeGrid) {
                    ...
                    if (void 0 !== l) {
                        ...
                        h = g - parseInt(this.p.data[l][c], 10) + 1;
                        l = d(this).jqGrid("getFullTreeNode", this.p.data[l]);
                        if (0 < l.length)
                            for (var j = 0; j < l.length; j++) d(this).jqGrid("delRowData", l[j][b]);
                        if ("nested" === this.p.treeGridModel) {
                            b =
                                d.jgrid.from(this.p.data).greater(c, g, {
                                    stype: "integer"
                                }).select();
                            if (b.length)
                                for (f in b) b.hasOwnProperty(f) && (b[f][c] = parseInt(b[f][c], 10) - h);
                            b = d.jgrid.from(this.p.data).greater(e, g, {
                                stype: "integer"
                            }).select();
                            if (b.length)
                                for (f in b) b.hasOwnProperty(f) && (b[f][e] = parseInt(b[f][e], 10) - h)
                        }
                    }
                }
            })
        ...
        addChildNode: function(a, b, c) {
            ...
            if (c) {
                var g = e.p.treeReader.expanded_field,
                    ...
                    j = e.p.treeReader.left_field,
                    i = e.p.treeReader.right_field,
                    p = e.p.treeReader.loaded,
                    m, k, q, s, o;
                m = 0;
                var r = b,
                    t;
                if ("undefined" === typeof a || null === a) {
                    o = e.p.data.length - 1;
                    if (0 <= o)
                        for (; 0 <= o;) m = Math.max(m, parseInt(e.p.data[o][e.p.localReader.id], 10)), o--;
                    a = m + 1
                }
                var u = d(e).jqGrid("getInd", b);
                t = !1;
                if (void 0 === b || null === b || "" === b) r = b = null, m = "last", s = e.p.tree_root_level, o = e.p.data.length + 1;
                else if (m = "after", k = e.p._index[b], q = e.p.data[k], b = q[e.p.localReader.id], s = parseInt(q[f], 10) + 1, o = d(e).jqGrid("getFullTreeNode", q), o.length ? (r = o = o[o.length - 1][e.p.localReader.id], o = d(e).jqGrid("getInd",
                        r) + 1) : o = d(e).jqGrid("getInd", b) + 1, q[h]) t = !0, q[g] = !0, d(e.rows[u]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(e.p.treeIcons.leaf + " tree-leaf").addClass(e.p.treeIcons.minus + " tree-minus"), e.p.data[k][h] = !1, q[p] = !0;
                k = o + 1;
                c[g] = !1;
                c[p] = !0;
                c[f] = s;
                c[h] = !0;
                "adjacency" === e.p.treeGridModel && (c[l] = b);
                if ("nested" === e.p.treeGridModel) {
                    ...
                    if (null !== b) {
                        ...
                        f = f.select();
                        if (f.length)
                            for (n in f) f.hasOwnProperty(n) && (f[n][j] = f[n][j] > h ? parseInt(f[n][j], 10) + 2 : f[n][j], f[n][i] = f[n][i] >= h ? parseInt(f[n][i], 10) + 2 : f[n][i]);
                        c[j] = h;
                        c[i] = h + 1
                    } else {
                        ...
                        if (f.length)
                            for (n in f) f.hasOwnProperty(n) && (f[n][j] = parseInt(f[n][j], 10) + 2);
                        f = d.jgrid.from(e.p.data).greater(i, h, {
                            stype: "integer"
                        }).select();
                        if (f.length)
                            for (n in f) f.hasOwnProperty(n) && (f[n][i] = parseInt(f[n][i],
                                10) + 2);
                        c[j] = h + 1;
                        c[i] = h + 2
                    }
                }
                if (null === b || d(e).jqGrid("isNodeLoaded", q) || t) d(e).jqGrid("addRowData", a, c, m, r), d(e).jqGrid("setTreeNode", o, k);
        ...
        jqGridExport: function(a) {
            ...
            this.each(function() {
                if (this.grid) {
                    ...
                    b.knv = null;
                    if (b.treeGrid)
                        for (var g in b.treeReader) b.treeReader.hasOwnProperty(g) && (b.colNames.splice(b.colNames.length - 1), b.colModel.splice(b.colModel.length - 1));
                    switch (a.exptype) {
                        case "xmlstring":
                            d =
        ...
        var g = function(a, b, e) {
                ...
                if (a instanceof Array)
                    if (0 === a.length) d += e + "<" + b + ">__EMPTY_ARRAY_</" + b + ">\n";
                        ...
                        for (f = 0, i = a.length; f < i; f += 1) var l = e + g(a[f], b, e + "\t") + "\n",
                            d = d + l;
        ...
        columnChooser: function(a) {
            ...
            if (!b("#colchooser_" + b.jgrid.jqID(c[0].p.id)).length) {
                    ...
                    a = b.extend({
                        ...
                        apply_perm: function() {
                            ...
                            b.each(f, function() {
                                ...
                                if (c >= 0) {
                                    var g = a.slice(),
                                        e = g.splice(c, Math.max(a.length - c, c));
                ...
                var k = c.jqGrid("getGridParam", "colModel"),
                    p = c.jqGrid("getGridParam", "colNames"),
                    f = {},
                    j = [];
                g.empty();
                b.each(k, function(b) {
                    f[this.name] = b;
                    this.hidedlg ? this.hidden || j.push(b) : g.append("<option value='" + b + "' " + (this.hidden ? "" : "selected='selected'") + ">" + p[b] + "</option>")
                });
                var i = b.isFunction(a.dlog_opts) ? a.dlog_opts.call(c, a) : a.dlog_opts;
                e(a.dlog, d, i);
                i = b.isFunction(a.msel_opts) ? a.msel_opts.call(c, a) : a.msel_opts;
                e(a.msel,
                    g, i)
            }
        },
                                ...
                                return b.extend({
                                    ...
                                    drop: function(d, e) {
                                        if (b(e.draggable).hasClass("jqgrow")) {
                                            var f =
                                                b(e.draggable).attr("id"),
                                                f = e.draggable.parent().parent().jqGrid("getRowData", f);
                                            if (!a.dropbyname) {
                                                var j = 0,
                                                    i = {},
                                                    h, n = b("#" + b.jgrid.jqID(this.id)).jqGrid("getGridParam", "colModel");
                                                try {
                                                    for (var o in f) {
                                                        h = n[j].name;
                                            ...
                                            if (e.helper.dropped) {
                                                var l;
                                                if (a.autoid)
                                                    if (b.isFunction(a.autoid)) l = a.autoid.call(this, f);
                                                    else {
