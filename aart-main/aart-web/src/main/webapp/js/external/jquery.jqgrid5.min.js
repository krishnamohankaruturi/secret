...
/*
 *Deb 6/25 Fix  jqGrid 5.1 (getRowData return empty array)
 *https://github.com/tonytomov/jqGrid/issues/811 
 * 
 */
! function(a) {
    "use strict";
        ...
        return this.each(function() {
            if (!this.grid) {
                ...
                var
                    ...
                    U = function(a, b) {
                        var
                            ...
                            r = "",
                            s = "<table role='presentation' class='ui-pg-table ui-common-table ui-paging-pager'><tbody><tr>",
                            t = "",
                            u = function(a, b) {
                                var
                                    c;
                        ...
                        if (a = a.substr(1), b += "_" + a, c = "pg_" + a, e = a + "_left", f = a + "_center", g = a + "_right", $("#" + $.jgrid.jqID(a)).append("<div id='" + c + "' class='ui-pager-control' role='group'><table role= 'presentation' " + k(l, "pagerTable", !1, "ui-pg-table ui-common-table ui-pager-table") + "><tbody><tr><td id='" + e + "' align='left'></td><td id='" + f + "' align='center' style='white-space:pre;'></td><td id='" + g + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr"), d.p.rowList.length > 0) {
                        ...
                        if ("rtl" === h && (s += t), d.p.pginput === !0 && (r = "<td id='input" + b + "' dir='" + h + "'>" + $.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' title='Page Number'value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(a) + "'></span>") + "</td>"), d.p.pgbuttons === !0) {
                            var
                ...
                ra = null, e.hDiv = document.createElement("div"), e.hDiv.style.width = e.width - Ga + "px", e.hDiv.className = k(l, "headerDiv", !0, "ui-jqgrid-hdiv"), $(e.hDiv).append(Fa), $(Fa).append(Da), Da = null, Ea && $(e.hDiv).hide(), d.p.pager && ("string" == typeof d.p.pager ? "#" !== d.p.pager.substr(0, 1) && (d.p.pager = "#" + d.p.pager) : d.p.pager = "#" + $(d.p.pager).attr("id"), $(d.p.pager).css({
                    width: e.width + "px"
                }).addClass(k(l, "pagerBox", !0, "ui-jqgrid-pager")).appendTo(w), Ea && $(d.p.pager).hide(), U(d.p.pager, "")), d.p.cellEdit === !1 && d.p.hoverrows === !0 && $(d).bind("mouseover", function(a) {
...
! function(a) {
    ...
    a.fmatter = {}, a.extend(a.fmatter, {
    ...
    }, a.fn.fmatter.rowactions = function(b,event) {
        ...
        var
            k = "onmouseover=jQuery(this).addClass('" + j.hover + "'); onfocus=jQuery(this).addClass('" + j.hover + "'); onmouseout=jQuery(this).removeClass('" + j.hover + "'); onblur=jQuery(this).removeClass('" + j.hover + "'); ";
        return e.editformbutton ? (d = "id='jEditButton_" + f + "' tabindex='0' onkeypress=jQuery.fn.fmatter.rowactions.call(this,'formedit',event); onclick=jQuery.fn.fmatter.rowactions.call(this,'formedit',event); " + k, g += "<div title='" + h.edittitle + "' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' " + d + "><span class='" + j.icon_base + " " + i.icon_edit + "'></span></div>") : e.editbutton && (d = "id='jEditButton_" + f + "'tabindex='0' onkeypress=jQuery.fn.fmatter.rowactions.call(this,'edit',event); onclick=jQuery.fn.fmatter.rowactions.call(this,'edit',event); " + k, g += "<div title='" + h.edittitle + "' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' " + d + "><span class='" + j.icon_base + " " + i.icon_edit + "'></span></div>"), e.delbutton && (d = "id='jDeleteButton_" + f + "'tabindex='0' onkeypress=jQuery.fn.fmatter.rowactions.call(this,'del',event); onclick=jQuery.fn.fmatter.rowactions.call(this,'del',event); " + k, g += "<div title='" + h.deltitle + "' style='float:left;' class='ui-pg-div ui-inline-del' " + d + "><span class='" + j.icon_base + " " + i.icon_del + "'></span></div>"), d = "id='jSaveButton_" + f + "' tabindex='0' onkeypress=jQuery.fn.fmatter.rowactions.call(this,'save',event); onclick=jQuery.fn.fmatter.rowactions.call(this,'save',event); " + k, g += "<div title='" + h.savetitle + "' style='float:left;display:none' class='ui-pg-div ui-inline-save' " + d + "><span class='" + j.icon_base + " " + i.icon_save + "'></span></div>", d = "id='jCancelButton_" + f + "'tabindex='0' onkeypress=jQuery.fn.fmatter.rowactions.call(this,'cancel',event); onclick=jQuery.fn.fmatter.rowactions.call(this,'cancel',event); " + k, g += "<div title='" + h.canceltitle + "' style='float:left;display:none;' class='ui-pg-div ui-inline-cancel' " + d + "><span class='" + j.icon_base + " " + i.icon_cancel + "'></span></div>", "<div style='margin-left:8px;'>" + g + "</div>"
                ...
                if (!this.p.navGrid) {
                    ...
                    if (p.grid && "string" == typeof b) {
                        ...
                        for (n.cloneToTop && p.p.toppager && (r = 2), q = 0; r > q; q++) {
                            var
                                u, v, w, x = a("<table role='presentation' class='ui-pg-table navtable ui-common-table'><tbody><tr></tr></tbody></table>"),
                            ...
                            0 === q ? (v = b, w = p.p.id, v === p.p.toppager && (w += "_top", r = 1)) : (v = p.p.toppager, w = p.p.id + "_top"), "rtl" === p.p.direction && a(x).attr("dir", "rtl").css("float", "right"), e = e || {}, n.add && (u = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(u).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.addicon + "'></span>" + n.addtext + "</div>"), a("tr", x).append(u), a(u, x).attr({
                                ...
                                if (!a(this).hasClass(l.disabled)) {
                                    ...
                                    b ? a.isFunction(n.editfunc) ? n.editfunc.call(p, b) : a(p).jqGrid("editGridRow", b, d) : (a.jgrid.viewModal("#" + o.themodal, {
                                        gbox: "#gbox_" + a.jgrid.jqID(p.p.id),
                                        jqm: !0
                                    }), a("#jqg_alrt_"+ a.jgrid.jqID(p.p.id)).focus())
                                }
                                return !1
                        ...
                        d.add && (f = f || {}, b = f.id || "add_" + c, k = a('<li class="ui-menu-item" role="presentation"><a class="' + n.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + b + '">' + (d.addtext || d.addtitle) + "</a></li>").click(function() {
                            ...
                            if (!a(this).hasClass(n.disabled)) {
                                ...
                                b ? a.isFunction(d.editfunc) ? d.editfunc.call(j, b) : a(j).jqGrid("editGridRow", b, e) : (a.jgrid.viewModal("#" + r.themodal, {
                                    ...
                                    jqm: !0
                                }), a("#jqg_alrt_"+ a.jgrid.jqID(j.p.id)).focus()), a(p).hide()
                            }
                            return !1
                ...
                if (!d.p.filterToolbar) {
                    ...
                    var
                        ...
                        k = function() {
                            ...
                            a.each(d.p.colModel, function() {
                            	...
                            	var
                                    n = a("#gs_" + d.p.idPrefix + a.jgrid.jqID(search_filter_id), this.frozen === !0 && d.p.frozenColumns === !0 ? d.grid.fhDiv : d.grid.hDiv);
                        ...
                        l = function(c) {
                            ...
                            c ? !0 : c, a.each(d.p.colModel, function() {
                            	 ...
                            	 var search_filter_id = (this.label==null || this.label == undefined || this.label == 'undefined') ? this.name:this.label;
                                var
                                    b, c = a("#gs_" + d.p.idPrefix + a.jgrid.jqID(search_filter_id), this.frozen === !0 && d.p.frozenColumns === !0 ? d.grid.fhDiv : d.grid.hDiv);
                    ...
                    b.restoreFromFilters && (g = d.p.postData.filters, g && ("string" == typeof g && (g = a.jgrid.parse(g)), f = g.rules.length ? g.rules : !1)), a.each(d.p.colModel, function(c) {
                        var
                            ...
                            w = a("<div></div>"),
                            x = a("<table class='ui-search-table' role='presentation' cellspacing='0'><tr><td class='ui-search-oper' headers=''></td><td class='ui-search-input' headers=''></td><td class='ui-search-clear' headers=''></td></tr></table>");
                        if (this.hidden === !0 && a(v).css("display", "none"), this.search = this.search === !1 ? !1 : !0, void 0 === this.stype && (this.stype = "text"), this.searchoptions = this.searchoptions || {}, void 0 === this.searchoptions.searchOperMenu && (this.searchoptions.searchOperMenu = !0), g = a.extend({}, this.searchoptions, {
                                name: s.index || s.name,
                                id: "gs_" + d.p.idPrefix +( (s.label==null || s.label == undefined || s.label == 'undefined') ? s.name:s.label),
                                oper: "search"
                            }), this.search) {
            ...
            return b = a.extend(!0, {
                ...
                c(f) {
                    if (f && f.rules) {
                    	...
                    	var search_filter_id = (k[i].label==null || k[i].label == undefined || k[i].label == 'undefined') ? k[i].name:k[i].label;
                    	
                        for (g = f.rules, l = g.length, d = 0; l > d; d++) h = g[d], i = a.inArray(h.field, m), -1 !== i && (e = a("#gs_" + j.p.idPrefix + a.jgrid.jqID(search_filter_id)), e.length > 0 && ("select" === k[i].stype ? e.find("option[value='" + a.jgrid.jqID(h.data) + "']").prop("selected", !0) : "text" === k[i].stype && e.val(h.data), a.isFunction(b.onSetVal) && b.onSetVal.call(j, e, k[i].name)));
                        if (f.groups)
                            for (var
                ...
                if (j.p.filterToolbar) {
                    for (d = 0; l > d; d++) {
                    	...
                    	var search_filter_id = (k[d].label==null || k[d].label == undefined || k[d].label == 'undefined') ? k[d].name:k[d].label;
                    	
                        switch (m.push(k[d].name), e = a("#gs_" + j.p.idPrefix + a.jgrid.jqID(search_filter_id)), k[d].stype) {
                            case "select":
                            case "text":
                                e.val("")
                        }
...
! function(a) {
    ...
    a.jgrid.extend({
        ...
        groupingToggle: function(b,event) {
        	if(event.type=='keypress'){
      		  if(event.which !=13){
      		   return true;
      		  }
        ...
        groupingRender: function(b, c, d, e) {
            return this.each(function() {
                ...
                u.reverse(), s = k.p.multiselect ? ' colspan="2"' : "", a.each(l.groups, function(f, v) {
                    ...
                    t++, i = k.p.id + "ghead_" + v.idx, h = i + "_" + f, n = "<span style='cursor:pointer;margin-right:8px;margin-left:5px;' tabindex='0' class='" + r.icon_base + " " + o + "' onkeypress=\"jQuery('#" + a.jgrid.jqID(k.p.id) + "').jqGrid('groupingToggle','" + h + "',event);return true;\" onclick=\"jQuery('#" + a.jgrid.jqID(k.p.id) + "').jqGrid('groupingToggle','" + h + "',event);return false;\"></span>";
                    try {
