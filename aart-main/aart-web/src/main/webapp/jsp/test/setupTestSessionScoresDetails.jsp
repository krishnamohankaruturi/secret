...
<div>
	<div class ="panel_full">	
 	  ...
 	  <span id="scoreloadingmessage" class="hidden" ><fmt:message key="label.common.loading"/>...<img src="<c:url value='/images/ajax-loader.gif'/>"/></span>
	...
	function loadScoreTestSessionData() {
		...
		if(($("#scoreTestSession").getGridParam('reccount') == undefined || 
			 ...
			 $.ajax({
					...
					beforeSend: function(){
 						$("#scoreloadingmessage").show();
					},
					complete: function(){
 						$("#scoreloadingmessage").hide();
					},
					dataType: 'json',
					type: "POST",
