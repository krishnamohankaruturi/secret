		...
		<ul>
			<li>
				<div id="helpWindows" style="width: 80%">
					<span class="helpLink" id="createHelpTopic"> <img src="images/icons/edit_icon.png" alt="Create New Topic"/> <a
					style="cursor: pointer;"> <span style="top: 2%;">Create New Topic</span></a>
					</span> 
					<span class="helpLink" id="editTopic" style="dispay: none;"> <img src="images/icons/edit_icon.png" alt="Edit Existing Topic"> <a
					style="cursor: pointer;"> <span style="top: 2%;">Edit Existing Topic</span></a>
					</span> 
					<span class="helpLink" id="createHelpContent"> <img src="images/icons/edit_icon.png" alt="Create New Help Content"> <a
					...
					<div style="width:33%;float:left">
						<label for="helpContentAps" class="field-label">AssessmentProgram <span
							class="lbl-required">*</span></label> 
							 <select id="helpContentAps" class="bcg_select required" multiple="multiple"  name="helpContentAps" title="Select Assessment Program">
					         </select>			
					</div>
					<div style="width:33%;float:left">
					<label for="helpContentStates" class="field-label">State(s) </label>
					 <select id="helpContentStates" class="bcg_select" multiple="multiple" name="helpContentStates" title="Select State"></select>
					</div>
					<div style="width:33%;float:left">
					<label
							for="helpContentRoles" class="field-label">Role(s) </label>
							 <select id="helpContentRoles" class="bcg_select" multiple="multiple"
						 name="helpContentRoles" title="Select Role">
					</select>		
				...
				<div class="form-group" style="width: 100%;float:left">
					...
					<div class="input-append">
						<input type="text" name="helpContentFileDataInput" id="helpContentFileDataInput" class="input-file"
							readOnly="readOnly" title="HelpContentFileDataInput"/><a title="HelpContentFileDataInput" class="add-on" onclick="$('input[id=helpContentFileData]').click();"></a>
					</div>
				</div>
