...
public class BatchReportProcessMedianPartitioner implements Partitioner {

	private final static Log logger = LogFactory .getLog(BatchReportProcessMedianPartitioner.class);
