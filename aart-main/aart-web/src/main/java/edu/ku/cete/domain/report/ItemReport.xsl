			...
			<fo:layout-master-set>
				<fo:simple-page-master master-name="simpleA4"
					...
					<fo:region-body column-count="2" column-gap="0.0in"
						margin-top="0.30in" margin-bottom="0.30in" margin-left="0.03in"
						margin-right="0.03in" />
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:block text-align="center">
						<fo:table border-top-style="none" border-bottom-style="none"
							...
							display-align="center" keep-together.within-column="always">
							...
							<xsl:for-each select="ItemReport/InterimTestItems/InterimReportTasks">
								<fo:table-column column-width="10mm" />
							</xsl:for-each>
							...
							<fo:table-header>
								<fo:table-cell background-color="#1a77bb"
									...
									border-right-style="solid" keep-together.within-column="always">
								...
								<fo:table-cell background-color="#f4be49"
									...
									padding-top="2pt" padding-bottom="2pt" border-top-style="solid"
									border-bottom-style="solid" border-left-style="solid"
									border-right-style="solid" wrap-option="wrap">
									<fo:block font-size="10.0pt" font-family="sans-serif"
								...
								<xsl:for-each select="ItemReport/MaxResponses">
									<fo:table-cell background-color="#f4be49"
										number-columns-spanned="1.5" padding-left="2pt" padding-right="2pt"
										padding-top="2pt" padding-bottom="2pt" border-top-style="solid"
										border-bottom-style="solid" border-left-style="solid"
							...
							<fo:table-body>
								...
								<xsl:for-each select="ItemReport/InterimTestItems">
									<fo:table-row>
										...
										<xsl:for-each select="InterimReportTasks">
