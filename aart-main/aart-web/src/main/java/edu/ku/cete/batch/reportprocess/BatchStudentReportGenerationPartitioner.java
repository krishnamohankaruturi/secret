...
public class BatchStudentReportGenerationPartitioner implements Partitioner {

	private final static Log logger = LogFactory .getLog(BatchStudentReportGenerationPartitioner.class);
