...
@Component("kapAdaptiveJobListener")
public class KapAdaptiveJobListener implements JobExecutionListener {
	final static Log logger = LogFactory.getLog(KapAdaptiveJobListener.class);
