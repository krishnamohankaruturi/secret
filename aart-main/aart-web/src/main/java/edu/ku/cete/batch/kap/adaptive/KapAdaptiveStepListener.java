...
public class KapAdaptiveStepListener <T, S> extends StepListenerSupport<Enrollment, KapAdaptiveContext> {
    ...
    @Override
    public void beforeWrite(List<? extends KapAdaptiveContext> items) {
        LOG.debug(String.format("Step %s - Writing %d items", stepExecution.getStepName(), items.size()));
    }

    @Override
    public void afterWrite(List<? extends KapAdaptiveContext> items) {
    ...
    @Override
    public void onWriteError(Exception exception, List<? extends KapAdaptiveContext> enrollments) {
    ...
    @Override
    public void afterProcess(Enrollment enrollment, KapAdaptiveContext result) {
