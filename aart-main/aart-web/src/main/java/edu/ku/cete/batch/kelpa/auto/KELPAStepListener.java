 ...
 *
 */
public class KELPAStepListener <T, S> extends StepListenerSupport<Enrollment, KELPAContext> {
    ...
    @Override
    public void beforeWrite(List<? extends KELPAContext> items) {
        LOG.debug(String.format("Step %s - Writing %d items", stepExecution.getStepName(), items.size()));
    }

    @Override
    public void afterWrite(List<? extends KELPAContext> items) {
    ...
    @Override
    public void onWriteError(Exception exception, List<? extends KELPAContext> enrollments) {
    ...
    @Override
    public void afterProcess(Enrollment enrollment, KELPAContext result) {
