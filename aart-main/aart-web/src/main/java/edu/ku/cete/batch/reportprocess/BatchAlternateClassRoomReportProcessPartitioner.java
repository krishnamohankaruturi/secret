...
public class BatchAlternateClassRoomReportProcessPartitioner implements Partitioner{

	private final static Log logger = LogFactory .getLog(BatchAlternateClassRoomReportProcessPartitioner.class);
	...
	public Map<String, ExecutionContext> partition(int gridSize) {
		logger.debug("Enter BatchAlternateClassRoomReportProcessPartitioner partition size : "+gridSize);
