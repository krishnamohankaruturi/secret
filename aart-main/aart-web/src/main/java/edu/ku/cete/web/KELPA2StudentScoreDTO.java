...
public class KELPA2StudentScoreDTO {
	...
	private List<StudentScoreDTO> kelpa2StudentScores = new ArrayList<StudentScoreDTO>();
	...
	public List<StudentScoreDTO> getKelpa2StudentScores() {
		return kelpa2StudentScores;
	}

	public void setKelpa2StudentScores(List<StudentScoreDTO> kelpa2StudentScores) {
		this.kelpa2StudentScores = kelpa2StudentScores;
	}
