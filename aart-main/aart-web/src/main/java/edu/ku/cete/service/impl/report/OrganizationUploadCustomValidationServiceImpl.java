...
@Service
public class OrganizationUploadCustomValidationServiceImpl implements BatchUploadCustomValidationService, BatchUploadCustomValidationForAlertService{
	...
	final static Log logger = LogFactory.getLog(OrganizationUploadCustomValidationServiceImpl.class);
	...
	public Map<String, Object> customValidation(BeanPropertyBindingResult validationErrors, Object rowData, Map<String, Object> params, Map<String, String> mappedFieldNames) {
        ...
        if("SCHOOL_XML_RECORD_TYPE".equals(uploadTypeCode) || "LEA_XML_RECORD_TYPE".equals(uploadTypeCode)){
		...
		logger.info("Completed organization custom validation - validation " + (validationPassed ? "passed" : "failed"));
