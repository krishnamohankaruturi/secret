...
-- Scenario 6.1: Creating new roster with only subject.
...
--SELECT createNewRosterWithNoCourse(state_student_identifiers := , att_sch_displayidentifier := , ayp_sch_displayidentifier := , schoolyear := , 
