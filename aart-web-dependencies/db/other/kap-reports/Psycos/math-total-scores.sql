\COPY (
	select s.id as "Student DB ID",
		...
		sr.rawscore as "Raw Score", sr.scalescore as "Scale Score",
		sr.standarderror as "Standard Error", ld.level as "Performance Level"
	from student s
...
) TO 'math-totalscores.csv' DELIMITER ',' CSV HEADER;