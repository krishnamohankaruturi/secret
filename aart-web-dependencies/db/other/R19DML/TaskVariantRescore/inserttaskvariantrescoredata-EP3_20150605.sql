...
ITEMDATA:=ARRAY[['20343','','',''],
['20344','','',''],
['20380','','',''],
['36125','','[{"correctResponse":{"value":"-30","score":1},"acceptableResponses":[]}]',''],
['9570','','{"correctResponses":[{"score":1,"responses":[{"numberOfSegments":"3","numberOfSelections":"1"}]}],"partialResponses":[{"numberOfSegments":{"score":"0.5","number":0},"numberOfSelections":{"score":"0.5","number":1}}]}',''],
['22920','','{"correctResponses":[{"score":2,"responses":[ {"index":2,"foilid":"cb-256214-6-96"}, {"index":3,"foilid":"cb-975763-4-85"}]}], "partialResponses":[ {"index":2,"score":"1.0","foilid":"cb-256214-6-96"}, {"index":3,"score":"1.0","foilid":"cb-975763-4-85"} ]}',''],
['28073','','{"correctResponses":[  {"score":1,"responses":[  {"index":-1,"foilid":"cb-690332-5-4"}]}],  "partialResponses":[ {"index":-1,"score":"1.0","foilid":"cb-690332-5-4"}]}','']];
...
UPDATEREASON:='Rescore after removing $ and comma from response';
