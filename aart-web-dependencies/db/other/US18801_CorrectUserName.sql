...
DECLARE
	...
	stateidentifiers TEXT[] := ARRAY['1002741527','1001310085','1001308612','1001308905','1001889175'];
BEGIN
	FOR i IN array_lower(stateidentifiers, 1) .. array_upper(stateidentifiers, 1) LOOP
		SELECT id, legalfirstname, legallastname
		FROM student
		WHERE stateid = (SELECT id FROM organization WHERE displayidentifier = 'OK')
