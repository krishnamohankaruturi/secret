--DE4929: Grade mapping incorrect in EP for CB tests and test collections
UPDATE assessmentprogramgrades set gradename='Birth–2 years old' where id=1;
...
BEGIN
	...
	IF (row_id.gradename = 'Birth–2 years old') THEN
			UPDATE gradecourse set assessmentprogramgradesid = (select id from assessmentprogramgrades where gradename = row_id.gradename) from assessmentprogramgrades where gradecourse.name = 'Birth–2 years old' or gradecourse.name = 'Birth - 2 years old';
		END IF;
