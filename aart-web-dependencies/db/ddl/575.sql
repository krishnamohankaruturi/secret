...
drop table if exists organizationannualresets;
drop sequence if exists organizationannualresets_id_pk;
create table organizationannualresets (
	id bigserial not null, 
	organizationid bigserial not null, 
	organizationname character varying(100),
	displayidentifier character varying(100),
	schoolstartdate timestamp with time zone, 
	schoolenddate timestamp with time zone,
	schoolyear bigint,
	fcsresetcomplete boolean default false,
	schoolyearresetcomplete boolean default false,
...
create sequence organizationannualresets_id_pk
	INCREMENT 1
	MINVALUE 1
...
--upload external reports function
...
ALTER TABLE student ADD COLUMN scibandid bigint;

ALTER TABLE student ADD COLUMN finalscibandid bigint;

ALTER TABLE student ADD CONSTRAINT sciband_student_fk FOREIGN KEY(scibandid) REFERENCES category(id)  MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE student ADD CONSTRAINT finalsciband_student_fk FOREIGN KEY(finalscibandid) REFERENCES category(id)  MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION;  