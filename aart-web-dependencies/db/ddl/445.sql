...
$BODY$
  ...
  LOOP
    ...
    LOOP
                SELECT graceperiod into grace_period FROM operationaltestwindowsessionrule otwsr, operationaltestwindowstestcollections otwtc, category sessionrule,categorytype catType
                                ...
                                AND otwsr.operationaltestwindowid = otwtc.operationaltestwindowid and otwsr.activeflag=true and otwtc.activeflag=true 
                                AND otwtc.testcollectionid = studenttest.testcollectionid;
