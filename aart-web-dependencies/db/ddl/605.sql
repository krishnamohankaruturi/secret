--ddl/605.sql 
alter table ccqscoreitem add column nonscoringreason bigint;


-- Function change from TDE team
...
ALTER TABLE authorities ALTER COLUMN displayname TYPE character varying(55);
