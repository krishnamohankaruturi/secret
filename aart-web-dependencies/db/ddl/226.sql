--226.sql  moved to 228.sql and moved from 232.sql;

--DE6727 increase the test session name length to 200
DROP VIEW node_report;
DROP VIEW total_item_summary_by_node;
ALTER TABLE testsession ALTER COLUMN name TYPE varchar(200);
