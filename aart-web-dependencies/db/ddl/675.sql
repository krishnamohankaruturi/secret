--dml/675.sql
-- Increasing the report label and expecting this is pre-populated(no custom logic anymore). 
ALTER TABLE surveylabel ALTER COLUMN reportlabel TYPE varchar(250);

ALTER TABLE accessibilityfile DROP COLUMN IF EXISTS brailletypeabbr;
