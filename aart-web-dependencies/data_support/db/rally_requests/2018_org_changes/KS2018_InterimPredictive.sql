...
where ot.statedisplayidentifier='KS' and ap.abbreviatedname='KAP' and e.currentschoolyear=2017
...
inner join assessmentprogram ap on ap.id=sap.assessmentprogramid
inner join gradecourse gc on e.currentgradelevel=gc.id
where ot.statedisplayidentifier='KS' and ap.abbreviatedname='KAP' and e.currentschoolyear in (2017,2018)
