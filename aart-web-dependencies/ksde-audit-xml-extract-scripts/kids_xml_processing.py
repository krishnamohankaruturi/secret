...
def main():
    ...
    parser.add_option("--logfile", default="ksdexmlaudit_kids_stco_record.log",
    ...
    targettable = "kids_record_staging"
    recordtypeXMLString="KIDS_Record"
    recordtype="KIDS"
...
def process_XML_records(offset):
    ...
    getDataSql="select * from ksdexmlaudit where type='"+recordtype+"' and xml != '<KIDS_Data></KIDS_Data>' and xml NOT SIMILAR TO  '<error_message>%' and id>"+ str(offset)
    if end is not None:
